...
draft: false
title: "Evertag - Editor d'etiquetes de música per a iPhone i Mac"
layout: hextra-home
description: "Mantingues la teva biblioteca musical organitzada. Troba etiquetes que falten. Edició per lots. Canvia les portades dels àlbums i molt més."
keywords: ["Evertag", "editor d'etiquetes d'àudio", "gestor d'etiquetes ID3", "editar metadades de música", "editor d'etiquetes FLAC", "app organitzador de música", "editor de metadades MP3", "editor d'etiquetes de música iOS", "app d'etiquetes d'àudio Mac", "reanomenar fitxers de música"]
tags: ["Evertag", "etiquetes ID3", "metadades de música", "editor d'etiquetes d'àudio", "editor MP3", "etiquetatge FLAC", "utilitats iPhone", "eines de música Mac", "gestió de biblioteca musical"]
aliases:
  - /evertag/
  - /mp3tag/
appStoreUrl: "https://apps.apple.com/app/apple-store/id1450763230?pt=95781850&ct=everappzcom&mt=8"
appStoreId: "1450763230"
features: "Edita més de 120 etiquetes d'àudio, Edició d'etiquetes per lots, Cercador de portades d'àlbum, Suport per a més de 30 formats d'àudio, Cercador automàtic d'etiquetes via MusicBrainz, Corregir problemes de codificació, Accés al núvol i USB, Transferència de música per Wi-Fi, Gestor de fitxers integrat, Editor de lletres"
screenshots:
...
{{< hextra/feature-grid cols="4">}}
  ...
  {{< hextra/feature-card
    ...
    subtitle=`<span class='pricing-details'>• Inclou anuncis<br>
• Edita etiquetes d'àudio<br>
• Edita portades d'àlbum<br>
• Edita fitxers simultàniament<br>
• Corregeix la codificació de caràcters<br>
• Emmagatzematge al núvol (1)<br>
• Favorits (10)<br>
• Cerca automàtica d'etiquetes (20/dia)<br>
• Cerca de portades d'àlbum (20/dia)</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  ...
  {{< hextra/feature-card
    ...
    subtitle=`<span class='pricing-details'>• Sense anuncis<br />
• Edita etiquetes d'àudio<br>
• Edita portades d'àlbum<br>
• Edita fitxers simultàniament<br>
• Corregeix la codificació de caràcters<br>
• Emmagatzematge al núvol (il·limitat)<br />
• Favorits (il·limitat)<br />
• Cerca automàtica d'etiquetes (il·limitat)<br />
• Cerca de portades d'àlbum (il·limitat)<br />
• Personalització</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  <span class='pricing-btn hx:inline-block hx:rounded-full hx:border hx:border-gray-200 hx:dark:border-neutral-800 hx:px-3 hx:py-1 hx:transition-all hx:duration-200'>
...
<span class='hx:block hx:mt-2 hx:text-center'>
  <span class='pricing-btn hx:inline-block hx:rounded-full hx:border hx:border-gray-200 hx:dark:border-neutral-800 hx:px-3 hx:py-1 hx:transition-all hx:duration-200'>
    <strong>$24.99</strong>/de per vida
  </span>
</span>`
  >}}
...
Aquesta versió és ideal per als usuaris que volen provar les funcions bàsiques d'Evertag sense una subscripció. Pots editar més de 120 etiquetes d'àudio, gestionar els teus fitxers directament des del núvol i organitzar la teva biblioteca musical amb el gestor de fitxers integrat.<br><br>

**Evertag Premium (Mensual, Anual o de per vida)**  <br>
Actualitzar a Premium elimina els anuncis i desbloqueja tot el potencial d'Evertag. Obtens accés il·limitat a totes les funcions: editar més de 120 etiquetes, editar múltiples fitxers per lots, corregir la codificació i gestionar favorits il·limitats. Pots connectar serveis d'emmagatzematge al núvol il·limitats, fer cerques automàtiques d'etiquetes il·limitades i cercar portades d'àlbum il·limitades.<br><br>

Els usuaris Premium també obtenen accés a la configuració de personalització completa, incloent la possibilitat de canviar la icona de l'app i el tema. Aquest pla és ideal per a col·leccionistes de música, DJs o qualsevol persona que gestioni grans biblioteques musicals a través de diferents dispositius i plataformes al núvol.<br><br>

**Opcions de preus**  <br>
• Premium Mensual — $1.99/mes  <br>
• Premium Anual — $12.99/any  <br>
• Premium de per vida — $24.99 (compra única)  <br><br>
...
El token d'autenticació és una clau digital que permet a les aplicacions de tercers interactuar amb l'emmagatzematge al núvol. El token d'autenticació s'emmagatzema al teu dispositiu en un emmagatzematge segur del sistema anomenat Keychain. Pots descarregar els teus fitxers del servei al núvol connectat al dispositiu i aquests fitxers es col·locaran al directori "Documents" de l'app. Pots eliminar aquests fitxers en qualsevol moment amb el gestor de fitxers integrat.<br>
...
Per rebutjar el token d'autenticació, inicia sessió al teu compte al navegador web i navega a la pàgina de configuració. Allà pots trobar totes les aplicacions de tercers connectades al teu compte al núvol i eliminar qualsevol d'elles si ja no vols utilitzar aquesta aplicació.<br><br>
...
Navega fins a la teva carpeta de música, toca "Obrir" per confirmar la selecció i els fitxers s'afegiran a l'editor d'etiquetes.<br>
Aquests fitxers s'editaran directament des de la ubicació seleccionada sense ser copiats al paquet de l'aplicació.<br><br>

**Afegir una carpeta del dispositiu per a accés ràpid**<br>
Simplifica el procés afegint una carpeta ubicada al teu dispositiu a la secció d'accés ràpid.<br>
D'aquesta manera, no necessitaràs repetir els passos cada vegada que vulguis editar etiquetes dels fitxers a la carpeta de música.<br>
Obre la pantalla "Fitxers locals".<br>
...
* Desplaça't cap avall fins a la secció "Lletres no sincronitzades" i toca el camp de text.<br>
* Toca l'element de menú "Afegir nova pàgina".<br>
* A la secció "Idioma", selecciona l'idioma de les lletres o deixa'l en blanc per utilitzar l'anglès per defecte.<br>
* A la secció "Text", introdueix les teves lletres en text pla o en format LRC amb codis de temps. Es mostra un exemple a la pantalla. També pots trobar lletres en format LRC a [lyricsify.com](https://www.lyricsify.com/)<br>
* Toca "Fet" per confirmar els canvis tant a la pantalla actual com a la pantalla d'edició de lletres.<br>
* Tanca la pantalla d'edició de lletres i toca "Desar" per aplicar els canvis al fitxer actual.<br><br>
...
Introdueix l'adreça IP de l'ordinador i el nom de la carpeta compartida al camp URL amb el format smb://adreça-ip-ordinador/nom-carpeta-compartida,<br>
introdueix el nom d'usuari i la contrasenya i toca "Fet".<br>
Si la connexió és exitosa, veuràs l'emmagatzematge connectat a la secció "Emmagatzematge al núvol".<br><br>
...
L'URL hauria de tenir el format http://nom-servidor o https://nom-servidor si el servidor admet SSL.<br><br>
...
**Wi-Fi Drive** és una tecnologia popular que et permet transferir fitxers del teu ordinador a un dispositiu iOS sense cables mitjançant un navegador d'escriptori.<br>
...
Pots arrossegar i deixar anar fitxers del teu ordinador a la pàgina web oberta i apareixeran al dispositiu.<br><br>

Tutorial més detallat disponible aquí:<br>
[Com transferir fitxers sense cables des d'un ordinador a un iPhone amb WiFi-Drive](/docs/howto/how-to-transfer-files-wirelessly-from-a-computer-to-an-iphone-using-wifi-drive)<br><br>

**Compartició de fitxers d'iTunes** és una altra tecnologia que et permet transferir fitxers de l'ordinador al dispositiu utilitzant iTunes i un cable lightning.<br>
Simplement connecta el dispositiu a l'ordinador amb un cable i executa iTunes.<br>
Obre iTunes → "Secció d'aplicacions" → i troba Evertag.<br>
Toca la icona de l'app per veure la carpeta compartida.<br>
Copia els fitxers de l'ordinador a la carpeta compartida del dispositiu.<br><br>
...
Per descarregar fitxers del núvol:<br>
– Obre el servei d'emmagatzematge al núvol connectat.<br>
...
Pots navegar i gestionar els teus fitxers amb el gestor de fitxers integrat. L'aplicació admet totes les operacions bàsiques de fitxers com reanomenar, eliminar, moure i molt més.<br><br>
...
• **Mostrar missatge de confirmació** – Quan està activat, l'aplicació et mostrarà un missatge de confirmació abans d'actualitzar el fitxer al núvol.<br>
• **Actualitzar automàticament les metadades del fitxer** – Quan està activat, l'aplicació aplicarà els canvis al fitxer del núvol just després de desar.<br>
...
Accions disponibles per als fitxers seleccionats:<br>
• <strong>Descarregar</strong> – Descarregar un fitxer o carpeta de l'emmagatzematge al núvol a la secció "Fitxers locals".<br>
• <strong>Moure</strong> – Moure un fitxer o carpeta a una carpeta diferent dins de l'emmagatzematge al núvol.<br>
• <strong>Reanomenar</strong> – Reanomenar un fitxer o carpeta a l'emmagatzematge remot.<br>
• <strong>Eliminar</strong> – Eliminar permanentment un fitxer o carpeta de l'emmagatzematge al núvol.<br>
• <strong>Ordenar</strong> – Ordenar fitxers per nom, mida o data d'edició.<br>
...
• Desplaça't fins a la part inferior de la pantalla.<br>
