...
draft: false
title: 'Evertag - Editor Tag Muzik untuk iPhone dan Mac'
layout: hextra-home
...
• Edit tag audio<br>
• Edit kulit album<br>
• Edit fail serentak<br>
• Betulkan pengekodan aksara<br>
• Storan awan (1)<br>
• Kegemaran (10)<br>
• Cari tag secara automatik (20/hari)<br>
• Cari kulit album (20/hari)</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  ...
  {{< hextra/feature-card
    ...
    subtitle=`<span class='pricing-details'>• Tiada iklan<br />
• Edit tag audio<br>
• Edit kulit album<br>
• Edit fail serentak<br>
• Betulkan pengekodan aksara<br>
• Storan awan (tanpa had)<br />
• Kegemaran (tanpa had)<br />
• Cari tag secara automatik (tanpa had)<br />
• Cari kulit album (tanpa had)<br />
• Pemperibadian</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  <span class='pricing-btn hx:inline-block hx:rounded-full hx:border hx:border-gray-200 hx:dark:border-neutral-800 hx:px-3 hx:py-1 hx:transition-all hx:duration-200'>
...
Versi ini sesuai untuk pengguna yang ingin mencuba ciri teras Evertag tanpa langganan. Anda boleh mengedit lebih 120 tag audio, menguruskan fail anda terus dari awan dan menyusun pustaka muzik anda menggunakan pengurus fail terbina dalam.<br><br>

**Evertag Premium (Bulanan, Tahunan atau Seumur Hidup)**  <br>
Menaik taraf ke Premium mengalih keluar iklan dan membuka potensi penuh Evertag. Anda mendapat akses tanpa had kepada semua ciri: edit lebih 120+ tag, edit kelompok berbilang fail, betulkan pengekodan dan urus kegemaran tanpa had. Anda boleh menyambung perkhidmatan storan awan tanpa had, melakukan carian tag automatik tanpa had dan mencari kulit album tanpa had.<br><br>

Pengguna Premium juga mendapat akses kepada tetapan pemperibadian penuh, termasuk keupayaan untuk menukar ikon aplikasi dan tema. Pelan ini sesuai untuk pengumpul muzik, DJ atau sesiapa yang menguruskan pustaka muzik besar merentas peranti dan platform awan yang berbeza.<br><br>
...
Token kebenaran ialah kunci digital yang membenarkan aplikasi pihak ketiga berinteraksi dengan storan awan. Token kebenaran disimpan pada peranti anda dalam storan sistem selamat yang dipanggil Keychain. Anda boleh memuat turun fail anda dari perkhidmatan awan yang disambungkan ke peranti dan fail tersebut akan diletakkan dalam direktori "Dokumen" aplikasi. Anda boleh mengalih keluar fail tersebut pada bila-bila masa menggunakan pengurus fail terbina dalam.<br>
Aplikasi tidak berkongsi sebarang maklumat dari akaun awan yang disambungkan. Anda boleh membatalkan akses kepada akaun awan anda pada bila-bila masa dengan membuka halaman tetapan akaun pada pelayar web anda.<br><br>

Untuk menolak token kebenaran, log masuk ke akaun anda pada pelayar web dan navigasi ke halaman tetapan. Di sana anda boleh menemui semua aplikasi pihak ketiga yang disambungkan ke akaun awan anda dan mengalih keluar mana-mana daripadanya jika anda tidak mahu menggunakan aplikasi tersebut lagi.<br><br>
...
Navigasi ke folder muzik anda, ketik "Buka" untuk mengesahkan pilihan anda dan fail akan ditambah ke editor tag.<br>
Fail ini akan diedit terus dari lokasi yang dipilih tanpa disalin ke bundle aplikasi.<br><br>

**Menambah Folder Peranti untuk Akses Pantas**<br>
Permudahkan proses dengan menambah folder yang terletak pada peranti anda ke bahagian akses pantas anda.<br>
Dengan cara ini, anda tidak perlu mengulangi langkah-langkah setiap kali anda ingin mengedit tag untuk fail dalam folder muzik.<br>
Buka skrin "Fail setempat".<br>
...
* Tatal ke bawah ke bahagian "Lirik tidak segerak" dan ketik medan teks.<br>
* Ketik item menu "Tambah halaman baru".<br>
* Dalam bahagian "Bahasa", pilih bahasa lirik atau biarkan kosong untuk menggunakan bahasa Inggeris secara lalai.<br>
* Dalam bahagian "Teks", masukkan lirik anda dalam teks biasa atau format LRC dengan kod masa. Contoh ditunjukkan pada skrin. Anda juga boleh menemui lirik berformat LRC di [lyricsify.com](https://www.lyricsify.com/)<br>
* Ketik "Selesai" untuk mengesahkan perubahan pada skrin semasa dan skrin Edit Lirik.<br>
* Tutup skrin Edit Lirik dan ketik "Simpan" untuk menerapkan perubahan pada fail semasa.<br><br>
...
Jika sambungan anda berjaya, anda akan melihat storan yang disambungkan dalam bahagian "Storan awan".<br><br>
...
URL hendaklah dalam format http://nama-pelayan atau https://nama-pelayan jika pelayan menyokong SSL.<br><br>

Tutorial penuh tersedia di sini:<br>
[Cara Menyambung Storan NAS Menggunakan WebDAV dan Mendengar Muzik di iPhone atau Mac Anda](/docs/howto/how-to-connect-nas-storage-using-webdav-and-listen-to-music-on-your-iphone-or-mac)<br><br>
...
Untuk menggunakan ciri ini, peranti dan komputer anda hendaklah disambungkan ke rangkaian Wi-Fi yang sama.<br>
Buka "Sambungan" → "Komputer" → "Sambung melalui Wi-Fi" dan aktifkan pelayan.<br>
Selepas ini, buka pelayar desktop dan masukkan URL dari aplikasi.<br>
...
**Perkongsian Fail iTunes** ialah teknologi lain yang membolehkan anda memindahkan fail dari komputer ke peranti menggunakan iTunes dan kabel lightning.<br>
Hanya sambungkan peranti ke komputer menggunakan kabel dan jalankan iTunes.<br>
Buka iTunes → "Bahagian Aplikasi" → dan cari Evertag.<br>
Ketik pada ikon aplikasi untuk melihat folder dikongsi.<br>
...
Untuk memuat turun fail dari awan:<br>
– Buka perkhidmatan storan awan yang disambungkan.<br>
...
Anda boleh melayari dan mengurus fail anda menggunakan pengurus fail terbina dalam. Aplikasi ini menyokong semua operasi fail asas seperti namakan semula, padam, alih dan banyak lagi.<br><br>
...
• **Tunjukkan mesej pengesahan** – Apabila diaktifkan, aplikasi akan meminta anda dengan mesej pengesahan sebelum mengemas kini fail di awan.<br>
• **Kemas kini metadata fail secara automatik** – Apabila diaktifkan, aplikasi akan menerapkan perubahan pada fail awan sejurus selepas menyimpan.<br>
...
Tindakan yang tersedia untuk fail yang dipilih:<br>
• <strong>Muat turun</strong> – Muat turun fail atau folder dari storan awan ke bahagian "Fail Setempat".<br>
• <strong>Alih</strong> – Alihkan fail atau folder ke folder lain dalam storan awan.<br>
• <strong>Namakan Semula</strong> – Namakan semula fail atau folder pada storan jauh.<br>
• <strong>Padam</strong> – Padam fail atau folder secara kekal dari storan awan.<br>
• <strong>Susun</strong> – Susun fail mengikut nama, saiz atau tarikh diedit.<br>
...
• Tatal ke bahagian bawah skrin.<br>
