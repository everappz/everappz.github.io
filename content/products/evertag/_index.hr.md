...
{{< hextra/feature-grid cols="4">}}
  ...
  {{< hextra/feature-card
    ...
    subtitle=`<span class='pricing-details'>• Uključuje oglase<br>
• Uređivanje audio oznaka<br>
• Uređivanje omota albuma<br>
• Istovremeno uređivanje datoteka<br>
• Popravak kodiranja znakova<br>
• Pohrana u oblaku (1)<br>
• Favoriti (10)<br>
• Automatsko pronalaženje oznaka (20/dan)<br>
• Pretraživanje omota albuma (20/dan)</span><br /><br />
...
• Istovremeno uređivanje datoteka<br>
• Popravak kodiranja znakova<br>
• Pohrana u oblaku (neograničeno)<br />
• Favoriti (neograničeno)<br />
• Automatsko pronalaženje oznaka (neograničeno)<br />
• Pretraživanje omota albuma (neograničeno)<br />
• Personalizacija</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  <span class='pricing-btn hx:inline-block hx:rounded-full hx:border hx:border-gray-200 hx:dark:border-neutral-800 hx:px-3 hx:py-1 hx:transition-all hx:duration-200'>
...
Ova verzija je odlična za korisnike koji žele isprobati osnovne značajke Evertaga bez pretplate. Možete uređivati preko 120 audio oznaka, upravljati datotekama izravno iz oblaka i organizirati svoju glazbenu biblioteku koristeći ugrađeni upravitelj datoteka.<br><br>

**Evertag Premium (mjesečno, godišnje ili doživotno)**  <br>
Nadogradnja na Premium uklanja oglase i otključava puni potencijal Evertaga. Dobivate neograničen pristup svim značajkama: uređivanje 120+ oznaka, grupno uređivanje više datoteka, popravak kodiranja i upravljanje neograničenim favoritima. Možete povezati neograničen broj usluga pohrane u oblaku, izvršiti neograničen broj automatskih pretraživanja oznaka i pretraživati neograničen broj omota albuma.<br><br>

Premium korisnici također dobivaju pristup potpunim postavkama personalizacije, uključujući mogućnost promjene ikone aplikacije i teme. Ovaj plan je idealan za kolekcionare glazbe, DJ-eve ili bilo koga tko upravlja velikim glazbenim bibliotekama na različitim uređajima i platformama u oblaku.<br><br>

**Opcije cijena**  <br>
• Premium mjesečno — $1.99/mjesečno  <br>
• Premium godišnje — $12.99/godišnje  <br>
• Premium doživotno — $24.99 (jednokratna kupnja)  <br><br>
...
Auth-token je digitalni ključ koji omogućuje aplikacijama trećih strana interakciju s pohranom u oblaku. Auth-token je pohranjen na vašem uređaju u sigurnoj sistemskoj pohrani pod nazivom Keychain. Možete preuzeti datoteke s povezane usluge u oblaku na uređaj i te datoteke bit će smještene u direktorij "Documents" aplikacije. Možete ih bilo kada ukloniti koristeći ugrađeni upravitelj datoteka.<br>
Aplikacija ne dijeli nikakve informacije s povezanog računa u oblaku. Možete opozvati pristup svom računu u oblaku bilo kada otvaranjem stranice postavki računa u svom web pregledniku.<br><br>

Za odbijanje auth-tokena prijavite se na svoj račun u web pregledniku i idite na stranicu postavki. Tamo možete pronaći sve aplikacije trećih strana koje su povezane s vašim računom u oblaku i ukloniti bilo koju od njih ako više ne želite koristiti tu aplikaciju.<br><br>
...
Idite do svoje glazbene mape, dodirnite "Open" za potvrdu odabira i datoteke će biti dodane u uređivač oznaka.<br>
Ove datoteke bit će uređene izravno s odabranog mjesta bez kopiranja u paket aplikacije.<br><br>

**Dodavanje mape uređaja za brzi pristup**<br>
Pojednostavite postupak dodavanjem mape koja se nalazi na vašem uređaju u odjeljak brzog pristupa.<br>
Na ovaj način nećete morati ponavljati korake svaki put kad želite urediti oznake za datoteke u glazbenoj mapi.<br>
Otvorite zaslon "Local files".<br>
...
* Pomaknite se do odjeljka "Lyrics unsynced" i dodirnite tekstualno polje.<br>
* Dodirnite stavku izbornika "Add new page".<br>
* U odjeljku "Language" odaberite jezik teksta ili ostavite prazno za korištenje engleskog prema zadanim postavkama.<br>
* U odjeljku "Text" unesite tekst u običnom tekstu ili LRC formatu s vremenskim kodovima. Primjer je prikazan na zaslonu. LRC-formatirane tekstove možete pronaći i na [lyricsify.com](https://www.lyricsify.com/)<br>
* Dodirnite "Done" za potvrdu promjena na trenutnom zaslonu i zaslonu za uređivanje tekstova.<br>
* Zatvorite zaslon za uređivanje tekstova i dodirnite "Save" za primjenu promjena na trenutnu datoteku.<br><br>
...
Unesite IP adresu računala i naziv dijeljene mape u polje URL koristeći format smb://computer-ip-address/shared-folder-name,<br>
unesite prijavu i lozinku i dodirnite "Done".<br>
Ako je vaša veza uspješna, vidjet ćete povezanu pohranu u odjeljku "Cloud storage".<br><br>
...
Za **WebDAV** protokol, svi koraci su isti osim polja URL.<br>
URL bi trebao biti u formatu http://server-name ili https://server-name ako poslužitelj podržava SSL.<br><br>
...
Otvorite "Connections" → "Computer" → "Connect via Wi-Fi" i omogućite poslužitelj.<br>
Nakon toga otvorite desktop preglednik i unesite URL iz aplikacije.<br>
Možete povući datoteke s računala na otvorenu web stranicu i pojavit će se na uređaju.<br><br>
...
Jednostavno povežite uređaj s računalom koristeći kabel i pokrenite iTunes.<br>
Otvorite iTunes → "Applications section" → i pronađite Evertag.<br>
Dodirnite ikonu aplikacije za prikaz dijeljene mape.<br>
Kopirajte datoteke s računala u dijeljenu mapu na uređaju.<br><br>
...
Za preuzimanje datoteka iz oblaka:<br>
– Otvorite povezanu uslugu pohrane u oblaku.<br>
...
Možete pregledavati i upravljati svojim datotekama koristeći ugrađeni upravitelj datoteka. Aplikacija podržava sve osnovne operacije s datotekama poput preimenovanja, brisanja, premještanja i više.<br><br>
...
• **Prikaži poruku potvrde** – Kada je omogućeno, aplikacija će vas upitati za potvrdu prije ažuriranja datoteke u oblaku.<br>
• **Automatski ažuriraj metapodatke datoteke** – Kada je omogućeno, aplikacija će primijeniti promjene na datoteku u oblaku odmah nakon spremanja.<br>
...
Dostupne akcije za odabrane datoteke:<br>
• <strong>Preuzmi</strong> – Preuzmite datoteku ili mapu iz pohrane u oblaku u odjeljak "Local Files".<br>
• <strong>Premjesti</strong> – Premjestite datoteku ili mapu u drugu mapu unutar pohrane u oblaku.<br>
• <strong>Preimenuj</strong> – Preimenujte datoteku ili mapu na udaljenoj pohrani.<br>
• <strong>Izbriši</strong> – Trajno izbrišite datoteku ili mapu iz pohrane u oblaku.<br>
• <strong>Sortiraj</strong> – Sortirajte datoteke po imenu, veličini ili datumu uređivanja.<br>
...
• Pomaknite se do dna zaslona.<br>
