...
draft: false
title: 'Evertag - Musiktageditor til iPhone og Mac'
layout: hextra-home
...
{{< hextra/feature-grid cols="4">}}
  ...
  {{< hextra/feature-card
    ...
    subtitle=`<span class='pricing-details'>• Inkluderer annoncer<br>
• Rediger lydtags<br>
• Rediger albumcovers<br>
• Rediger filer samtidigt<br>
• Ret tegnkodning<br>
• Cloudlagring (1)<br>
• Favoritter (10)<br>
• Find tags automatisk (20/dag)<br>
• Søg albumcovers (20/dag)</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  ...
  {{< hextra/feature-card
    tag="Gratis"
    tagType="default"
    title="Premium månedligt"
    class="pricing-card pricing-subscription"
    subtitle=`<span class='pricing-details'>• Ingen annoncer<br />
• Rediger lydtags<br>
• Rediger albumcovers<br>
• Rediger filer samtidigt<br>
• Ret tegnkodning<br>
• Cloudlagring (ubegrænset)<br />
• Favoritter (ubegrænset)<br />
• Find tags automatisk (ubegrænset)<br />
• Søg albumcovers (ubegrænset)<br />
...
Denne version er ideel for brugere, der vil prøve Evertags kernefunktioner uden abonnement. Du kan redigere over 120 lydtags, administrere dine filer direkte fra skyen og organisere dit musikbibliotek med den indbyggede filhåndtering.<br><br>

**Evertag Premium (månedligt, årligt eller livstid)**  <br>
Opgradering til Premium fjerner annoncer og låser op for det fulde potentiale i Evertag. Du får ubegrænset adgang til alle funktioner: rediger over 120+ tags, masseredigering af flere filer, ret kodning og administrer ubegrænsede favoritter. Du kan forbinde ubegrænsede cloudlagringstjenester, udføre ubegrænsede automatiske tagsøgninger og søge efter ubegrænsede albumcovers.<br><br>

Premium-brugere får også adgang til fulde personaliseringsindstillinger, herunder muligheden for at ændre appikon og tema. Denne plan er ideel for musiksamlere, DJ'er eller alle, der administrerer store musikbiblioteker på tværs af forskellige enheder og cloudplatforme.<br><br>

**Prismuligheder**  <br>
• Premium månedligt — $1.99/måned  <br>
• Premium årligt — $12.99/år  <br>
• Premium livstid — $24.99 (engangskøb)  <br><br>
...
Auth-token er en digital nøgle, der tillader tredjepartsapplikationer at interagere med cloudlagring. Auth-token gemmes på din enhed i sikker systemlagring kaldet Keychain. Du kan downloade dine filer fra den tilsluttede cloudtjeneste til enheden, og disse filer placeres i appens «Documents»-mappe. Du kan fjerne disse filer når som helst ved hjælp af den indbyggede filhåndtering.<br>
Applikationen deler ingen information fra den tilsluttede cloudkonto. Du kan tilbagekalde adgangen til din cloudkonto når som helst ved at åbne kontoindstillingssiden i din webbrowser.<br><br>

For at afvise auth-token, log ind på din konto i webbrowseren og naviger til indstillingssiden. Der kan du finde alle tredjepartsapps, der er forbundet til din cloudkonto, og fjerne dem, hvis du ikke længere ønsker at bruge den pågældende applikation.<br><br>
...
Navigér til din musikmappe, tryk «Åbn» for at bekræfte dit valg, og filerne bliver tilføjet til tageditor.<br>
Disse filer redigeres direkte fra den valgte placering uden at blive kopieret til applikationspakken.<br><br>

**Tilføj en enhedsmappe for hurtig adgang**<br>
Forenkl processen ved at tilføje en mappe på din enhed til din hurtigadgangssektion.<br>
På denne måde behøver du ikke gentage trinnene hver gang, du vil redigere tags for filerne i musikmappen.<br>
Åbn skærmen «Lokale filer».<br>
...
* Scroll ned til sektionen «Tekster usynkroniseret» og tryk på tekstfeltet.<br>
* Tryk på menupunktet «Tilføj ny side».<br>
* I sektionen «Sprog» vælger du tekstsproget eller lader det stå tomt for at bruge engelsk som standard.<br>
* I sektionen «Tekst» indtaster du dine tekster i ren tekst eller LRC-format med tidskoder. Et eksempel vises på skærmen. Du kan også finde LRC-formaterede tekster på [lyricsify.com](https://www.lyricsify.com/)<br>
* Tryk «Færdig» for at bekræfte ændringerne både på den aktuelle skærm og tekstredaktionsskærmen.<br>
* Luk tekstredaktionsskærmen og tryk «Gem» for at anvende ændringerne på den aktuelle fil.<br><br>
...
Indtast computerens IP-adresse og det delte mappenavn i URL-feltet med formatet smb://computer-ip-adresse/delt-mappenavn,<br>
indtast login og adgangskode og tryk «Færdig».<br>
Hvis forbindelsen er vellykket, vil du se tilsluttet lagring i sektionen «Cloudlagring».<br><br>

En komplet vejledning tilgængelig her:<br>
...
URL skal være i formatet http://servernavn eller https://servernavn, hvis serveren understøtter SSL.<br><br>

En komplet vejledning tilgængelig her:<br>
[Sådan tilslutter du NAS-lagring ved hjælp af WebDAV og lytter til musik på din iPhone eller Mac](/docs/howto/how-to-connect-nas-storage-using-webdav-and-listen-to-music-on-your-iphone-or-mac)<br><br>

**Wi-Fi Drive** er en populær teknologi, der lader dig overføre filer fra din computer til en iOS-enhed trådløst via en desktopbrowser.<br>
For at bruge denne funktion skal din enhed og computer være forbundet til det samme Wi-Fi-netværk.<br>
Åbn «Forbindelser» → «Computer» → «Tilslut via Wi-Fi» og aktiver serveren.<br>
Derefter åbner du en desktopbrowser og indtaster URL'en fra applikationen.<br>
Du kan trække og slippe filer fra din computer til den åbne webside, og de vil vises på enheden.<br><br>
...
**iTunes-fildeling** er en anden teknologi, der lader dig overføre filer fra computer til enhed ved hjælp af iTunes og lightning-kabel.<br>
Tilslut blot enheden til computeren med et kabel og kør iTunes.<br>
Åbn iTunes → «Applikationssektionen» → og find Evertag.<br>
Tryk på appikonet for at se en delt mappe.<br>
Kopier filer fra computeren til den delte mappe på enheden.<br><br>
...
For at downloade filer fra skyen:<br>
– Åbn den tilsluttede cloudlagringstjeneste.<br>
...
Du kan gennemse og administrere dine filer ved hjælp af den indbyggede filhåndtering. Appen understøtter alle grundlæggende filoperationer som omdøb, slet, flyt og mere.<br><br>
...
• **Vis bekræftelsesbesked** – Når aktiveret, vil appen bede dig om bekræftelse, før den opdaterer filen i skyen.<br>
• **Opdater filens metadata automatisk** – Når aktiveret, vil appen anvende ændringerne på cloudfilen lige efter gem.<br>
...
Tilgængelige handlinger for valgte filer:<br>
• <strong>Download</strong> – Download en fil eller mappe fra cloudlagring til sektionen «Lokale filer».<br>
• <strong>Flyt</strong> – Flyt en fil eller mappe til en anden mappe i cloudlagringen.<br>
• <strong>Omdøb</strong> – Omdøb en fil eller mappe i fjernlagringen.<br>
• <strong>Slet</strong> – Slet permanent en fil eller mappe fra cloudlagringen.<br>
• <strong>Sortér</strong> – Sortér filer efter navn, størrelse eller redigeringsdato.<br>
...
• Scroll til bunden af skærmen.<br>
...
{{< cards >}}
  {{< card icon="location-marker" title="Navigation" subtitle="Lær, hvordan du nemt navigerer i vores app ved hjælp af fanebaren (for iPhone-brugere) eller venstremenuen (for iPad- og Mac-brugere) for at få adgang til og udforske alle appens funktioner." link="/docs/guide/evertag/evertag-guide-navigation" >}}

  {{< card icon="cloud" title="Forbindelser" subtitle="Tilslut nemt alle dine tilgængelige cloudkonti med dine værdifulde lydfiler. Du kan endda redigere dine onlinefiler nemt med vores integrerede filhåndtering." link="/docs/guide/evertag/evertag-guide-connections" >}}

  {{< card icon="folder" title="Lokale filer" subtitle="Se og organiser filer gemt i appens Documents-mappe eller på din enhed. Brug den indbyggede filhåndtering til at redigere og administrere dine lydfiler med lethed." link="/docs/guide/evertag/evertag-guide-local-files" >}}

  {{< card icon="pencil-alt" title="Tageditor" subtitle="Mester kunsten at manipulere lydfilmetadata. Find ud af, hvordan du redigerer metadata, ændrer albumcovers og problemfrit administrerer flere filer samtidigt." link="/docs/guide/evertag/evertag-guide-tag-editor" >}}

  {{< card icon="code" title="Tagfelt-tilknytninger" subtitle="Udforsk den komplette liste over lydtagfelter understøttet af Evertag-appen, herunder interne feltnavne og tilknytninger på tværs af store metadataformater." link="/docs/guide/evertag/evertag-tag-field-mappings" >}}

  {{< card icon="adjustments" title="Indstillinger" subtitle="Opdag, hvordan du tilpasser din appoplevelse, finjusterer ydeevne, administrerer dataforbrug og skræddersyr sprog- og brugergrænsefladepræferencer efter din smag." link="/docs/guide/evertag/evertag-guide-settings" >}}
