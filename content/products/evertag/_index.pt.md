...
draft: false
title: 'Evertag - Editor de tags de música para iPhone e Mac'
layout: hextra-home
description: "Mantenha a sua biblioteca musical organizada. Encontre tags em falta. Edição em lote. Altere capas de álbuns e muito mais."
keywords: ["Evertag", "editor de tags de áudio", "gestor de tags ID3", "editar metadados de música", "editor de tags FLAC", "app organizador de música", "editor de metadados MP3", "editor de tags de música iOS", "app de tags de áudio Mac", "renomear ficheiros de música"]
tags: ["Evertag", "tags ID3", "metadados de música", "editor de tags de áudio", "editor MP3", "etiquetagem FLAC", "utilitários iPhone", "ferramentas de música Mac", "gestão de biblioteca musical"]
aliases:
  - /evertag/
  - /mp3tag/
appStoreUrl: "https://apps.apple.com/app/apple-store/id1450763230?pt=95781850&ct=everappzcom&mt=8"
appStoreId: "1450763230"
features: "Edite mais de 120 tags de áudio, Edição de tags em lote, Pesquisa de capas de álbum, Suporte para mais de 30 formatos de áudio, Pesquisa automática de tags via MusicBrainz, Corrigir problemas de codificação, Acesso à nuvem e USB, Transferência de música por Wi-Fi, Gestor de ficheiros integrado, Editor de letras"
screenshots:
...
{{< hextra/hero-button 
  text="Descarregar para dispositivo móvel"
...
{{< hextra/hero-button 
  text="Descarregar para computador"
...
{{< hextra/feature-grid cols="4">}}
  ...
  {{< hextra/feature-card
    ...
    subtitle=`<span class='pricing-details'>• Inclui anúncios<br>
• Editar tags de áudio<br>
• Editar capas de álbum<br>
• Editar ficheiros simultaneamente<br>
• Corrigir codificação de caracteres<br>
• Armazenamento na nuvem (1)<br>
• Favoritos (10)<br>
• Pesquisa automática de tags (20/dia)<br>
• Pesquisa de capas de álbum (20/dia)</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  ...
  {{< hextra/feature-card
    ...
    subtitle=`<span class='pricing-details'>• Sem anúncios<br />
• Editar tags de áudio<br>
• Editar capas de álbum<br>
• Editar ficheiros simultaneamente<br>
• Corrigir codificação de caracteres<br>
• Armazenamento na nuvem (ilimitado)<br />
• Favoritos (ilimitado)<br />
• Pesquisa automática de tags (ilimitado)<br />
• Pesquisa de capas de álbum (ilimitado)<br />
• Personalização</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  <span class='pricing-btn hx:inline-block hx:rounded-full hx:border hx:border-gray-200 hx:dark:border-neutral-800 hx:px-3 hx:py-1 hx:transition-all hx:duration-200'>
...
Esta versão é ótima para utilizadores que querem experimentar as funcionalidades principais do Evertag sem uma subscrição. Pode editar mais de 120 tags de áudio, gerir os seus ficheiros diretamente a partir da nuvem e organizar a sua biblioteca musical usando o gestor de ficheiros integrado.<br><br>

**Evertag Premium (Mensal, Anual ou Vitalício)**  <br>
Atualizar para Premium remove os anúncios e desbloqueia todo o potencial do Evertag. Obtém acesso ilimitado a todas as funcionalidades: editar mais de 120 tags, editar vários ficheiros em lote, corrigir codificação e gerir favoritos ilimitados. Pode ligar serviços de armazenamento na nuvem ilimitados, realizar pesquisas automáticas de tags ilimitadas e pesquisar capas de álbum ilimitadas.<br><br>

Os utilizadores Premium também obtêm acesso às definições completas de personalização, incluindo a possibilidade de alterar o ícone da app e o tema. Este plano é ideal para colecionadores de música, DJs ou qualquer pessoa que gere grandes bibliotecas musicais em diferentes dispositivos e plataformas na nuvem.<br><br>

**Opções de preços**  <br>
• Premium Mensal — $1.99/mês  <br>
• Premium Anual — $12.99/ano  <br>
• Premium Vitalício — $24.99 (compra única)  <br><br>
...
O token de autenticação é uma chave digital que permite a aplicações de terceiros interagir com o armazenamento na nuvem. O token de autenticação é armazenado no seu dispositivo num armazenamento seguro do sistema chamado Keychain. Pode descarregar os seus ficheiros do serviço na nuvem ligado para o dispositivo e esses ficheiros serão colocados no diretório "Documents" da app. Pode remover esses ficheiros a qualquer momento usando o gestor de ficheiros integrado.<br>
A aplicação não partilha nenhuma informação da conta na nuvem ligada. Pode revogar o acesso à sua conta na nuvem a qualquer momento abrindo a página de definições da conta no seu navegador web.<br><br>

Para rejeitar o token de autenticação, inicie sessão na sua conta no navegador web e navegue até à página de definições. Aí pode encontrar todas as aplicações de terceiros ligadas à sua conta na nuvem e remover qualquer uma delas se já não quiser usar essa aplicação.<br><br>
...
Navegue até à sua pasta de música, toque em "Abrir" para confirmar a sua seleção e os ficheiros serão adicionados ao editor de tags.<br>
Estes ficheiros serão editados diretamente a partir da localização selecionada sem serem copiados para o pacote da aplicação.<br><br>

**Adicionar uma pasta do dispositivo para acesso rápido**<br>
Simplifique o processo adicionando uma pasta localizada no seu dispositivo à secção de acesso rápido.<br>
Desta forma, não precisará de repetir os passos sempre que quiser editar tags dos ficheiros na pasta de música.<br>
Abra o ecrã "Ficheiros locais".<br>
...
* Deslize para baixo até à secção "Letras não sincronizadas" e toque no campo de texto.<br>
* Toque no item de menu "Adicionar nova página".<br>
* Na secção "Idioma", selecione o idioma das letras ou deixe em branco para usar inglês por predefinição.<br>
* Na secção "Texto", introduza as suas letras em texto simples ou formato LRC com códigos de tempo. Um exemplo é mostrado no ecrã. Também pode encontrar letras em formato LRC em [lyricsify.com](https://www.lyricsify.com/)<br>
* Toque em "Concluído" para confirmar as alterações tanto no ecrã atual como no ecrã de edição de letras.<br>
* Feche o ecrã de edição de letras e toque em "Guardar" para aplicar as alterações ao ficheiro atual.<br><br>
...
Introduza o endereço IP do computador e o nome da pasta partilhada no campo URL usando o formato smb://endereço-ip-computador/nome-pasta-partilhada,<br>
introduza o nome de utilizador e a palavra-passe e toque em "Concluído".<br>
Se a ligação for bem-sucedida, verá o armazenamento ligado na secção "Armazenamento na nuvem".<br><br>

Tutorial completo disponível aqui:<br>
[Transfira os seus ficheiros do computador para o iPhone usando o protocolo SMB](/docs/howto/transfer-your-files-from-the-computer-to-iphone-using-smb-protocol/)<br><br>

Para o protocolo **WebDAV**, todos os passos são iguais, exceto o campo URL.<br>
O URL deve ter o formato http://nome-servidor ou https://nome-servidor se o servidor suportar SSL.<br><br>

Tutorial completo disponível aqui:<br>
[Como ligar armazenamento NAS usando WebDAV e ouvir música no seu iPhone ou Mac](/docs/howto/how-to-connect-nas-storage-using-webdav-and-listen-to-music-on-your-iphone-or-mac)<br><br>

**Wi-Fi Drive** é uma tecnologia popular que lhe permite transferir ficheiros do seu computador para um dispositivo iOS sem fios usando um navegador de secretária.<br>
Para usar esta funcionalidade, o seu dispositivo e computador devem estar ligados à mesma rede Wi-Fi.<br>
Abra "Ligações" → "Computador" → "Ligar via Wi-Fi" e ative o servidor.<br>
Depois abra um navegador de secretária e introduza o URL da aplicação.<br>
Pode arrastar e largar ficheiros do seu computador para a página web aberta e eles aparecerão no dispositivo.<br><br>

Tutorial mais detalhado disponível aqui:<br>
[Como transferir ficheiros sem fios de um computador para um iPhone usando WiFi-Drive](/docs/howto/how-to-transfer-files-wirelessly-from-a-computer-to-an-iphone-using-wifi-drive)<br><br>

**Partilha de Ficheiros do iTunes** é outra tecnologia que lhe permite transferir ficheiros do computador para o dispositivo usando o iTunes e um cabo lightning.<br>
Basta ligar o dispositivo ao computador usando um cabo e executar o iTunes.<br>
Abra o iTunes → "Secção de aplicações" → e encontre o Evertag.<br>
Toque no ícone da app para ver a pasta partilhada.<br>
Copie ficheiros do computador para a pasta partilhada no dispositivo.<br><br>
...
Para descarregar ficheiros da nuvem:<br>
– Abra o serviço de armazenamento na nuvem ligado.<br>
...
Pode navegar e gerir os seus ficheiros usando o gestor de ficheiros integrado. A aplicação suporta todas as operações básicas de ficheiros como renomear, eliminar, mover e mais.<br><br>
...
• **Mostrar mensagem de confirmação** – Quando ativado, a aplicação irá solicitar uma mensagem de confirmação antes de atualizar o ficheiro na nuvem.<br>
• **Atualizar automaticamente os metadados do ficheiro** – Quando ativado, a aplicação irá aplicar as alterações ao ficheiro na nuvem logo após guardar.<br>
...
Ações disponíveis para ficheiros selecionados:<br>
• <strong>Descarregar</strong> – Descarregar um ficheiro ou pasta do armazenamento na nuvem para a secção "Ficheiros Locais".<br>
• <strong>Mover</strong> – Mover um ficheiro ou pasta para uma pasta diferente dentro do armazenamento na nuvem.<br>
• <strong>Renomear</strong> – Renomear um ficheiro ou pasta no armazenamento remoto.<br>
• <strong>Eliminar</strong> – Eliminar permanentemente um ficheiro ou pasta do armazenamento na nuvem.<br>
• <strong>Ordenar</strong> – Ordenar ficheiros por nome, tamanho ou data de edição.<br>
...
• Deslize até ao fundo do ecrã.<br>
