...
draft: false
title: 'Evertag - محرر علامات الموسيقى لأجهزة iPhone و Mac'
layout: hextra-home
description: "حافظ على تنظيم مكتبتك الموسيقية. اعثر على العلامات المفقودة. التحرير الجماعي. تغيير أغلفة الألبومات والمزيد."
keywords: ["Evertag", "محرر علامات الصوت", "مدير علامات ID3", "تحرير بيانات الموسيقى الوصفية", "محرر علامات FLAC", "تطبيق تنظيم الموسيقى", "محرر بيانات MP3 الوصفية", "محرر علامات موسيقى iOS", "تطبيق علامات صوت Mac", "إعادة تسمية ملفات الموسيقى"]
tags: ["Evertag", "علامات ID3", "بيانات الموسيقى الوصفية", "محرر علامات الصوت", "محرر MP3", "وسم FLAC", "أدوات iPhone", "أدوات موسيقى Mac", "إدارة مكتبة الموسيقى"]
aliases:
  - /evertag/
  - /mp3tag/
appStoreUrl: "https://apps.apple.com/app/apple-store/id1450763230?pt=95781850&ct=everappzcom&mt=8"
appStoreId: "1450763230"
features: "تحرير أكثر من 120 علامة صوتية, التحرير الجماعي للعلامات, باحث أغلفة الألبومات, دعم أكثر من 30 صيغة صوتية, باحث العلامات التلقائي عبر MusicBrainz, إصلاح مشاكل الترميز, الوصول إلى السحابة و USB, نقل الموسيقى عبر Wi-Fi, مدير ملفات مدمج, محرر كلمات الأغاني"
screenshots:
...
{{< hextra/feature-grid cols="4">}}
  ...
  {{< hextra/feature-card
    ...
    subtitle=`<span class='pricing-details'>• يتضمن إعلانات<br>
• تحرير علامات الصوت<br>
• تحرير أغلفة الألبومات<br>
• تحرير الملفات في وقت واحد<br>
• إصلاح ترميز الأحرف<br>
• التخزين السحابي (1)<br>
• المفضلات (10)<br>
• البحث التلقائي عن العلامات (20/يوم)<br>
• البحث عن أغلفة الألبومات (20/يوم)</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  ...
  {{< hextra/feature-card
    ...
    subtitle=`<span class='pricing-details'>• بدون إعلانات<br />
• تحرير علامات الصوت<br>
• تحرير أغلفة الألبومات<br>
• تحرير الملفات في وقت واحد<br>
• إصلاح ترميز الأحرف<br>
• التخزين السحابي (غير محدود)<br />
• المفضلات (غير محدود)<br />
• البحث التلقائي عن العلامات (غير محدود)<br />
• البحث عن أغلفة الألبومات (غير محدود)<br />
• التخصيص</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  <span class='pricing-btn hx:inline-block hx:rounded-full hx:border hx:border-gray-200 hx:dark:border-neutral-800 hx:px-3 hx:py-1 hx:transition-all hx:duration-200'>
...
<span class='hx:block hx:mt-2 hx:text-center'>
  <span class='pricing-btn hx:inline-block hx:rounded-full hx:border hx:border-gray-200 hx:dark:border-neutral-800 hx:px-3 hx:py-1 hx:transition-all hx:duration-200'>
    <strong>$24.99</strong>/مدى الحياة
  </span>
</span>`
  >}}
...
هذا الإصدار رائع للمستخدمين الذين يريدون تجربة الميزات الأساسية لـ Evertag بدون اشتراك. يمكنك تحرير أكثر من 120 علامة صوتية وإدارة ملفاتك مباشرة من السحابة وتنظيم مكتبتك الموسيقية باستخدام مدير الملفات المدمج.<br><br>

**Evertag Premium (شهري أو سنوي أو مدى الحياة)**  <br>
الترقية إلى Premium تزيل الإعلانات وتفتح الإمكانات الكاملة لـ Evertag. تحصل على وصول غير محدود لجميع الميزات: تحرير أكثر من 120 علامة، تحرير جماعي لملفات متعددة، إصلاح الترميز وإدارة مفضلات غير محدودة. يمكنك ربط خدمات تخزين سحابي غير محدودة وإجراء عمليات بحث تلقائية عن العلامات غير محدودة والبحث عن أغلفة ألبومات غير محدودة.<br><br>

يحصل مستخدمو Premium أيضاً على إعدادات تخصيص كاملة، بما في ذلك القدرة على تغيير أيقونة التطبيق والسمة. هذه الخطة مثالية لجامعي الموسيقى والدي جي أو أي شخص يدير مكتبات موسيقية كبيرة عبر أجهزة ومنصات سحابية مختلفة.<br><br>

**خيارات الأسعار**  <br>
• بريميوم شهري — $1.99/شهر  <br>
• بريميوم سنوي — $12.99/سنة  <br>
• بريميوم مدى الحياة — $24.99 (شراء لمرة واحدة)  <br><br>
...
رمز المصادقة هو مفتاح رقمي يسمح للتطبيقات الخارجية بالتفاعل مع التخزين السحابي. يُخزّن رمز المصادقة على جهازك في تخزين النظام الآمن المسمى Keychain. يمكنك تنزيل ملفاتك من الخدمة السحابية المتصلة إلى الجهاز وستُوضع هذه الملفات في مجلد «Documents» الخاص بالتطبيق. يمكنك إزالة هذه الملفات في أي وقت باستخدام مدير الملفات المدمج.<br>
...
لإلغاء رمز المصادقة، سجّل الدخول إلى حسابك في متصفح الويب وانتقل إلى صفحة الإعدادات. هناك يمكنك العثور على جميع التطبيقات الخارجية المتصلة بحسابك السحابي وإزالة أي منها إذا لم تعد ترغب في استخدام هذا التطبيق.<br><br>
...
انتقل إلى مجلد الموسيقى الخاص بك، اضغط «فتح» لتأكيد اختيارك وستتم إضافة الملفات إلى محرر العلامات.<br>
سيتم تحرير هذه الملفات مباشرة من الموقع المحدد دون نسخها إلى حزمة التطبيق.<br><br>

**إضافة مجلد جهاز للوصول السريع**<br>
بسّط العملية بإضافة مجلد موجود على جهازك إلى قسم الوصول السريع.<br>
بهذه الطريقة، لن تحتاج لتكرار الخطوات في كل مرة تريد فيها تحرير علامات الملفات في مجلد الموسيقى.<br>
افتح شاشة «الملفات المحلية».<br>
...
* مرر لأسفل إلى قسم «كلمات الأغاني غير المتزامنة» واضغط على حقل النص.<br>
* اضغط على عنصر القائمة «إضافة صفحة جديدة».<br>
* في قسم «اللغة»، حدد لغة كلمات الأغاني أو اتركه فارغاً لاستخدام الإنجليزية افتراضياً.<br>
* في قسم «النص»، أدخل كلمات الأغاني بنص عادي أو بتنسيق LRC مع أكواد زمنية. يظهر مثال على الشاشة. يمكنك أيضاً العثور على كلمات بتنسيق LRC على [lyricsify.com](https://www.lyricsify.com/)<br>
* اضغط «تم» لتأكيد التغييرات في كل من الشاشة الحالية وشاشة تحرير كلمات الأغاني.<br>
* أغلق شاشة تحرير كلمات الأغاني واضغط «حفظ» لتطبيق التغييرات على الملف الحالي.<br><br>
...
أدخل عنوان IP لجهاز الكمبيوتر واسم المجلد المشترك في حقل URL بالتنسيق smb://عنوان-ip-الكمبيوتر/اسم-المجلد-المشترك،<br>
أدخل اسم المستخدم وكلمة المرور واضغط «تم».<br>
إذا نجح الاتصال ستظهر وحدة التخزين المتصلة في قسم «التخزين السحابي».<br><br>

دليل كامل متاح هنا:<br>
...
لبروتوكول **WebDAV** جميع الخطوات هي نفسها باستثناء حقل URL.<br>
...
**Wi-Fi Drive** هي تقنية شائعة تتيح لك نقل الملفات من جهاز الكمبيوتر إلى جهاز iOS لاسلكياً باستخدام متصفح سطح المكتب.<br>
لاستخدام هذه الميزة يجب أن يكون جهازك وجهاز الكمبيوتر متصلين بنفس شبكة Wi-Fi.<br>
افتح «الاتصالات» → «الكمبيوتر» → «الاتصال عبر Wi-Fi» وقم بتفعيل الخادم.<br>
بعد ذلك افتح متصفح سطح المكتب وأدخل عنوان URL من التطبيق.<br>
يمكنك سحب وإفلات الملفات من جهاز الكمبيوتر إلى صفحة الويب المفتوحة وستظهر على الجهاز.<br><br>
...
ما عليك سوى توصيل الجهاز بالكمبيوتر باستخدام كابل وتشغيل iTunes.<br>
افتح iTunes → «قسم التطبيقات» → وابحث عن Evertag.<br>
...
لتنزيل الملفات من السحابة:<br>
– افتح خدمة التخزين السحابي المتصلة.<br>
...
يمكنك تصفح وإدارة ملفاتك باستخدام مدير الملفات المدمج. يدعم التطبيق جميع عمليات الملفات الأساسية مثل إعادة التسمية والحذف والنقل والمزيد.<br><br>
...
• **عرض رسالة تأكيد** – عند التفعيل، سيطلب منك التطبيق تأكيداً قبل تحديث الملف في السحابة.<br>
• **تحديث البيانات الوصفية للملف تلقائياً** – عند التفعيل، سيطبق التطبيق التغييرات على الملف السحابي فور الحفظ.<br>
...
الإجراءات المتاحة للملفات المحددة:<br>
• <strong>تنزيل</strong> – تنزيل ملف أو مجلد من التخزين السحابي إلى قسم «الملفات المحلية».<br>
• <strong>نقل</strong> – نقل ملف أو مجلد إلى مجلد مختلف داخل التخزين السحابي.<br>
• <strong>إعادة تسمية</strong> – إعادة تسمية ملف أو مجلد في التخزين البعيد.<br>
• <strong>حذف</strong> – حذف ملف أو مجلد نهائياً من التخزين السحابي.<br>
• <strong>ترتيب</strong> – ترتيب الملفات حسب الاسم أو الحجم أو تاريخ التعديل.<br>
