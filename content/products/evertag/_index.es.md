...
draft: false
title: 'Evertag - Editor de etiquetas de música para iPhone y Mac'
layout: hextra-home
description: "Mantén tu biblioteca musical organizada. Encuentra etiquetas faltantes. Edición por lotes. Cambia portadas de álbumes y mucho más."
keywords: ["Evertag", "editor de etiquetas de audio", "gestor de etiquetas ID3", "editar metadatos de música", "editor de etiquetas FLAC", "app organizador de música", "editor de metadatos MP3", "editor de etiquetas de música iOS", "app de etiquetas de audio Mac", "renombrar archivos de música"]
tags: ["Evertag", "etiquetas ID3", "metadatos de música", "editor de etiquetas de audio", "editor MP3", "etiquetado FLAC", "utilidades iPhone", "herramientas de música Mac", "gestión de biblioteca musical"]
appStoreUrl: "https://apps.apple.com/app/apple-store/id1450763230?pt=95781850&ct=everappzcom&mt=8"
appStoreId: "1450763230"
features: "Edita más de 120 etiquetas de audio, Edición de etiquetas por lotes, Buscador de portadas de álbum, Soporte para más de 30 formatos de audio, Buscador automático de etiquetas vía MusicBrainz, Corregir problemas de codificación, Acceso a la nube y USB, Transferencia de música por Wi-Fi, Gestor de archivos integrado, Editor de letras"
screenshots:
...
{{< hextra/feature-grid cols="4">}}
  ...
  {{< hextra/feature-card
    ...
    subtitle=`<span class='pricing-details'>• Incluye anuncios<br>
• Editar etiquetas de audio<br>
• Editar portadas de álbum<br>
• Editar archivos simultáneamente<br>
• Corregir codificación de caracteres<br>
• Almacenamiento en la nube (1)<br>
• Favoritos (10)<br>
• Buscar etiquetas automáticamente (20/día)<br>
• Buscar portadas de álbum (20/día)</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  ...
  {{< hextra/feature-card
    ...
    subtitle=`<span class='pricing-details'>• Sin anuncios<br />
• Editar etiquetas de audio<br>
• Editar portadas de álbum<br>
• Editar archivos simultáneamente<br>
• Corregir codificación de caracteres<br>
• Almacenamiento en la nube (ilimitado)<br />
• Favoritos (ilimitado)<br />
• Buscar etiquetas automáticamente (ilimitado)<br />
• Buscar portadas de álbum (ilimitado)<br />
• Personalización</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  <span class='pricing-btn hx:inline-block hx:rounded-full hx:border hx:border-gray-200 hx:dark:border-neutral-800 hx:px-3 hx:py-1 hx:transition-all hx:duration-200'>
...
<span class='hx:block hx:mt-2 hx:text-center'>
  <span class='pricing-btn hx:inline-block hx:rounded-full hx:border hx:border-gray-200 hx:dark:border-neutral-800 hx:px-3 hx:py-1 hx:transition-all hx:duration-200'>
    <strong>$24.99</strong>/de por vida
  </span>
</span>`
  >}}
...
Esta versión es ideal para usuarios que quieren probar las funciones principales de Evertag sin suscripción. Puedes editar más de 120 etiquetas de audio, gestionar tus archivos directamente desde la nube y organizar tu biblioteca musical con el gestor de archivos integrado.<br><br>

**Evertag Premium (mensual, anual o de por vida)**  <br>
La actualización a Premium elimina los anuncios y desbloquea todo el potencial de Evertag. Obtienes acceso ilimitado a todas las funciones: edita más de 120 etiquetas, edición por lotes de múltiples archivos, corrige codificación y gestiona favoritos ilimitados. Puedes conectar servicios de almacenamiento en la nube ilimitados, realizar búsquedas automáticas de etiquetas ilimitadas y buscar portadas de álbum ilimitadas.<br><br>

Los usuarios Premium también obtienen acceso a la configuración completa de personalización, incluyendo la posibilidad de cambiar el icono de la app y el tema. Este plan es ideal para coleccionistas de música, DJs o cualquier persona que gestione grandes bibliotecas musicales en diferentes dispositivos y plataformas en la nube.<br><br>

**Opciones de precios**  <br>
• Premium mensual — $1.99/mes  <br>
• Premium anual — $12.99/año  <br>
• Premium de por vida — $24.99 (compra única)  <br><br>
...
El token de autenticación es una clave digital que permite a las aplicaciones de terceros interactuar con el almacenamiento en la nube. El token de autenticación se almacena en tu dispositivo en el almacenamiento seguro del sistema llamado Keychain. Puedes descargar tus archivos del servicio en la nube conectado al dispositivo y esos archivos se colocarán en el directorio «Documents» de la app. Puedes eliminar esos archivos en cualquier momento usando el gestor de archivos integrado.<br>
...
Para rechazar el token de autenticación, inicia sesión en tu cuenta en el navegador web y navega a la página de configuración. Allí puedes encontrar todas las aplicaciones de terceros conectadas a tu cuenta en la nube y eliminar cualquiera de ellas si ya no deseas usar esa aplicación.<br><br>
...
Navega a tu carpeta de música, toca «Abrir» para confirmar tu selección y los archivos se añadirán al editor de etiquetas.<br>
Estos archivos se editarán directamente desde la ubicación seleccionada sin ser copiados al paquete de la aplicación.<br><br>

**Añadir una carpeta del dispositivo para acceso rápido**<br>
Simplifica el proceso añadiendo una carpeta ubicada en tu dispositivo a tu sección de acceso rápido.<br>
De esta manera, no necesitarás repetir los pasos cada vez que quieras editar etiquetas de los archivos en la carpeta de música.<br>
Abre la pantalla «Archivos locales».<br>
...
* Desplázate hacia abajo hasta la sección «Letras no sincronizadas» y toca el campo de texto.<br>
* Toca el elemento de menú «Añadir nueva página».<br>
* En la sección «Idioma», selecciona el idioma de las letras o déjalo en blanco para usar inglés por defecto.<br>
* En la sección «Texto», introduce tus letras en texto plano o formato LRC con códigos de tiempo. Se muestra un ejemplo en la pantalla. También puedes encontrar letras en formato LRC en [lyricsify.com](https://www.lyricsify.com/)<br>
* Toca «Hecho» para confirmar los cambios tanto en la pantalla actual como en la pantalla de edición de letras.<br>
* Cierra la pantalla de edición de letras y toca «Guardar» para aplicar los cambios al archivo actual.<br><br>
...
Introduce la dirección IP de la computadora y el nombre de la carpeta compartida en el campo URL con el formato smb://dirección-ip-computadora/nombre-carpeta-compartida,<br>
introduce usuario y contraseña y toca «Hecho».<br>
Si la conexión es exitosa verás el almacenamiento conectado en la sección «Almacenamiento en la nube».<br><br>
...
La URL debe estar en formato http://nombre-servidor o https://nombre-servidor si el servidor soporta SSL.<br><br>
...
**Wi-Fi Drive** es una tecnología popular que te permite transferir archivos de tu computadora a un dispositivo iOS de forma inalámbrica usando un navegador de escritorio.<br>
Para usar esta función, tu dispositivo y computadora deben estar conectados a la misma red Wi-Fi.<br>
Abre «Conexiones» → «Computadora» → «Conectar vía Wi-Fi» y activa el servidor.<br>
Luego abre un navegador de escritorio e introduce la URL de la aplicación.<br>
Puedes arrastrar y soltar archivos de tu computadora a la página web abierta y aparecerán en el dispositivo.<br><br>
...
**Compartir archivos de iTunes** es otra tecnología que te permite transferir archivos de la computadora al dispositivo usando iTunes y cable lightning.<br>
Solo conecta el dispositivo a la computadora con un cable y ejecuta iTunes.<br>
Abre iTunes → «Sección de aplicaciones» → y encuentra Evertag.<br>
Toca el icono de la app para ver una carpeta compartida.<br>
...
Para descargar archivos de la nube:<br>
– Abre el servicio de almacenamiento en la nube conectado.<br>
...
Puedes navegar y gestionar tus archivos usando el gestor de archivos integrado. La app soporta todas las operaciones básicas de archivos como renombrar, eliminar, mover y más.<br><br>
...
• **Mostrar mensaje de confirmación** – Cuando está activado, la app te pedirá confirmación antes de actualizar el archivo en la nube.<br>
• **Actualizar automáticamente los metadatos del archivo** – Cuando está activado, la app aplicará los cambios al archivo en la nube justo después de guardar.<br>
...
Acciones disponibles para archivos seleccionados:<br>
• <strong>Descargar</strong> – Descarga un archivo o carpeta del almacenamiento en la nube a la sección «Archivos locales».<br>
• <strong>Mover</strong> – Mueve un archivo o carpeta a una carpeta diferente dentro del almacenamiento en la nube.<br>
• <strong>Renombrar</strong> – Renombra un archivo o carpeta en el almacenamiento remoto.<br>
• <strong>Eliminar</strong> – Elimina permanentemente un archivo o carpeta del almacenamiento en la nube.<br>
• <strong>Ordenar</strong> – Ordena archivos por nombre, tamaño o fecha de edición.<br>
...
• Desplázate hasta el final de la pantalla.<br>
...
{{< cards >}}
  {{< card icon="location-marker" title="Navegación" subtitle="Aprende cómo navegar fácilmente en nuestra app usando la barra de pestañas (para usuarios de iPhone) o el menú izquierdo (para usuarios de iPad y Mac) para acceder y explorar todas las funciones de la app." link="/docs/guide/evertag/evertag-guide-navigation" >}}

  {{< card icon="cloud" title="Conexiones" subtitle="Conecta fácilmente todas tus cuentas en la nube disponibles con tus valiosos archivos de audio. Incluso puedes editar tus archivos en línea fácilmente con nuestro gestor de archivos integrado." link="/docs/guide/evertag/evertag-guide-connections" >}}

  {{< card icon="folder" title="Archivos locales" subtitle="Visualiza y organiza archivos almacenados en la carpeta Documents de la app o en tu dispositivo. Usa el gestor de archivos integrado para editar y gestionar tus archivos de audio con facilidad." link="/docs/guide/evertag/evertag-guide-local-files" >}}

  {{< card icon="pencil-alt" title="Editor de etiquetas" subtitle="Domina el arte de la manipulación de metadatos de archivos de audio. Descubre cómo editar metadatos, cambiar portadas de álbum y gestionar múltiples archivos simultáneamente sin problemas." link="/docs/guide/evertag/evertag-guide-tag-editor" >}}

  {{< card icon="code" title="Mapeo de campos de etiquetas" subtitle="Explora la lista completa de campos de etiquetas de audio compatibles con la app Evertag, incluyendo nombres de campos internos y mapeos entre los principales formatos de metadatos." link="/docs/guide/evertag/evertag-tag-field-mappings" >}}

  {{< card icon="adjustments" title="Ajustes" subtitle="Descubre cómo personalizar tu experiencia con la app, ajustar el rendimiento, gestionar el uso de datos y adaptar las preferencias de idioma e interfaz de usuario a tu gusto." link="/docs/guide/evertag/evertag-guide-settings" >}}
