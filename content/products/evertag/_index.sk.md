...
draft: false
title: 'Evertag - Editor Hudobných Tagov pre iPhone a Mac'
layout: hextra-home
...
• Úprava audio tagov<br>
• Úprava obalov albumov<br>
• Súčasná úprava súborov<br>
• Oprava kódovania znakov<br>
• Cloudové úložiská (1)<br>
• Obľúbené (10)<br>
• Automatické vyhľadávanie tagov (20/deň)<br>
• Vyhľadávanie obalov albumov (20/deň)</span><br /><br />
...
• Súčasná úprava súborov<br>
• Oprava kódovania znakov<br>
• Cloudové úložiská (neobmedzene)<br />
• Obľúbené (neobmedzene)<br />
• Automatické vyhľadávanie tagov (neobmedzene)<br />
• Vyhľadávanie obalov albumov (neobmedzene)<br />
• Personalizácia</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  <span class='pricing-btn hx:inline-block hx:rounded-full hx:border hx:border-gray-200 hx:dark:border-neutral-800 hx:px-3 hx:py-1 hx:transition-all hx:duration-200'>
...
Táto verzia je skvelá pre používateľov, ktorí chcú vyskúšať základné funkcie Evertag bez predplatného. Môžete upraviť viac ako 120 audio tagov, spravovať súbory priamo z cloudu a organizovať svoju hudobnú knižnicu pomocou vstavaného správcu súborov.<br><br>

**Evertag Premium (Mesačne, Ročne alebo Doživotne)**  <br>
Upgrade na Premium odstráni reklamy a odomkne plný potenciál Evertag. Získate neobmedzený prístup ku všetkým funkciám: úprava viac ako 120+ tagov, hromadná úprava viacerých súborov, oprava kódovania a správa neobmedzených obľúbených. Môžete pripojiť neobmedzený počet cloudových úložísk, vykonávať neobmedzené automatické vyhľadávanie tagov a vyhľadávať neobmedzené obaly albumov.<br><br>

Používatelia Premium majú tiež prístup k úplným nastaveniam personalizácie vrátane možnosti zmeniť ikonu aplikácie a tému. Tento plán je ideálny pre zberateľov hudby, DJ-ov alebo kohokoľvek, kto spravuje veľké hudobné knižnice na rôznych zariadeniach a cloudových platformách.<br><br>

**Cenové Možnosti**  <br>
• Premium Mesačne — $1.99/mesiac  <br>
• Premium Ročne — $12.99/rok  <br>
• Premium Doživotne — $24.99 (jednorazový nákup)  <br><br>
...
Autorizačný token je digitálny kľúč, ktorý umožňuje aplikáciám tretích strán interagovať s cloudovým úložiskom. Autorizačný token je uložený na vašom zariadení v zabezpečenom systémovom úložisku Keychain. Môžete stiahnuť súbory z pripojenej cloudovej služby do zariadenia a tieto súbory budú umiestnené v priečinku „Documents" aplikácie. Tieto súbory môžete kedykoľvek odstrániť pomocou vstavaného správcu súborov.<br>
...
Na zrušenie autorizačného tokenu sa prihláste do svojho účtu vo webovom prehliadači a prejdite na stránku nastavení. Tam nájdete všetky aplikácie tretích strán pripojené k vášmu cloudovému účtu a môžete odstrániť ktorúkoľvek z nich, ak už nechcete používať danú aplikáciu.<br><br>
...
Prejdite do hudobného priečinka, ťuknite na „Otvoriť" na potvrdenie výberu a súbory budú pridané do editora tagov.<br>
Tieto súbory budú upravované priamo z vybraného umiestnenia bez kopírovania do balíka aplikácie.<br><br>

**Pridanie Priečinka Zariadenia pre Rýchly Prístup**<br>
Zjednodušte proces pridaním priečinka na vašom zariadení do sekcie rýchleho prístupu.<br>
Takto nebudete musieť opakovať kroky zakaždým, keď chcete upraviť tagy pre súbory v hudobnom priečinku.<br>
Otvorte obrazovku „Lokálne súbory".<br>
...
* Posuňte sa nadol do sekcie „Nesynchronizované texty" a ťuknite na textové pole.<br>
* Ťuknite na položku menu „Pridať novú stránku".<br>
* V sekcii „Jazyk" vyberte jazyk textu alebo nechajte prázdne pre použitie angličtiny predvolene.<br>
* V sekcii „Text" zadajte texty v obyčajnom texte alebo formáte LRC s časovými kódmi. Príklad je zobrazený na obrazovke. Texty vo formáte LRC môžete tiež nájsť na [lyricsify.com](https://www.lyricsify.com/)<br>
* Ťuknite na „Hotovo" na potvrdenie zmien na aktuálnej obrazovke aj na obrazovke Úpravy Textov.<br>
* Zatvorte obrazovku Úpravy Textov a ťuknite na „Uložiť" na použitie zmien pre aktuálny súbor.<br><br>
...
**Wi-Fi Drive** je populárna technológia, ktorá vám umožňuje prenášať súbory z počítača na iOS zariadenie bezdrôtovo pomocou desktopového prehliadača.<br>
Na použitie tejto funkcie musia byť vaše zariadenie a počítač pripojené k rovnakej Wi-Fi sieti.<br>
Otvorte „Pripojenia" → „Počítač" → „Pripojiť cez Wi-Fi" a povoľte server.<br>
Potom otvorte desktopový prehliadač a zadajte URL z aplikácie.<br>
Môžete presunúť súbory z počítača na otvorenú webovú stránku a zobrazia sa na zariadení.<br><br>

Podrobnejší návod je dostupný tu:<br>
[Ako preniesť súbory bezdrôtovo z počítača na iPhone pomocou WiFi-Drive](/docs/howto/how-to-transfer-files-wirelessly-from-a-computer-to-an-iphone-using-wifi-drive)<br><br>

**iTunes File Sharing** je ďalšia technológia, ktorá vám umožňuje prenášať súbory z počítača na zariadenie pomocou iTunes a lightning kábla.<br>
Stačí pripojiť zariadenie k počítaču pomocou kábla a spustiť iTunes.<br>
Otvorte iTunes → „Sekcia Aplikácie" → a nájdite Evertag.<br>
...
Na stiahnutie súborov z cloudu:<br>
...
Môžete prehliadať a spravovať súbory pomocou vstavaného správcu súborov. Aplikácia podporuje všetky základné operácie so súbormi ako premenovanie, vymazanie, presun a ďalšie.<br><br>
...
• **Zobraziť potvrdzovaciu správu** – Keď je povolené, aplikácia vás pred aktualizáciou súboru v cloude vyzve potvrdením.<br>
• **Automaticky aktualizovať metadáta súboru** – Keď je povolené, aplikácia použije zmeny na cloudový súbor hneď po uložení.<br>
...
Dostupné akcie pre vybrané súbory:<br>
• <strong>Stiahnuť</strong> – Stiahnuť súbor alebo priečinok z cloudového úložiska do sekcie „Lokálne Súbory".<br>
• <strong>Presunúť</strong> – Presunúť súbor alebo priečinok do iného priečinka v cloudovom úložisku.<br>
• <strong>Premenovať</strong> – Premenovať súbor alebo priečinok na vzdialenom úložisku.<br>
• <strong>Vymazať</strong> – Natrvalo vymazať súbor alebo priečinok z cloudového úložiska.<br>
• <strong>Zoradiť</strong> – Zoradiť súbory podľa názvu, veľkosti alebo dátumu úpravy.<br>
...
• Posuňte sa na koniec obrazovky.<br>
...
{{< cards >}}
  {{< card icon="location-marker" title="Navigácia" subtitle="Naučte sa, ako jednoducho navigovať v aplikácii pomocou Panela Záložiek (pre používateľov iPhone) alebo Ľavého Menu (pre používateľov iPad a Mac) na prístup a preskúmanie všetkých funkcií aplikácie." link="/docs/guide/evertag/evertag-guide-navigation" >}}

  {{< card icon="cloud" title="Pripojenia" subtitle="Jednoducho prepojte všetky dostupné cloudové účty s vašimi cennými audio súbormi. Môžete dokonca upravovať online súbory jednoducho pomocou vstavaného správcu súborov." link="/docs/guide/evertag/evertag-guide-connections" >}}

  {{< card icon="folder" title="Lokálne Súbory" subtitle="Zobrazte a organizujte súbory uložené v priečinku Documents aplikácie alebo na zariadení. Použite vstavaný správca súborov na úpravu a správu audio súborov s ľahkosťou." link="/docs/guide/evertag/evertag-guide-local-files" >}}

  {{< card icon="pencil-alt" title="Editor Tagov" subtitle="Ovládnite umenie manipulácie s metadátami audio súborov. Zistite, ako upravovať metadáta, meniť obaly albumov a bezproblémovo spravovať viacero súborov súčasne." link="/docs/guide/evertag/evertag-guide-tag-editor" >}}

  {{< card icon="code" title="Mapovanie Polí Tagov" subtitle="Preskúmajte úplný zoznam polí audio tagov podporovaných aplikáciou Evertag, vrátane interných názvov polí a mapovaní medzi hlavnými formátmi metadát." link="/docs/guide/evertag/evertag-tag-field-mappings" >}}

  {{< card icon="adjustments" title="Nastavenia" subtitle="Objavte, ako prispôsobiť zážitok z aplikácie, vyladiť výkon, spravovať využitie dát a prispôsobiť jazykové preferencie a používateľské rozhranie podľa vašich predstáv." link="/docs/guide/evertag/evertag-guide-settings" >}}
