...
• Audió címkék szerkesztése<br>
• Borítóképek szerkesztése<br>
• Fájlok egyidejű szerkesztése<br>
• Karakterkódolás javítása<br>
• Felhőtárhelyek (1)<br>
• Kedvencek (10)<br>
• Automatikus címkekeresés (20/nap)<br>
• Borítóképek keresése (20/nap)</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  ...
  {{< hextra/feature-card
    ...
    subtitle=`<span class='pricing-details'>• Hirdetésmentes<br />
• Audió címkék szerkesztése<br>
• Borítóképek szerkesztése<br>
• Fájlok egyidejű szerkesztése<br>
• Karakterkódolás javítása<br>
• Felhőtárhelyek (korlátlan)<br />
• Kedvencek (korlátlan)<br />
• Automatikus címkekeresés (korlátlan)<br />
• Borítóképek keresése (korlátlan)<br />
• Személyre szabás</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  <span class='pricing-btn hx:inline-block hx:rounded-full hx:border hx:border-gray-200 hx:dark:border-neutral-800 hx:px-3 hx:py-1 hx:transition-all hx:duration-200'>
...
<span class='hx:block hx:mt-2 hx:text-center'>
  <span class='pricing-btn hx:inline-block hx:rounded-full hx:border hx:border-gray-200 hx:dark:border-neutral-800 hx:px-3 hx:py-1 hx:transition-all hx:duration-200'>
    7 nap ingyenes, aztán <strong>$12.99</strong>/év
  </span>
</span>`
  >}}
...
<span class='hx:block hx:mt-2 hx:text-center'>
  <span class='pricing-btn hx:inline-block hx:rounded-full hx:border hx:border-gray-200 hx:dark:border-neutral-800 hx:px-3 hx:py-1 hx:transition-all hx:duration-200'>
    <strong>$24.99</strong>/élethosszig
  </span>
</span>`
  >}}
...
Ez a verzió remek azoknak a felhasználóknak, akik előfizetés nélkül szeretnék kipróbálni az Evertag alapvető funkcióit. 120-nál több audió címkét szerkeszthet, közvetlenül a felhőből kezelheti fájljait, és a beépített fájlkezelővel rendezheti zenei könyvtárát.<br><br>

**Evertag Premium (havi, éves vagy élethosszig)**  <br>
A Prémiumra való frissítés eltávolítja a hirdetéseket és feloldja az Evertag teljes potenciálját. Korlátlan hozzáférést kap minden funkcióhoz: 120+ címke szerkesztése, több fájl kötegelt szerkesztése, kódolás javítása és korlátlan kedvencek kezelése. Korlátlan számú felhőtárhely szolgáltatást csatlakoztathat, korlátlan automatikus címkekeresést végezhet és korlátlanul kereshet borítóképeket.<br><br>

A Prémium felhasználók teljes személyre szabási beállításokhoz is hozzáférnek, beleértve az alkalmazás ikonjának és témájának megváltoztatását. Ez a terv ideális zenegyűjtők, DJ-k vagy bárki számára, aki nagy zenei könyvtárakat kezel különböző eszközökön és felhőplatformokon.<br><br>

**Árazási lehetőségek**  <br>
• Prémium havi — $1.99/hó  <br>
• Prémium éves — $12.99/év  <br>
• Prémium élethosszig — $24.99 (egyszeri vásárlás)  <br><br>
...
Az auth-token egy digitális kulcs, amely lehetővé teszi harmadik féltől származó alkalmazások számára a felhőtárhellyel való interakciót. Az auth-token az eszközén van tárolva egy Keychain nevű biztonságos rendszertárhelyen. Letöltheti fájljait a csatlakoztatott felhőszolgáltatásból az eszközre, és ezek a fájlok az alkalmazás "Documents" könyvtárába kerülnek. Ezeket a fájlokat bármikor eltávolíthatja a beépített fájlkezelővel.<br>
Az alkalmazás nem oszt meg semmilyen információt a csatlakoztatott felhőfiókból. Bármikor visszavonhatja a felhőfiókjához való hozzáférést a fiókbeállítások oldalának megnyitásával a böngészőjében.<br><br>

Az auth-token elutasításához jelentkezzen be fiókjába a böngészőben és navigáljon a beállítások oldalra. Ott megtalálja az összes harmadik féltől származó alkalmazást, amely csatlakoztatva van a felhőfiókjához, és eltávolíthatja bármelyiket, ha már nem kívánja használni azt az alkalmazást.<br><br>
...
Navigáljon a zenei mappájához, érintse meg az "Open" gombot a kiválasztás megerősítéséhez, és a fájlok hozzáadódnak a címkeszerkesztőhöz.<br>
Ezek a fájlok közvetlenül a kiválasztott helyről lesznek szerkesztve, az alkalmazáscsomagba való másolás nélkül.<br><br>

**Eszközmappa hozzáadása a gyors hozzáféréshez**<br>
Egyszerűsítse a folyamatot az eszközön található mappa hozzáadásával a gyors hozzáférés szakaszhoz.<br>
Így nem kell minden alkalommal megismételnie a lépéseket, amikor a zenei mappában lévő fájlok címkéit szeretné szerkeszteni.<br>
Nyissa meg a "Local files" képernyőt.<br>
...
* Görgessen le a "Lyrics unsynced" szakaszhoz és érintse meg a szövegmezőt.<br>
* Érintse meg az "Add new page" menüpontot.<br>
* A "Language" szakaszban válassza ki a dalszöveg nyelvét, vagy hagyja üresen az alapértelmezett angol használatához.<br>
* A "Text" szakaszban adja meg dalszövegét egyszerű szövegben vagy LRC formátumban időkódokkal. Egy példa látható a képernyőn. LRC-formátumú dalszövegeket a [lyricsify.com](https://www.lyricsify.com/) oldalon is találhat<br>
* Érintse meg a "Done" gombot a módosítások megerősítéséhez az aktuális képernyőn és a dalszöveg-szerkesztő képernyőn egyaránt.<br>
* Zárja be a dalszöveg-szerkesztő képernyőt és érintse meg a "Save" gombot a módosítások alkalmazásához az aktuális fájlon.<br><br>
...
Adja meg a számítógép IP-címét és a megosztott mappa nevét az URL mezőben smb://computer-ip-address/shared-folder-name formátumban,<br>
adja meg a bejelentkezési nevet és jelszót, majd érintse meg a "Done" gombot.<br>
Sikeres kapcsolat esetén a csatlakoztatott tárhely megjelenik a "Cloud storage" szakaszban.<br><br>
...
**WebDAV** protokoll esetén az összes lépés ugyanaz, kivéve az URL mezőt.<br>
Az URL formátuma http://server-name vagy https://server-name legyen, ha a szerver támogatja az SSL-t.<br><br>

Teljes útmutató itt érhető el:<br>
[Hogyan csatlakoztassunk NAS tárhelyet WebDAV használatával és hallgassunk zenét iPhone-on vagy Mac-en](/docs/howto/how-to-connect-nas-storage-using-webdav-and-listen-to-music-on-your-iphone-or-mac)<br><br>

**Wi-Fi Drive** egy népszerű technológia, amely lehetővé teszi fájlok vezeték nélküli átvitelét számítógépéről iOS eszközére asztali böngésző segítségével.<br>
Ennek a funkciónak a használatához az eszköznek és a számítógépnek ugyanahhoz a Wi-Fi hálózathoz kell csatlakoznia.<br>
Nyissa meg a "Connections" → "Computer" → "Connect via Wi-Fi" menüt és engedélyezze a szervert.<br>
Ezután nyisson meg egy asztali böngészőt és adja meg az alkalmazásban látható URL-t.<br>
Húzza a fájlokat a számítógépéről a megnyitott weboldalra, és azok megjelennek az eszközön.<br><br>

Részletesebb útmutató itt érhető el:<br>
[Hogyan vigyünk át fájlokat vezeték nélkül számítógépről iPhone-ra WiFi-Drive használatával](/docs/howto/how-to-transfer-files-wirelessly-from-a-computer-to-an-iphone-using-wifi-drive)<br><br>

**iTunes File Sharing** egy másik technológia, amely lehetővé teszi fájlok átvitelét számítógépről eszközre iTunes és lightning kábel használatával.<br>
Egyszerűen csatlakoztassa az eszközt a számítógéphez kábellel és indítsa el az iTunes-t.<br>
Nyissa meg az iTunes → "Applications section" → és keresse meg az Evertag-et.<br>
Érintse meg az alkalmazás ikonját a megosztott mappa megtekintéséhez.<br>
Másolja a fájlokat a számítógépről a megosztott mappába az eszközön.<br><br>
...
Fájlok letöltése a felhőből:<br>
– Nyissa meg a csatlakoztatott felhőtárhely szolgáltatást.<br>
...
Fájljait a beépített fájlkezelővel böngészheti és kezelheti. Az alkalmazás támogat minden alapvető fájlműveletet, mint az átnevezés, törlés, áthelyezés és más műveleteket.<br><br>
...
• **Megerősítő üzenet megjelenítése** – Ha engedélyezve van, az alkalmazás megerősítő üzenetet jelenít meg a felhőben lévő fájl frissítése előtt.<br>
• **A fájl metaadatainak automatikus frissítése** – Ha engedélyezve van, az alkalmazás a mentés után azonnal alkalmazza a módosításokat a felhőfájlon.<br>
...
Elérhető műveletek a kiválasztott fájlokhoz:<br>
• <strong>Letöltés</strong> – Fájl vagy mappa letöltése a felhőtárhelyről a "Local Files" szakaszba.<br>
• <strong>Áthelyezés</strong> – Fájl vagy mappa áthelyezése másik mappába a felhőtárhelyen belül.<br>
• <strong>Átnevezés</strong> – Fájl vagy mappa átnevezése a távoli tárhelyen.<br>
• <strong>Törlés</strong> – Fájl vagy mappa végleges törlése a felhőtárhelyről.<br>
• <strong>Rendezés</strong> – Fájlok rendezése név, méret vagy szerkesztés dátuma szerint.<br>
...
• Görgessen a képernyő aljára.<br>
