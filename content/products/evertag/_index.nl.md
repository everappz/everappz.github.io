...
draft: false
title: 'Evertag - Muziek Tag Editor voor iPhone en Mac'
layout: hextra-home
...
• Audiotags bewerken<br>
• Albumhoezen bewerken<br>
• Bestanden gelijktijdig bewerken<br>
• Tekencodering herstellen<br>
• Cloudopslag (1)<br>
• Favorieten (10)<br>
• Automatisch tags zoeken (20/dag)<br>
• Albumhoezen zoeken (20/dag)</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  ...
  {{< hextra/feature-card
    ...
    subtitle=`<span class='pricing-details'>• Geen advertenties<br />
• Audiotags bewerken<br>
• Albumhoezen bewerken<br>
• Bestanden gelijktijdig bewerken<br>
• Tekencodering herstellen<br>
• Cloudopslag (onbeperkt)<br />
• Favorieten (onbeperkt)<br />
• Automatisch tags zoeken (onbeperkt)<br />
• Albumhoezen zoeken (onbeperkt)<br />
• Personalisatie</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  <span class='pricing-btn hx:inline-block hx:rounded-full hx:border hx:border-gray-200 hx:dark:border-neutral-800 hx:px-3 hx:py-1 hx:transition-all hx:duration-200'>
...
<span class='hx:block hx:mt-2 hx:text-center'>
  <span class='pricing-btn hx:inline-block hx:rounded-full hx:border hx:border-gray-200 hx:dark:border-neutral-800 hx:px-3 hx:py-1 hx:transition-all hx:duration-200'>
    <strong>$24.99</strong>/levenslang
  </span>
</span>`
  >}}
...
Deze versie is geweldig voor gebruikers die de kernfuncties van Evertag willen uitproberen zonder abonnement. Je kunt meer dan 120 audiotags bewerken, je bestanden rechtstreeks vanuit de cloud beheren en je muziekbibliotheek organiseren met de ingebouwde bestandsbeheerder.<br><br>

**Evertag Premium (Maandelijks, Jaarlijks of Levenslang)**  <br>
Upgraden naar Premium verwijdert advertenties en ontgrendelt het volledige potentieel van Evertag. Je krijgt onbeperkte toegang tot alle functies: bewerk meer dan 120+ tags, batch bewerk meerdere bestanden, herstel codering en beheer onbeperkte favorieten. Je kunt onbeperkte cloudopslagdiensten verbinden, onbeperkte automatische tagzoekopdrachten uitvoeren en onbeperkt albumhoezen zoeken.<br><br>

Premium-gebruikers krijgen ook toegang tot volledige personalisatie-instellingen, inclusief de mogelijkheid om het app-icoon en thema te wijzigen. Dit plan is ideaal voor muziekverzamelaars, DJ's of iedereen die grote muziekbibliotheken beheert op verschillende apparaten en cloudplatforms.<br><br>

**Prijsopties**  <br>
• Premium Maandelijks — $1.99/maand  <br>
• Premium Jaarlijks — $12.99/jaar  <br>
• Premium Levenslang — $24.99 (eenmalige aankoop)  <br><br>
...
Auth-token is een digitale sleutel waarmee applicaties van derden kunnen communiceren met cloudopslag. Auth-token wordt opgeslagen op je apparaat in een veilige systeemopslag genaamd Keychain. Je kunt je bestanden downloaden van de verbonden clouddienst naar het apparaat en die bestanden worden geplaatst in de "Documenten" map van de app. Je kunt die bestanden op elk moment verwijderen met de ingebouwde bestandsbeheerder.<br>
...
Om het auth-token in te trekken, log in op je account in de webbrowser en navigeer naar de instellingenpagina. Daar kun je alle applicaties van derden vinden die verbonden zijn met je cloudaccount en ze verwijderen als je die applicatie niet meer wilt gebruiken.<br><br>
...
Navigeer naar je muziekmap, tik op "Open" om je selectie te bevestigen en de bestanden worden toegevoegd aan de tag editor.<br>
Deze bestanden worden direct bewerkt vanaf de geselecteerde locatie zonder te worden gekopieerd naar de applicatiebundel.<br><br>

**Een Apparaatmap Toevoegen voor Snelle Toegang**<br>
Vereenvoudig het proces door een map op je apparaat toe te voegen aan je snelle toegang sectie.<br>
Op deze manier hoef je de stappen niet elke keer te herhalen wanneer je tags wilt bewerken voor bestanden in de muziekmap.<br>
Open het scherm "Lokale bestanden".<br>
...
* Scroll naar beneden naar het gedeelte "Niet-gesynchroniseerde songteksten" en tik op het tekstveld.<br>
* Tik op het menu-item "Nieuwe pagina toevoegen".<br>
* In het gedeelte "Taal" selecteer je de taal van de songtekst of laat je het leeg om standaard Engels te gebruiken.<br>
* In het gedeelte "Tekst" voer je je songteksten in als platte tekst of LRC-formaat met tijdcodes. Een voorbeeld wordt op het scherm getoond. Je kunt ook LRC-geformatteerde songteksten vinden op [lyricsify.com](https://www.lyricsify.com/)<br>
* Tik op "Gereed" om de wijzigingen te bevestigen op zowel het huidige scherm als het Songtekst Bewerk scherm.<br>
* Sluit het Songtekst Bewerk scherm en tik op "Opslaan" om de wijzigingen toe te passen op het huidige bestand.<br><br>
...
voer inloggegevens en wachtwoord in en tik op "Gereed".<br>
Als je verbinding succesvol is, zie je de verbonden opslag in het gedeelte "Cloudopslag".<br><br>

Een volledige tutorial is hier beschikbaar:<br>
[Draag je bestanden over van de computer naar iPhone via het SMB protocol](/docs/howto/transfer-your-files-from-the-computer-to-iphone-using-smb-protocol/)<br><br>

Voor het **WebDAV** protocol zijn alle stappen hetzelfde behalve het URL-veld.<br>
De URL moet het formaat http://server-naam of https://server-naam hebben als de server SSL ondersteunt.<br><br>

Een volledige tutorial is hier beschikbaar:<br>
[Hoe NAS-opslag Verbinden via WebDAV en Muziek Luisteren op je iPhone of Mac](/docs/howto/how-to-connect-nas-storage-using-webdav-and-listen-to-music-on-your-iphone-or-mac)<br><br>

**Wi-Fi Drive** is een populaire technologie waarmee je draadloos bestanden kunt overdragen van je computer naar een iOS-apparaat via een desktopbrowser.<br>
...
Open daarna een desktopbrowser en voer de URL in vanuit de applicatie.<br>
Je kunt bestanden slepen en neerzetten van je computer naar de geopende webpagina en ze verschijnen op het apparaat.<br><br>

Meer gedetailleerde tutorial beschikbaar hier:<br>
[Hoe bestanden draadloos overdragen van een computer naar een iPhone via WiFi-Drive](/docs/howto/how-to-transfer-files-wirelessly-from-a-computer-to-an-iphone-using-wifi-drive)<br><br>

**iTunes Bestandsdeling** is een andere technologie waarmee je bestanden kunt overdragen van computer naar apparaat via iTunes en een lightning-kabel.<br>
Verbind gewoon een apparaat met de computer via een kabel en start iTunes.<br>
Open iTunes → "Applicaties sectie" → en vind Evertag.<br>
Tik op het app-icoon om een gedeelde map te zien.<br>
...
Om bestanden uit de cloud te downloaden:<br>
– Open de verbonden cloudopslagdienst.<br>
...
Je kunt je bestanden doorzoeken en beheren met de ingebouwde bestandsbeheerder. De app ondersteunt alle basis bestandsbewerkingen zoals hernoemen, verwijderen, verplaatsen en meer.<br><br>
...
• **Bevestigingsbericht tonen** – Wanneer ingeschakeld, zal de app je vragen met een bevestigingsbericht voordat het bestand in de cloud wordt bijgewerkt.<br>
• **Metadata van bestand automatisch bijwerken** – Wanneer ingeschakeld, zal de app de wijzigingen direct na het opslaan toepassen op het cloudbestand.<br>
...
Beschikbare acties voor geselecteerde bestanden:<br>
• <strong>Downloaden</strong> – Download een bestand of map van cloudopslag naar het gedeelte "Lokale Bestanden".<br>
• <strong>Verplaatsen</strong> – Verplaats een bestand of map naar een andere map binnen de cloudopslag.<br>
• <strong>Hernoemen</strong> – Hernoem een bestand of map op de externe opslag.<br>
• <strong>Verwijderen</strong> – Verwijder een bestand of map permanent van de cloudopslag.<br>
• <strong>Sorteren</strong> – Sorteer bestanden op naam, grootte of bewerkingsdatum.<br>
...
• Scroll naar de onderkant van het scherm.<br>
