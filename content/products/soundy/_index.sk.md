...
sidebar:
  exclude: true
title: 'Soundy - Ekvalizér pre SoundCloud'
layout: hextra-home
...
Soundy bol odstránený z App Store, pretože ho nemôžeme podporovať kvôli zmenám v API SoundCloud
  </a>
{{< /hextra/hero-subtitle >}}
</div>

{{< hextra/hero-button 
  text="Pozrite si naše ďalšie aplikácie"
  link="/products"
>}}
