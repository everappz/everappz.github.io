...
sidebar:
  exclude: true
title: 'Soundy - Equalizer voor SoundCloud'
layout: hextra-home
...
Soundy is verwijderd uit de App Store omdat we het niet kunnen ondersteunen vanwege wijzigingen in de SoundCloud API
  </a>
{{< /hextra/hero-subtitle >}}
</div>

{{< hextra/hero-button 
  text="Bekijk onze andere apps"
  link="/products"
>}}
