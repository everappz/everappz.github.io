...
sidebar:
  exclude: true
title: 'Soundy - Equalizzatore per SoundCloud'
layout: hextra-home
...
Soundy è stato rimosso dall'App Store perché non possiamo supportarlo a causa delle modifiche all'API di SoundCloud
  </a>
{{< /hextra/hero-subtitle >}}
</div>

{{< hextra/hero-button 
  text="Scopri le nostre altre app"
  link="/products"
>}}
