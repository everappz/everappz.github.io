...
sidebar:
  exclude: true
title: 'Soundy - Egalizator pentru SoundCloud'
layout: hextra-home
...
Soundy a fost eliminat din App Store deoarece nu îl putem susține din cauza modificărilor API-ului SoundCloud
  </a>
{{< /hextra/hero-subtitle >}}
</div>

{{< hextra/hero-button 
  text="Descoperiți celelalte aplicații ale noastre"
  link="/products"
>}}
