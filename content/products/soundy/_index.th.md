...
sidebar:
  exclude: true
title: 'Soundy - อีควอไลเซอร์สำหรับ SoundCloud'
layout: hextra-home
...
Soundy ถูกลบออกจาก App Store เนื่องจากเราไม่สามารถสนับสนุนได้เพราะการเปลี่ยนแปลง API ของ SoundCloud
  </a>
{{< /hextra/hero-subtitle >}}
</div>

{{< hextra/hero-button 
  text="ดูแอปอื่นๆ ของเรา"
  link="/products"
>}}
