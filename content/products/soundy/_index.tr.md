...
sidebar:
  exclude: true
title: 'Soundy - SoundCloud için Ekolayzır'
layout: hextra-home
...
SoundCloud API değişiklikleri nedeniyle destekleyemediğimiz için Soundy App Store'dan kaldırıldı
  </a>
{{< /hextra/hero-subtitle >}}
</div>

{{< hextra/hero-button 
  text="Diğer uygulamalarımıza göz atın"
  link="/products"
>}}
