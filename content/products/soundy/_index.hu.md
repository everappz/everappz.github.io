...
sidebar:
  exclude: true
title: 'Soundy - Hangszínszabályzó a SoundCloudhoz'
layout: hextra-home
...
A Soundy eltávolításra került az App Store-ból, mert a SoundCloud API változásai miatt nem tudjuk támogatni
  </a>
{{< /hextra/hero-subtitle >}}
</div>

{{< hextra/hero-button 
  text="Nézze meg többi alkalmazásunkat"
  link="/products"
>}}
