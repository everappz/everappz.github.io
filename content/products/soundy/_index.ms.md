...
sidebar:
  exclude: true
title: 'Soundy - Penyama untuk SoundCloud'
layout: hextra-home
...
Soundy telah dialih keluar dari App Store kerana kami tidak dapat menyokongnya disebabkan perubahan API SoundCloud
  </a>
{{< /hextra/hero-subtitle >}}
</div>

{{< hextra/hero-button 
  text="Lihat aplikasi kami yang lain"
  link="/products"
>}}
