...
sidebar:
  exclude: true
title: 'Soundy - Korektor dźwięku dla SoundCloud'
layout: hextra-home
...
Soundy został usunięty z App Store, ponieważ nie możemy go wspierać z powodu zmian w API SoundCloud
  </a>
{{< /hextra/hero-subtitle >}}
</div>

{{< hextra/hero-button 
  text="Sprawdź nasze inne aplikacje"
  link="/products"
>}}
