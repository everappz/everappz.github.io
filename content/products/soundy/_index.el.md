...
sidebar:
  exclude: true
title: 'Soundy - Ισοσταθμιστής για SoundCloud'
layout: hextra-home
...
Το Soundy αφαιρέθηκε από το App Store επειδή δεν μπορούμε να το υποστηρίξουμε λόγω αλλαγών στο API του SoundCloud
  </a>
{{< /hextra/hero-subtitle >}}
</div>

{{< hextra/hero-button 
  text="Δείτε τις άλλες εφαρμογές μας"
  link="/products"
>}}
