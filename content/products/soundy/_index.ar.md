...
sidebar:
  exclude: true
title: 'Soundy - معادل صوت لـ SoundCloud'
layout: hextra-home
...
تمت إزالة Soundy من App Store لأننا لا نستطيع دعمه بسبب تغييرات واجهة برمجة تطبيقات SoundCloud
  </a>
{{< /hextra/hero-subtitle >}}
</div>

{{< hextra/hero-button 
  text="تحقق من تطبيقاتنا الأخرى"
  link="/products"
>}}
