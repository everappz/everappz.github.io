...
Ubah iPhone atau iPad jadi drive nirkabel&nbsp;<br class="hx:sm:block hx:hidden" />yang berbagi file dengan <strong>perangkat apa pun di jaringan Anda</strong>
{{< /hextra/hero-centered-subtitle >}}
</div>
...
{{< cards cols="4">}}
  ...
  {{< feature-card 
    ...
    method="Fill"
    options="1030x400 q82 webp Center"
    subtitle="Thumbnail pratinjau asli di TV dan di browser, plus galeri foto layar penuh dengan geser dan zoom - bukan sekadar ikon polos." 
  >}}
...
• Proteksi kata sandi dan pemblokiran perangkat<br />
• Hingga 5 folder berbagi dan 10 koneksi tersimpan</span><br /><br />
<span class='hx:block hx:mt-2 hx:text-center'>
  ...
  {{< hextra/feature-card
    ...
    subtitle=`<span class='pricing-details'>• Semua yang ada di Gratis<br />
...
<span class='hx:block hx:mt-2 hx:text-center'>
  <span class='pricing-btn hx:inline-block hx:rounded-full hx:border hx:border-gray-200 hx:dark:border-neutral-800 hx:px-3 hx:py-1 hx:transition-all hx:duration-200'>
    <strong>$9.99</strong>/seumur hidup
  </span>
</span>`
  >}}
...
- Di <strong>Windows</strong>, petakan network drive menggunakan alamat WebDAV yang sama.<br>
