...
Pretvorite iPhone ili iPad u bežični disk&nbsp;<br class="hx:sm:block hx:hidden" />koji dijeli datoteke sa <strong>svakim uređajem na vašoj mreži</strong>
{{< /hextra/hero-centered-subtitle >}}
</div>
...
{{< cards cols="4">}}
  ...
  {{< feature-card 
    ...
    method="Fill"
    options="1030x400 q82 webp Center"
    subtitle="Prave sličice pregleda na TV-ima i u pregledniku, uz galeriju fotografija preko cijelog zaslona s prevlačenjem i zumiranjem - ne obične ikone." 
  >}}
...
- Na <strong>Windowsu</strong> mapirajte mrežni disk pomoću iste WebDAV adrese.<br>
...
Uz to, Everdisk uključuje cijeli skup <strong>PDF alata</strong>, koji se otvaraju iz PDF-ovog izbornika <strong>•••</strong> u pregledniku datoteka:<br>
• <strong>Kompresija</strong> - smanjite PDF, uz procijenjenu veličinu prikazanu prije spremanja.<br>
• <strong>Prepoznavanje teksta (OCR)</strong> - pretvorite skeniran dokument u pretraživi PDF ili izvezite tekst u .txt datoteku.<br>
• <strong>Lozinka</strong> - postavite, promijenite ili uklonite lozinku potrebnu za otvaranje PDF-a.<br>
