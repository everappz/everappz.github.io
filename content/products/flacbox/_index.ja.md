...
{{< cards >}}
  ...
  {{< feature-card title="ロスレスオーディオサポート" subtitle="FLAC、ALAC、WAV、APE、DFF、WV、AIFFなど多くの高品質フォーマットを再生。" icon="music-note" >}}
  {{< feature-card title="オフラインモード" subtitle="アルバム、プレイリスト、トラックをダウンロードしていつでもオフライン再生。" icon="download" >}}
  {{< feature-card title="ファイル管理" subtitle="アプリ内でファイルのコピー、移動、名前変更、削除を簡単に。" icon="folder" >}}

  {{< feature-card title="カスタムプレイリスト" subtitle="プレイリストの作成、編集、並び替え、M3Uファイルのエクスポート・インポート。" icon="collection" >}}
  {{< feature-card title="メディアライブラリ" subtitle="音楽を追加し、タグを使ってアルバム、アーティスト、ジャンル別に整理。" icon="library" >}}
  {{< feature-card title="高度な検索" subtitle="スマート検索ツールで曲、アーティスト、アルバムをすばやく検索。" icon="search" >}}

  {{< feature-card title="クラウドストリーミング" subtitle="Google Drive、Dropbox、OneDrive、iCloud、MEGAなどからストリーミング。" icon="cloud" >}}
  {{< feature-card title="NAS・コンピュータアクセス" subtitle="SMB、DLNA、WebDAVで接続。iTunesやWi-Fiで転送。" icon="desktop-computer" >}}
  {{< feature-card title="USBフラッシュカード" subtitle="iXpandなどのUSBアダプターを使用してSDカードから直接音楽を再生。" icon="inbox" >}}

  {{< feature-card title="再生コントロール" subtitle="完璧なオーディオコントロールのために再生速度とピッチを変更。" icon="fast-forward" >}}
  {{< feature-card title="歌詞とコメント" subtitle="曲の再生中に埋め込まれた歌詞とコメントを表示。" icon="annotation" >}}
  {{< feature-card title="ID3タグエディター" subtitle="内蔵ツールでタイトル、アーティスト、アルバムなどのメタデータを編集・修正。" icon="pencil-alt" >}}

  {{< feature-card title="イコライザー＆ブースト" subtitle="プリセットを使用するか、プリアンプゲインで手動調整してリッチなサウンドに。" icon="adjustments" >}}
  {{< feature-card title="Apple CarPlay" subtitle="音楽再生用の専用CarPlay UIで安全にドライブ。" icon="truck" >}}
  {{< feature-card title="AirPlay＆Chromecast" subtitle="Apple TVやGoogle Chromecastデバイスにワイヤレスでストリーミング。" icon="device-mobile" >}}

  {{< feature-card title="Last.fm連携" subtitle="音楽統計を追跡し、パーソナライズされた曲のレコメンドを取得。" icon="chart-bar" >}}
  {{< feature-card title="自動同期" subtitle="クラウドとローカルフォルダで音楽ライブラリを自動同期。" icon="refresh" >}}
  {{< feature-card title="オーディオブックサポート" subtitle="ブックマーク、スリープタイマー付きでオーディオブックを聴き、中断した場所から再生を再開。" icon="book-open" >}}
