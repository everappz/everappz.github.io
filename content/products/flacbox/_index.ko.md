...
{{< cards >}}
  ...
  {{< feature-card title="무손실 오디오 지원" subtitle="FLAC, ALAC, WAV, APE, DFF, WV, AIFF 등 다양한 고품질 포맷을 재생합니다." icon="music-note" >}}
  {{< feature-card title="오프라인 모드" subtitle="앨범, 재생목록, 트랙을 다운로드하여 언제든지 오프라인 재생할 수 있습니다." icon="download" >}}
  {{< feature-card title="파일 관리" subtitle="앱 내에서 파일을 쉽게 복사, 이동, 이름 변경, 삭제할 수 있습니다." icon="folder" >}}

  {{< feature-card title="사용자 정의 재생목록" subtitle="재생목록 생성, 편집, 재정렬, M3U 파일 내보내기 및 가져오기." icon="collection" >}}
  {{< feature-card title="미디어 라이브러리" subtitle="음악을 추가하고 태그를 사용하여 앨범, 아티스트, 장르별로 정리합니다." icon="library" >}}
  {{< feature-card title="고급 검색" subtitle="스마트 검색 도구로 노래, 아티스트, 앨범을 빠르게 찾습니다." icon="search" >}}

  {{< feature-card title="클라우드 스트리밍" subtitle="Google Drive, Dropbox, OneDrive, iCloud, MEGA 등에서 스트리밍합니다." icon="cloud" >}}
  {{< feature-card title="NAS 및 컴퓨터 접근" subtitle="SMB, DLNA, WebDAV를 통해 연결합니다. iTunes 또는 Wi-Fi로 전송합니다." icon="desktop-computer" >}}
  {{< feature-card title="USB 플래시 카드" subtitle="iXpand 같은 USB 어댑터를 사용하여 SD 카드에서 직접 음악을 재생합니다." icon="inbox" >}}

  {{< feature-card title="재생 컨트롤" subtitle="완벽한 오디오 제어를 위해 재생 속도와 피치를 변경합니다." icon="fast-forward" >}}
  {{< feature-card title="가사 및 댓글" subtitle="노래 재생 중 내장된 가사와 댓글을 확인합니다." icon="annotation" >}}
  {{< feature-card title="ID3 태그 편집기" subtitle="내장 도구로 제목, 아티스트, 앨범 등의 메타데이터를 편집하고 수정합니다." icon="pencil-alt" >}}

  {{< feature-card title="이퀄라이저 및 부스트" subtitle="프리셋을 사용하거나 프리앰프 게인으로 수동 조절하여 풍부한 사운드를 만듭니다." icon="adjustments" >}}
  {{< feature-card title="Apple CarPlay" subtitle="전용 CarPlay UI로 안전하게 운전하며 음악을 재생합니다." icon="truck" >}}
  {{< feature-card title="AirPlay 및 Chromecast" subtitle="Apple TV 및 Google Chromecast 기기에 무선으로 스트리밍합니다." icon="device-mobile" >}}

  {{< feature-card title="Last.fm 연동" subtitle="음악 통계를 추적하고 개인화된 노래 추천을 받습니다." icon="chart-bar" >}}
  {{< feature-card title="자동 동기화" subtitle="클라우드 및 로컬 폴더와 음악 라이브러리를 자동 동기화합니다." icon="refresh" >}}
  {{< feature-card title="오디오북 지원" subtitle="북마크, 수면 타이머, 중단한 곳에서 재생 재개 기능으로 오디오북을 들을 수 있습니다." icon="book-open" >}}
