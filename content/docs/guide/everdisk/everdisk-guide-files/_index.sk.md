---
title: "Súbory a dokumenty"
date: 2026-08-20
description: "Použite kartu Dokumenty v Everdisku ako plnohodnotného správcu súborov: prehliadajte v zozname alebo mriežke, vytvárajte priečinky, premenovávajte, presúvajte, kopírujte, nahrávajte a mažte, komprimujte a rozbaľujte súbory, pripájajte externé priečinky z vášho zariadenia, skenujte papierové dokumenty do PDF, používajte vstavané nástroje PDF (kompresia, OCR, heslo, oprávnenia, metadáta, zlúčenie) a prezerajte informácie o súbore."
keywords: ["správca súborov Everdisk", "karta Dokumenty", "vytvorenie priečinka iPhone", "premenovanie presun kopírovanie súborov", "komprimovanie rozbaľovanie iPhone", "archivovanie a rozbaľovanie súborov", "pripojenie externého priečinka", "skenovanie dokumentov do PDF", "nástroje PDF iPhone", "kompresia PDF", "OCR PDF s vyhľadávaním", "ochrana PDF heslom", "úprava metadát PDF", "zlúčenie PDF", "informácie o súbore", "režim výberu viacnásobný výber"]
tags: ["everdisk", "guide", "files", "documents"]
readingTime: 10
---


Karta **Dokumenty** je plnohodnotný správca súborov pre všetko na vašom zariadení. Práve tam pristávajú sťahovania, tam organizujete to, čo zdieľate, a tam komprimujete súbory, skenujete dokumenty a pripájate priečinky z iných častí vášho zariadenia.

V hornej časti karty Dokumenty je prepínač s tromi režimami - **Dokumenty**, **Fotografie** a **Hudba**. Táto stránka sa venuje režimu **Dokumenty** (vaše súbory a priečinky). Fotografie a hudbe sa venuje časť [Fotografie, hudba a video](/docs/guide/everdisk/everdisk-guide-media).

## Prehliadanie vašich súborov

- Prepínajte medzi zobrazením v **zozname** a v **mriežke** (ikony).
- **Triedte** podľa názvu, dátumu alebo veľkosti.
- Každý súbor zobrazuje **náhľad**, kde je to možné - fotografie, snímky z videa, prvé strany PDF, obaly hudby a náhľady textu.

Priečinok Dokumenty sa pri zapnutí zdieľania zdieľa štandardne, takže čokoľvek si tu uchovávate, ľahko odovzdáte ostatným zariadeniam.

## Bežné akcie so súbormi
...
## Pripojenie externých priečinkov
...
- [Zdieľanie](/docs/guide/everdisk/everdisk-guide-sharing) - zdieľajte tieto súbory s ostatnými zariadeniami.
- [Fotografie, hudba a video](/docs/guide/everdisk/everdisk-guide-media) - režimy Fotografie a Hudba a prehrávanie.
- [Nastavenia](/docs/guide/everdisk/everdisk-guide-settings) - kôš verzus trvalé mazanie, vyrovnávacia pamäť náhľadov.
