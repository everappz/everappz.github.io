...
keywords: [
  ...
  "zip unzip iPhone", "archive unarchive files", "connect external folder",
  "scan documents to PDF", "PDF tools iPhone", "compress PDF", "PDF OCR searchable",
  "password protect PDF", "edit PDF metadata", "flatten PDF", "file info", "selection mode multi-select"
]
tags: ["everdisk", "guide", "files", "documents"]
readingTime: 10
aliases:
  - /guide-everdisk-files/
---
...
Zipping and extracting show a progress bar you can cancel. When the new folder or archive is ready, Everdisk scrolls to it and highlights it briefly.

## Connect external folders

You can work with folders that live elsewhere on your device, not just the app's own Documents folder.

1. In the Documents folder, open the ••• menu and choose **Connect Folder**.
...
Everdisk can turn paper documents into clean PDFs using your camera.

1. In the Documents tab, open the ••• menu and choose **Scan Documents**.
2. Point the camera at a page. Everdisk finds the edges automatically, straightens the page, and lets you capture more pages.
3. When you finish, all the pages are saved together as a single **multi-page PDF** in the current folder.

Scanning needs a device with a real camera. You can then share the PDF over the network, or send it to another app with **Open In**.
...
To annotate a PDF (or a photo), just **tap it** in the Documents tab to open it in the built-in viewer, then open the **Markup** tools. You can **draw, highlight, add text and shapes, and add a signature** with your finger, and your changes are saved back to the file. If you later want to lock those marks so they can't be edited, run **PDF Tools → Flatten** on the file.

## Select several items at once

Turn on **selection mode** (Select) to act on many items together. Checkboxes appear next to each item, and a bar at the bottom offers **Move**, **Copy**, **Upload**, **Archive**, **Open In** and **Delete** for everything you selected. Use **Select All** or **Deselect All** to speed things up.

## File info

The **Info** screen for any file shows:

- A preview.
- The full **location** (path) on your device.
- Size, created and modified dates, and detailed media attributes.
- For photos and videos with location data, a **map with a pin** and an **Open in Maps** button.
- A **Share** button.
