...
Keď na obrazovke [Zdieľanie](/docs/guide/everdisk/everdisk-guide-sharing) ťuknete na **Start**, ostatné zariadenia sa môžu k vašim súborom pripojiť štyrmi rôznymi spôsobmi. Vyberte si metódu, ktorá zodpovedá zariadeniu, ktoré chcete použiť. V každom prípade sa presná **adresa**, ktorú potrebujete, zobrazuje v sekcii **How to Connect** na obrazovke Zdieľanie.
...
1. V **Nastaveniach → Sharing → Pripojenia** sa uistite, že je zapnuté **TV a mediálne centrum** (štandardne je zapnuté).
...
- Ak sa video na staršej TV neprehráva, znížte kvalitu videa v **Nastaveniach → Sharing → Videá**, aby ho Everdisk skonvertoval do kompatibilnejšieho formátu.
...
1. V **Nastaveniach → Sharing → Pripojenia** sa uistite, že je zapnutý **Prehliadač**.
2. Ťuknite na **Start**.
...
- **nahrať** súbory späť do vášho zariadenia - len ak ste zapli **Files Editing** (pozri [Prístup a súkromie](/docs/guide/everdisk/everdisk-guide-access)).
...
1. V **Nastaveniach → Sharing → Pripojenia** sa uistite, že je zapnutý **Počítač**.
...
Či bude spojenie len na čítanie alebo obojsmerné, závisí od nastavenia **Files Editing**. Keď je zapnuté, môžete kopírovať súbory do svojho zariadenia a premenovávať ich či mazať; keď je vypnuté, disk je len na čítanie.
...
1. V **Nastaveniach → Sharing → Pripojenia** sa uistite, že sú zapnuté **Ostatné aplikácie a zariadenia**.
...
2. Ak vás na zariadení požiada, ťuknite na **Trust This Computer**.
3. V Everdisku ťuknite na **Start**. Objaví sa poznámka **Fast Connection Available** a na obrazovke Zdieľanie sa zobrazí ďalšia adresa s odznakom **Cable Connection**, ktorá končí na `.local`.
