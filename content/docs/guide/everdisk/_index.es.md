...
### Primeros pasos con Everdisk

Esta guia explica cada parte de la app paso a paso. Elige una seccion mas abajo para aprender como funciona la funcion de compartir, como se conectan otros dispositivos, como llegar a tus propios servidores y como gestionar, reproducir y proteger tus archivos.<br><br>
...
{{< cards >}}
  ...
  {{< card icon="music-note" title="Fotos, musica y video" subtitle="Comparte toda tu biblioteca de fotos y musica, escucha audio en el minireproductor y ve videos a pantalla completa." link="/docs/guide/everdisk/everdisk-guide-media" >}}

  {{< card icon="lock-closed" title="Acceso y privacidad" subtitle="Protege lo que compartes con un usuario y contrasena, permite o bloquea la edicion, bloquea dispositivos y mantenlo todo local." link="/docs/guide/everdisk/everdisk-guide-access" >}}

  {{< card icon="adjustments" title="Ajustes" subtitle="Cada ajuste explicado: perfil del dispositivo, conexiones, calidad de fotos y video, puertos, transferencias y mas." link="/docs/guide/everdisk/everdisk-guide-settings" >}}

  {{< card icon="question-mark-circle" title="Preguntas frecuentes" subtitle="Respuestas rapidas a las dudas mas habituales y a situaciones reales." link="/docs/faq/everdisk" >}}
{{< /cards >}}
