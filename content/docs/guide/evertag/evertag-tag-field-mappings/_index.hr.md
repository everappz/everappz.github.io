---
title: "Mapiranja polja oznaka"
date: 2020-02-01
description: "Istražite potpuni popis audio oznaka koje podržava aplikacija Evertag, uključujući interna naziva polja i mapiranja prema glavnim formatima metapodataka."
keywords: ["audio metapodaci", "audio oznake", "ID3 oznake", "Vorbis Comments", "MP4 oznake", "ASF metapodaci", "Evertag podrška oznaka", "oznake glazbenih datoteka", "formati audio oznaka"]
tags: ["Evertag", "audio oznake", "metapodaci", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


Evertag podržava širok raspon polja audio oznaka korištenih u popularnim formatima kao što su ID3, MP4, Vorbis Comments i ASF.

Ovaj referentni vodič opisuje svako polje oznake, njegovo interno ime u Evertagu i kako se mapira prema različitim standardima metapodataka.

Koristite ga za bolje razumijevanje kako Evertag organizira i uređuje podatke oznaka za vašu glazbenu biblioteku.
