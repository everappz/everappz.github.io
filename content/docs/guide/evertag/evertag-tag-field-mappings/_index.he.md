---
title: "מיפויי שדות תגים"
date: 2020-02-01
description: "חקרו את הרשימה המלאה של שדות תגי אודיו הנתמכים על ידי אפליקציית Evertag, כולל שמות שדות פנימיים ומיפויים בין פורמטי מטאדטה עיקריים."
keywords: ["מטאדטה אודיו", "תגי אודיו", "תגי ID3", "הערות Vorbis", "תגי MP4", "מטאדטה ASF", "תמיכת תגים Evertag", "תגי קבצי מוזיקה", "פורמטי תגי אודיו"]
tags: ["Evertag", "תגי אודיו", "מטאדטה", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


Evertag תומך במגוון רחב של שדות תגי אודיו המשמשים בפורמטים פופולריים כמו ID3, MP4, הערות Vorbis ו-ASF.

מדריך הפניה זה מתאר כל שדה תג, שמו הפנימי ב-Evertag וכיצד הוא ממופה לסטנדרטי מטאדטה שונים.

השתמשו בו כדי להבין טוב יותר כיצד Evertag מארגן ועורך נתוני תגים עבור ספריית המוזיקה שלכם.
...
## MusicBrainz: מדינת הוצאה לאור של אלבום
...
## MusicBrainz: מזהה קבוצת הוצאה לאור
...
## MusicBrainz: מזהה רצועת הוצאה לאור
