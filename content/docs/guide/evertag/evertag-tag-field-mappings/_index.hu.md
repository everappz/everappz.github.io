---
title: "Tag mező leképezések"
date: 2020-02-01
description: "Fedezze fel az Evertag alkalmazás által támogatott audio tag mezők teljes listáját, beleértve a belső mezőneveket és a főbb metaadat-formátumok közötti leképezéseket."
keywords: ["audio metaadat", "audio tagek", "ID3 tagek", "Vorbis megjegyzések", "MP4 tagek", "ASF metaadat", "Evertag tag támogatás", "zenefájl tagek", "audio tag formátumok"]
tags: ["Evertag", "audio tagek", "metaadat", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


Az Evertag az ID3, MP4, Vorbis megjegyzések és ASF-hez hasonló népszerű formátumokban használt audio tag mezők széles körét támogatja.  

Ez a referencia útmutató az egyes tag mezőket, azok belső nevét az Evertag-ben és a különböző metaadatszabványokhoz való leképezésüket ismerteti.   

Segítségével jobban megértheti, hogyan szervezi és szerkeszti az Evertag a tag adatokat a zenekönyvtárához.

## AcoustID: Ujjlenyomat
...
## Album előadó rendezési sorrendje
...
## Zeneszerző rendezési sorrendje
...
## Dalszöveg tanácsadói értékelés
- **APE (ape)**: N/A
- **ASF/Windows Media (asf, wma)**: N/A
...
## MusicBrainz: Album előadó azonosítója
...
## MusicBrainz: Album kiadási országa
...
## MusicBrainz: Előadó azonosítója
...
## MusicBrainz: Eredeti album azonosítója
...
## MusicBrainz: Eredeti előadó azonosítója
...
## MusicBrainz: Kiadási csoport azonosítója
...
## MusicBrainz: Kiadási szám azonosítója
...
## Replay Gain: Referencia hangosság
...
## Műsor neve rendezési sorrendje
