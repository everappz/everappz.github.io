---
title: "Ánh xạ trường thẻ"
date: 2020-02-01
description: "Khám phá danh sách đầy đủ các trường thẻ âm thanh được hỗ trợ bởi ứng dụng Evertag, bao gồm tên trường nội bộ và ánh xạ giữa các định dạng siêu dữ liệu chính."
keywords: ["siêu dữ liệu âm thanh", "thẻ âm thanh", "thẻ ID3", "Vorbis Comments", "thẻ MP4", "siêu dữ liệu ASF", "hỗ trợ thẻ Evertag", "thẻ tệp âm nhạc", "định dạng thẻ âm thanh"]
tags: ["Evertag", "thẻ âm thanh", "siêu dữ liệu", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


Evertag hỗ trợ nhiều trường thẻ âm thanh được sử dụng trong các định dạng phổ biến như ID3, MP4, Vorbis Comments và ASF.  

Hướng dẫn tham khảo này mô tả từng trường thẻ, tên nội bộ của nó trong Evertag và cách nó ánh xạ tới các tiêu chuẩn siêu dữ liệu khác nhau.   

Sử dụng nó để hiểu rõ hơn cách Evertag tổ chức và chỉnh sửa dữ liệu thẻ cho thư viện nhạc của bạn.
