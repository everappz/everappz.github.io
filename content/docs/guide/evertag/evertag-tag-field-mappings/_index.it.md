---
title: "Mappatura dei Campi Tag"
date: 2020-02-01
description: "Esplora l'elenco completo dei campi tag audio supportati dall'app Evertag, inclusi i nomi dei campi interni e le mappature nei principali formati di metadati."
keywords: ["metadati audio", "tag audio", "tag ID3", "Vorbis Comments", "tag MP4", "metadati ASF", "supporto tag Evertag", "tag file musicali", "formati tag audio"]
tags: ["Evertag", "tag audio", "metadati", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


Evertag supporta un'ampia gamma di campi tag audio utilizzati nei formati più popolari come ID3, MP4, Vorbis Comments e ASF.  

Questa guida di riferimento descrive ogni campo tag, il suo nome interno in Evertag e come si mappa ai diversi standard di metadati.   

Usala per capire meglio come Evertag organizza e modifica i dati tag per la tua libreria musicale.

## AcoustID: Impronta digitale
...
## MusicBrainz: Paese di Pubblicazione Album
...
## MusicBrainz: ID Album Originale
...
## MusicBrainz: ID Artista Originale
...
## MusicBrainz: ID Gruppo di Pubblicazione
...
## MusicBrainz: ID Traccia di Pubblicazione
...
## Replay Gain: Volume di Riferimento
...
## Replay Gain: Intervallo Traccia
