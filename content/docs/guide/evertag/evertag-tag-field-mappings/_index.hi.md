---
title: "टैग फ़ील्ड मैपिंग"
date: 2020-02-01
description: "Evertag ऐप द्वारा समर्थित ऑडियो टैग फ़ील्ड की पूरी सूची एक्सप्लोर करें, जिसमें आंतरिक फ़ील्ड नाम और प्रमुख मेटाडेटा फ़ॉर्मेट में मैपिंग शामिल हैं।"
keywords: ["ऑडियो मेटाडेटा", "ऑडियो टैग", "ID3 टैग", "Vorbis Comments", "MP4 टैग", "ASF मेटाडेटा", "Evertag टैग समर्थन", "म्यूज़िक फ़ाइल टैग", "ऑडियो टैग फ़ॉर्मेट"]
tags: ["Evertag", "ऑडियो टैग", "मेटाडेटा", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


Evertag ID3, MP4, Vorbis Comments और ASF जैसे लोकप्रिय formats में उपयोग किए जाने वाले ऑडियो टैग fields की एक विस्तृत श्रृंखला का समर्थन करता है।

यह reference guide प्रत्येक टैग field, Evertag में उसका internal name और विभिन्न metadata standards में उसकी mapping की रूपरेखा देता है।

इसका उपयोग करके बेहतर समझें कि Evertag आपकी म्यूज़िक library के लिए टैग data कैसे व्यवस्थित और संपादित करता है।
