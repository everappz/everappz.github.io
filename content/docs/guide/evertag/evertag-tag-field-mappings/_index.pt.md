---
title: "Mapeamentos de Campos de Tag"
date: 2020-02-01
description: "Explore a lista completa de campos de tags de áudio suportados pela aplicação Evertag, incluindo nomes de campos internos e mapeamentos entre os principais formatos de metadados."
keywords: ["metadados de áudio", "tags de áudio", "tags ID3", "Vorbis Comments", "tags MP4", "metadados ASF", "suporte de tags Evertag", "tags de ficheiros de música", "formatos de tags de áudio"]
tags: ["Evertag", "tags de áudio", "metadados", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


O Evertag suporta uma vasta gama de campos de tags de áudio utilizados em formatos populares como ID3, MP4, Vorbis Comments e ASF.  

Este guia de referência descreve cada campo de tag, o seu nome interno no Evertag e como é mapeado para os diferentes padrões de metadados.   

Utilize-o para compreender melhor como o Evertag organiza e edita dados de tags para a sua biblioteca de música.

## AcoustID: Impressão Digital
...
## Ordem de Ordenação do Artista do Álbum
...
## Ordem de Ordenação do Compositor
...
## Classificação Consultiva de Letras
- **APE (ape)**: N/A
- **ASF/Windows Media (asf, wma)**: N/A
...
## MusicBrainz: ID do Artista do Álbum
...
## MusicBrainz: País de Lançamento do Álbum
...
## MusicBrainz: ID do Álbum Original
...
## MusicBrainz: ID do Artista Original
...
## MusicBrainz: ID do Grupo de Lançamento
...
## MusicBrainz: ID da Faixa de Lançamento
...
## Replay Gain: Intervalo do Álbum
...
## Replay Gain: Sonoridade de Referência
...
## Replay Gain: Intervalo da Faixa
...
## Ordem de Ordenação do Nome do Programa
...
## Ordem de Ordenação do Título da Faixa
