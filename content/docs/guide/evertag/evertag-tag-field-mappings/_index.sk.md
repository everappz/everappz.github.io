---
title: "Mapovanie polí tagov"
date: 2020-02-01
description: "Preskúmajte úplný zoznam polí audio tagov podporovaných aplikáciou Evertag vrátane interných názvov polí a mapovania naprieč hlavnými formátmi metadát."
keywords: ["audio metadáta", "audio tagy", "ID3 tagy", "Vorbis komentáre", "MP4 tagy", "ASF metadáta", "podpora tagov Evertag", "tagy hudobných súborov", "formáty audio tagov"]
tags: ["Evertag", "audio tagy", "metadáta", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


Evertag podporuje široké spektrum polí audio tagov používaných v populárnych formátoch ako ID3, MP4, Vorbis Comments a ASF.  

Tento referenčný sprievodca opisuje každé pole tagu, jeho interný názov v Evertagu a spôsob mapovania na rôzne štandardy metadát.   

Využite ho na lepšie pochopenie toho, ako Evertag organizuje a upravuje dáta tagov vo vašej hudobnej knižnici.

## AcoustID: Odtlačok prsta
...
## Poradie zoradenia albumového interpreta
...
## MusicBrainz: ID albumového interpreta
...
## MusicBrainz: Krajina vydania albumu
...
## MusicBrainz: ID pôvodného albumu
...
## MusicBrainz: ID pôvodného interpreta
...
## MusicBrainz: ID skladby vo vydaní
...
## Replay Gain: Referenčná hlasitosť
...
## Poradie zoradenia názvu relácie
...
## Poradie zoradenia názvu skladby
