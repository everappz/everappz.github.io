---
title: "Mapări ale Câmpurilor de Etichetă"
date: 2020-02-01
description: "Explorați lista completă a câmpurilor de etichete audio acceptate de aplicația Evertag, inclusiv numele interne ale câmpurilor și mapările între principalele formate de metadate."
keywords: ["metadate audio", "etichete audio", "etichete ID3", "Vorbis Comments", "etichete MP4", "metadate ASF", "suport etichete Evertag", "etichete fișiere muzicale", "formate etichete audio"]
tags: ["Evertag", "etichete audio", "metadate", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


Evertag acceptă o gamă largă de câmpuri de etichete audio utilizate în formate populare precum ID3, MP4, Vorbis Comments și ASF.  

Acest ghid de referință descrie fiecare câmp de etichetă, numele său intern în Evertag și modul în care se mapează la diferite standarde de metadate.   

Utilizați-l pentru a înțelege mai bine cum Evertag organizează și editează datele etichetelor pentru biblioteca dvs. muzicală.
...
## Ordine de Sortare Artist Album
...
## Clasificare Consultativă Versuri
- **APE (ape)**: N/A
- **ASF/Windows Media (asf, wma)**: N/A
...
## MusicBrainz: Țara de Lansare a Albumului
...
## MusicBrainz: ID Artist Original
...
## MusicBrainz: ID Grup de Lansare
...
## MusicBrainz: ID Piesă de Lansare
...
## Replay Gain: Sonoritate de Referință
...
## Ordine de Sortare Nume Program
