...
title: "タグフィールドマッピング"
date: 2020-02-01
description: "Evertagアプリがサポートするオーディオタグフィールドの完全なリストを探索してください。内部フィールド名と主要なメタデータ形式間のマッピングも含まれています。"
keywords: ["オーディオメタデータ", "オーディオタグ", "ID3タグ", "Vorbisコメント", "MP4タグ", "ASFメタデータ", "Evertagタグサポート", "音楽ファイルタグ", "オーディオタグ形式"]
tags: ["Evertag", "オーディオタグ", "メタデータ", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


EvertagはID3、MP4、Vorbisコメント、ASFなどの一般的な形式で使用される幅広いオーディオタグフィールドをサポートしています。  

このリファレンスガイドでは、各タグフィールド、Evertag内での内部名、およびさまざまなメタデータ標準へのマッピング方法を説明しています。   

Evertagが音楽ライブラリのタグデータをどのように整理・編集するかをより深く理解するためにご活用ください。
