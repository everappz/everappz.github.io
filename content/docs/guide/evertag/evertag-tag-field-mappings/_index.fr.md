---
title: "Correspondances des champs de tags"
date: 2020-02-01
description: "Explorez la liste complète des champs de tags audio pris en charge par l'application Evertag, y compris les noms de champs internes et les correspondances entre les principaux formats de métadonnées."
keywords: ["métadonnées audio", "tags audio", "tags ID3", "commentaires Vorbis", "tags MP4", "métadonnées ASF", "prise en charge des tags Evertag", "tags de fichiers musicaux", "formats de tags audio"]
tags: ["Evertag", "tags audio", "métadonnées", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


Evertag prend en charge une large gamme de champs de tags audio utilisés dans les formats populaires comme ID3, MP4, Commentaires Vorbis et ASF.

Ce guide de référence décrit chaque champ de tag, son nom interne dans Evertag et la façon dont il se mappe aux différentes normes de métadonnées.

Utilisez-le pour mieux comprendre comment Evertag organise et modifie les données de tags pour votre bibliothèque musicale.
...
## Ordre de tri de l'artiste de l'album
...
## Évaluation de contenu des paroles
- **APE (ape)**: N/A
- **ASF/Windows Media (asf, wma)**: N/A
...
## MusicBrainz : ID de l'artiste de l'album
...
## MusicBrainz : Pays de sortie de l'album
...
## MusicBrainz : ID de l'album original
...
## MusicBrainz : ID de l'artiste original
...
## MusicBrainz : ID du groupe de sortie
...
## MusicBrainz : ID de piste de sortie
...
## Propriétaire de la radio en ligne
...
## Replay Gain : Niveau de référence
...
## Ordre de tri du nom de l'émission
...
## Ordre de tri du titre de la piste
