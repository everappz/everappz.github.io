---
title: "Tag-feltmappings"
date: 2020-02-01
description: "Udforsk den komplette liste over lydtagfelter understøttet af Evertag-appen, herunder interne feltnavne og mappings på tværs af større metadataformater."
keywords: ["lydmetadata", "lydtags", "ID3-tags", "Vorbis Comments", "MP4-tags", "ASF-metadata", "Evertag tagsupport", "musikfiltags", "lydtagformater"]
tags: ["Evertag", "lydtags", "metadata", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


Evertag understøtter en bred vifte af lydtagfelter brugt på tværs af populære formater som ID3, MP4, Vorbis Comments og ASF.  

Denne referencevejledning beskriver hvert tagfelt, dets interne navn i Evertag og, hvordan det mappes til forskellige metadatastandarder.   

Brug den til bedre at forstå, hvordan Evertag organiserer og redigerer tagdata til dit musikbibliotek.

## AcoustID: Fingeraftryk
...
## Sorteringsrækkefølge for albuminterpret
...
## Sorteringsrækkefølge for album
...
## Sorteringsrækkefølge for interpret
...
## Sorteringsrækkefølge for komponist
...
## Rådgivende bedømmelse for lyrics
- **APE (ape)**: N/A
- **ASF/Windows Media (asf, wma)**: N/A
...
## MusicBrainz: Udgivelsesland for album
...
## MusicBrainz: Originalt album-ID
...
## MusicBrainz: Originalt interpret-ID
...
## MusicBrainz: Udgivelsesgruppes-ID
...
## MusicBrainz: Udgivelsessporets ID
...
## Replay Gain: Referencelydstyrke
...
## Sorteringsrækkefølge for shownavn
...
## Sorteringsrækkefølge for sporets titel
