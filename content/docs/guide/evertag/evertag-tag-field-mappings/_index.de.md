---
title: "Tag-Feld-Zuordnungen"
date: 2020-02-01
description: "Erkunden Sie die vollständige Liste der von der Evertag-App unterstützten Audio-Tag-Felder, einschließlich interner Feldnamen und Zuordnungen zu den wichtigsten Metadatenformaten."
keywords: ["Audio-Metadaten", "Audio-Tags", "ID3-Tags", "Vorbis Comments", "MP4-Tags", "ASF-Metadaten", "Evertag Tag-Unterstützung", "Musik-Datei-Tags", "Audio-Tag-Formate"]
tags: ["Evertag", "Audio-Tags", "Metadaten", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


Evertag unterstützt eine Vielzahl von Audio-Tag-Feldern, die in gängigen Formaten wie ID3, MP4, Vorbis Comments und ASF verwendet werden.  

Dieses Referenzhandbuch beschreibt jedes Tag-Feld, seinen internen Namen in Evertag und wie es verschiedenen Metadatenstandards zugeordnet wird.   

Verwenden Sie es, um besser zu verstehen, wie Evertag Tag-Daten für Ihre Musikbibliothek organisiert und bearbeitet.

## AcoustID: Fingerabdruck
...
## Sortierreihenfolge Album-Künstler
...
## MusicBrainz: Album-Veröffentlichungsland
...
## MusicBrainz: Original-Künstler-ID
...
## MusicBrainz: Release-Gruppen-ID
...
## Originales Veröffentlichungsjahr
...
## Replay Gain: Referenzlautstärke
...
## Sortierreihenfolge Sendungsname
...
## WWW: Kommerzielle Informationen
