---
title: "Assignació de camps d'etiquetes"
date: 2020-02-01
description: "Explora la llista completa de camps d'etiquetes d'àudio compatibles amb l'aplicació Evertag, incloent noms de camps interns i assignacions entre els principals formats de metadades."
keywords: ["metadades d'àudio", "etiquetes d'àudio", "etiquetes ID3", "comentaris Vorbis", "etiquetes MP4", "metadades ASF", "compatibilitat d'etiquetes Evertag", "etiquetes de fitxers musicals", "formats d'etiquetes d'àudio"]
tags: ["Evertag", "etiquetes d'àudio", "metadades", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


Evertag és compatible amb una àmplia gamma de camps d'etiquetes d'àudio utilitzats en formats populars com ID3, MP4, Vorbis Comments i ASF.  

Aquesta guia de referència descriu cada camp d'etiqueta, el seu nom intern a Evertag i com s'assigna als diferents estàndards de metadades.   

Utilitza-la per entendre millor com Evertag organitza i edita les dades d'etiquetes de la teva biblioteca musical.

## AcoustID: Empremta digital
...
## Ordre de classificació de l'artista de l'àlbum
...
## Ordre de classificació de l'àlbum
...
## Ordre de classificació de l'artista
...
## Ordre de classificació del compositor
...
## Valoració de contingut de lletres
...
## MusicBrainz: ID de l'artista de l'àlbum
...
## MusicBrainz: País de llançament de l'àlbum
...
## MusicBrainz: ID de l'àlbum original
...
## MusicBrainz: ID de l'artista original
...
## MusicBrainz: ID del grup de llançament
...
## MusicBrainz: ID de la pista de llançament
...
## Propietari de la ràdio per Internet
...
## Replay Gain: Sonoritat de referència
...
## Ordre de classificació del nom del programa
...
## Ordre de classificació del títol de la pista
