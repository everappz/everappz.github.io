---
title: "Tagfelttilordninger"
date: 2020-02-01
description: "Utforsk den komplette listen over lydtagfelt støttet av Evertag-appen, inkludert interne feltnavn og tilordninger på tvers av de viktigste metadataformatene."
keywords: ["lydmetadata", "lydtager", "ID3-tager", "Vorbis-kommentarer", "MP4-tager", "ASF-metadata", "Evertag-tagstøtte", "musikkfiltagger", "lydtagformater"]
tags: ["Evertag", "lydtager", "metadata", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


Evertag støtter et bredt spekter av lydtagfelt som brukes i populære formater som ID3, MP4, Vorbis-kommentarer og ASF.  

Denne referanseguiden beskriver hvert tagfelt, dets interne navn i Evertag og hvordan det tilordnes til ulike metadatastandarder.   

Bruk den til bedre å forstå hvordan Evertag organiserer og redigerer tagdata for musikkbiblioteket ditt.

## AcoustID: Fingeravtrykk
...
## Sorteringsrekkefølge albumartist
...
## Sorteringsrekkefølge komponist
...
## MusicBrainz: Utgivelsesland for album
...
## MusicBrainz: Utgivelsesgruppe-ID
...
## Sorteringsrekkefølge sportittel
