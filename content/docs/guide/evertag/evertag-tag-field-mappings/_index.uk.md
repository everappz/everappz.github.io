---
title: "Відповідність полів тегів"
date: 2020-02-01
description: "Ознайомтеся з повним переліком полів аудіотегів, підтримуваних додатком Evertag, включно з внутрішніми назвами полів і відповідністю між основними форматами метаданих."
keywords: ["метадані аудіо", "аудіотеги", "теги ID3", "Vorbis Comments", "теги MP4", "метадані ASF", "підтримка тегів Evertag", "теги музичних файлів", "формати аудіотегів"]
tags: ["Evertag", "аудіотеги", "метадані", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


Evertag підтримує широкий спектр полів аудіотегів, що використовуються в популярних форматах, таких як ID3, MP4, Vorbis Comments та ASF.  

Цей довідник описує кожне поле тега, його внутрішню назву в Evertag і відповідність різним стандартам метаданих.   

Використовуйте його для кращого розуміння того, як Evertag організовує та редагує дані тегів для вашої музичної бібліотеки.
