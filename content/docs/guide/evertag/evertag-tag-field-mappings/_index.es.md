---
title: "Correspondencias de campos de etiquetas"
date: 2020-02-01
description: "Explore la lista completa de campos de etiquetas de audio compatibles con la aplicación Evertag, incluidos los nombres de campos internos y las correspondencias con los principales formatos de metadatos."
keywords: ["metadatos de audio", "etiquetas de audio", "etiquetas ID3", "Vorbis Comments", "etiquetas MP4", "metadatos ASF", "compatibilidad de etiquetas Evertag", "etiquetas de archivos de música", "formatos de etiquetas de audio"]
tags: ["Evertag", "etiquetas de audio", "metadatos", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


Evertag admite una amplia gama de campos de etiquetas de audio utilizados en formatos populares como ID3, MP4, Vorbis Comments y ASF.  

Esta guía de referencia describe cada campo de etiqueta, su nombre interno en Evertag y cómo se corresponde con los diferentes estándares de metadatos.   

Úsela para comprender mejor cómo Evertag organiza y edita los datos de etiquetas de su biblioteca de música.

## AcoustID: Huella digital
...
## Orden de clasificación del artista del álbum
...
## Orden de clasificación del álbum
...
## Orden de clasificación del artista
...
## Orden de clasificación del compositor
...
## Clasificación del contenido de las letras
- **APE (ape)**: N/A
- **ASF/Windows Media (asf, wma)**: N/A
...
## MusicBrainz: ID del artista del álbum
...
## MusicBrainz: País de lanzamiento del álbum
...
## MusicBrainz: ID del álbum original
...
## MusicBrainz: ID del artista original
...
## MusicBrainz: ID del grupo de lanzamiento
...
## MusicBrainz: ID de pista de lanzamiento
...
## Propietario de la radio por internet
...
## Replay Gain: Ganancia del álbum
...
## Replay Gain: Sonoridad de referencia
...
## Replay Gain: Ganancia de la pista
...
## Orden de clasificación del nombre del programa
...
## Orden de clasificación del título de la pista
