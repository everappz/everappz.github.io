---
title: "Tägikentän vastaavuudet"
date: 2020-02-01
description: "Tutustu Evertag-sovelluksen tukemien äänitägikentien täydelliseen luetteloon, mukaan lukien sisäiset kenttien nimet ja vastaavuudet tärkeimpien metadatamuotojen välillä."
keywords: ["äänimetadata", "äänitägit", "ID3-tägit", "Vorbis Comments", "MP4-tägit", "ASF-metadata", "Evertag-tägen tuki", "musiikkitiedostojen tägit", "äänitägimuodot"]
tags: ["Evertag", "äänitägit", "metadata", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


Evertag tukee laajaa valikoimaa äänitägikenttiä, joita käytetään suosituissa muodoissa, kuten ID3, MP4, Vorbis Comments ja ASF.  

Tämä viiteopas kuvaa jokaisen tägikentän, sen sisäisen nimen Evertagissa ja sen vastaavuuden eri metadatastandardeihin.   

Käytä sitä ymmärtääksesi paremmin, miten Evertag järjestää ja muokkaa täginaamoja musiikkikirjastoasi varten.

## AcoustID: Sormenjälki
...
## Albumin esittäjän lajittelujärjestys
...
## MusicBrainz: Albumin esittäjän ID
...
## MusicBrainz: Albumin julkaisumaa
...
## MusicBrainz: Alkuperäisen albumin ID
...
## MusicBrainz: Alkuperäisen esittäjän ID
...
## MusicBrainz: Julkaisun kappaleen ID
...
## Replay Gain: Albumin vaihteluväli
...
## Replay Gain: Kappaleen vahvistus
...
## Replay Gain: Kappaleen vaihteluväli
...
## Ohjelman nimen lajittelujärjestys
...
## Kappaleen otsikon lajittelujärjestys
