---
title: "Таблица полей тегов"
date: 2020-02-01
description: "Полный список полей аудиотегов, поддерживаемых приложением Evertag, включая внутренние имена полей и соответствия в основных форматах метаданных."
keywords: ["метаданные аудио", "аудиотеги", "теги ID3", "Vorbis Comments", "теги MP4", "метаданные ASF", "поддержка тегов Evertag", "теги музыкальных файлов", "форматы аудиотегов"]
tags: ["Evertag", "аудиотеги", "метаданные", "ID3", "Vorbis", "MP4", "ASF"]
cascade:
  type: docs
---


Evertag поддерживает широкий набор полей аудиотегов, используемых в популярных форматах — ID3, MP4, Vorbis Comments и ASF.  

В этом справочном руководстве описано каждое поле тега, его внутреннее имя в Evertag и соответствие различным стандартам метаданных.   

Используйте его, чтобы лучше понять, как Evertag организует и редактирует данные тегов для вашей музыкальной библиотеки.
...
## Порядок сортировки исполнителя альбома
...
## Порядок сортировки исполнителя
...
## Порядок сортировки композитора
...
## Рекомендательная оценка текста
- **APE (ape)**: N/A
- **ASF/Windows Media (asf, wma)**: N/A
...
## MusicBrainz: ID исполнителя альбома
...
## MusicBrainz: Страна издания альбома
...
## MusicBrainz: ID оригинального альбома
...
## MusicBrainz: ID оригинального исполнителя
...
## Replay Gain: Референсная громкость
...
## Порядок сортировки названия шоу
...
## Порядок сортировки названия трека
