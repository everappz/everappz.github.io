...
keywords: [
  ...
  "video playlist manager", "create video playlist iPhone",
  "Evervideo M3U", "Evervideo M3U8", "Evervideo CUE",
  "Evervideo playlist export", "Evervideo playlist archive",
  "video playlist offline mode", "video playlist sort"
]
tags: ["guide", "evervideo", "playlists"]
readingTime: 5
aliases:
  - /post/evervideo-guide-playlists/
...
2. Select **Rearrange Videos**. The view switches into editing mode.
3. Tap the reorder indicator icon near the video title to give it focus.
...
5. Move the cell to its new position.
