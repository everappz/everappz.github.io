...
description: 'اعثر على إجابات للأسئلة الشائعة حول Evermusic وFlacbox وEvervideo وEvertag. استكشف ميزات مثل البث السحابي وإدارة الملفات وخيارات التشغيل وتحرير البيانات الوصفية والمزيد.'
keywords: [
  "أسئلة Evermusic الشائعة", "دعم Flacbox", "مساعدة Evervideo", "أسئلة Evertag",
  "كيفية استخدام Evermusic", "استكشاف أخطاء مشغل الموسيقى السحابي", "دليل التشغيل دون اتصال",
  "دعم محرر علامات الصوت", "مشاكل بث الفيديو", "دليل نقل الملفات"
]
tags: [
  "الأسئلة الشائعة", "مساعدة", "دعم", "evermusic", "flacbox", "evervideo", "evertag",
  "إعداد السحابة", "مشاكل التشغيل", "إدارة الملفات", "تحرير البيانات الوصفية",
  "استكشاف الأخطاء", "وضع عدم الاتصال", "مشغل الموسيقى", "مشغل الفيديو"
]
---
...
هل تبحث عن إجابات أو مساعدة في استخدام أحد تطبيقاتنا؟ أنت في المكان الصحيح.

ستساعدك صفحات الأسئلة الشائعة على توصيل التخزين السحابي وإدارة ملفات الموسيقى والفيديو وإعداد التشغيل دون اتصال وضبط إعدادات المعادل الصوتي وإصلاح البيانات الوصفية والمزيد.

استعرض الأسئلة الشائعة لتطبيقك أدناه للبدء، أو تصفح الأسئلة والإجابات الشائعة التي تلقيناها من رسائل المستخدمين.
...
**إعداد WebDAV:**<br>
- **الخوادم الأمريكية:** `https://webdav.pcloud.com`  
- **الخوادم الأوروبية:** `https://ewebdav.pcloud.com`  
- **اسم المستخدم:** عنوان بريدك الإلكتروني في pCloud  
- **كلمة المرور:** كلمة مرور حساب pCloud الخاص بك  
...
1. انتقل إلى **الزاوية العلوية اليمنى** من شاشتك وافتح **مركز التحكم** (بالقرب من الساعة).  
2. انقر على أيقونة **الصوت/مستوى الصوت**.  
3. في الشاشة التالية، انقر على **AirPlay** لعرض قائمة بجميع أجهزة AirPlay المتاحة.  
...
- تأكد من تثبيت أحدث إصدار من التطبيق على كلا الجهازين<br>
- فعّل **iCloud** على كلا الجهازين<br>
- شغّل التطبيق على جهاز iOS الخاص بك وانتظر دقيقة واحدة لرفع معلومات الشراء<br>
- على Mac، ثبّت التطبيق من App Store باستخدام **نفس Apple ID**<br>
- شغّل التطبيق وانتظر بضع ثوانٍ لمزامنة المعلومات<br>
...
- **النسخ الاحتياطي والاستعادة** من إعدادات التطبيق [كيفية نقل مكتبة الموسيقى بين الأجهزة في Evermusic: دليل خطوة بخطوة](/docs/howto/how-to-transfer-your-music-library-between-devices-in-evermusic-step-by-step-guide/)<br>
- **تصدير قائمة التشغيل إلى M3U**، ثم استيرادها على جهاز آخر:<br>
  - [كيفية تصدير قوائم التشغيل](/docs/howto/export-tracks-collection-from-evermusic-flacbox-to-m3u-csv-txt/)<br>
...
- يتم تخزين بيانات الاعتماد بأمان في **iOS Keychain**<br>
- نجمع فقط تقارير الأعطال والاستخدام المجهولة<br>
- يمكنك إلغاء الاشتراك في **إعدادات التطبيق ← التحليلات**<br><br>

مزيد من المعلومات:<br>
- [سياسة الخصوصية](/legal/privacy-policy/)<br>
- [أمان Apple Keychain](https://support.apple.com/guide/security/keychain-data-protection-secb0694df1a/web)<br><br>
...
- **الإعدادات ← مكتبة الموسيقى ← مزامنة الموسيقى عبر الإنترنت ← المزامنة في الخلفية**<br><br>
...
ومع ذلك، إذا نجحت في الاتصال بـ **WD MyCloud EX2 Ultra** أو **WD MyCloud Mirror** أو نموذج **WD MyCloud** آخر، فلا يزال بإمكانك استخدامه بالحل البديل التالي:<br><br>

1. افتح **الاتصالات ← الاتصال بالتخزين السحابي ← My Cloud Home**<br>
2. أنشئ مجلدًا باستخدام مدير الملفات المدمج<br>
3. ارفع ملفات الموسيقى إلى هذا المجلد<br>
4. ستُخزَّن في "صندوق رمل" يمكن للتطبيق الوصول إليه فقط<br>
...
**Evermusic**<br>
- iOS (الأيقونة الزرقاء): `lsevermusic://`<br>
- macOS: `lsevermusicmac://`<br>
- iOS (الأيقونة الحمراء): `lsevermusicpro://`<br><br>
...
- فعّل **SMB1** على خادمك وفي إعدادات التطبيق<br>
- استخدم **منتقي الملفات النظامي**:<br>
  - انتقل إلى **الملفات المحلية > الملفات على هذا الجهاز > فتح الملفات...**<br>
...
– **كيف أدير تخزين iCloud؟**  <br>
لديك خياران:  <br>
1. استخدم [https://www.icloud.com](https://www.icloud.com) في متصفحك لتنظيم الملفات ورفعها أو حذفها.<br>  
2. في التطبيق، بعد الاتصال بـ iCloud عبر **الاتصالات ← الاتصال بالتخزين السحابي ← iCloud Drive**، استخدم مدير الملفات المدمج لرفع الملفات وتنزيلها وإعادة تسمية المجلدات أو حذف الملفات مباشرةً في تخزين iCloud — دون حفظها على جهازك.<br>

⚠️ كن حذرًا عند حذف الملفات. يحذفها التطبيق نهائيًا (لن تنتقل إلى سلة المهملات ولا يمكن استرجاعها).<br>
...
1. **باستخدام كابل USB (مُوصى به للمكتبات الكبيرة)**  <br>
   استخدم تطبيق **Apple Devices** على Windows 11 لنقل الملفات مباشرةً إلى iPhone عبر USB.  
   اتبع دليل Apple هنا:  
   https://support.apple.com/en-ph/120402 <br>

2. **لاسلكيًا عبر Wi-Fi Drive**  <br>
   فعّل ميزة **WiFi Drive** داخل التطبيق وارفع موسيقاك عبر متصفح على حاسوبك.  
   تعليمات خطوة بخطوة هنا:  
   [كيفية نقل ملفات الموسيقى من الكمبيوتر إلى iPhone بدون iTunes باستخدام WiFi-Drive](/docs/howto/how-to-transfer-music-from-computer-to-iphone-without-itunes/) <br>

3. **لاسلكيًا باستخدام خادم DLNA**  <br>
   شغّل خادم وسائط DLNA على حاسوب Windows الخاص بك وبثّ مكتبتك أو انقلها مباشرةً إلى التطبيق.  
   الدليل:  
   [كيفية تفعيل خادم وسائط DLNA على Windows 10 وتشغيل الموسيقى على iPhone](/docs/howto/how-to-enable-dlna-media-server-on-windows-10-and-play-your-music-on-iphone/) <br>

4. **لاسلكيًا باستخدام مشاركة ملفات SMB**  <br>
   فعّل **مشاركة الملفات SMB** على PC الخاص بك واتصل به في التطبيق لاستعراض ملفاتك وتنزيلها أو نقلها مجلدًا بمجلد.  
   التعليمات:  
   [نقل الملفات من الكمبيوتر إلى iPhone باستخدام بروتوكول SMB](/docs/howto/transfer-your-files-from-the-computer-to-iphone-using-smb-protocol/) <br>
