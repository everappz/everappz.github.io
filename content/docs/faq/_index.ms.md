...
keywords: [
  "Evermusic FAQ", "sokongan Flacbox", "bantuan Evervideo", "soalan Evertag",
  "cara menggunakan Evermusic", "penyelesaian masalah pemain muzik awan", "panduan main balik luar talian",
  "sokongan editor tag audio", "masalah penstriman video", "tutorial pemindahan fail"
]
tags: [
  "FAQ", "bantuan", "sokongan", "evermusic", "flacbox", "evervideo", "evertag",
...
Mencari jawapan atau bantuan menggunakan salah satu aplikasi kami? Anda berada di tempat yang betul.

Halaman FAQ kami akan membantu anda menyambungkan storan awan, mengurus fail muzik dan video, menyediakan main balik luar talian, melaraskan tetapan equalizer, membetulkan metadata, dan banyak lagi.

Terokai FAQ untuk aplikasi anda di bawah untuk bermula, atau semak soalan dan jawapan umum yang kami terima daripada e-mel pengguna.
...
**Persediaan WebDAV:**<br>
- **Pelayan AS:** `https://webdav.pcloud.com`  
- **Pelayan Eropah:** `https://ewebdav.pcloud.com`  
- **Nama pengguna:** Alamat e-mel pCloud anda  
- **Kata laluan:** Kata laluan akaun pCloud anda  
...
1. Pergi ke **sudut kanan atas** skrin anda dan buka **Pusat Kawalan** (berhampiran jam).  
2. Klik ikon **Bunyi/Kelantangan**.  
3. Pada skrin seterusnya, klik **AirPlay** untuk melihat senarai semua peranti AirPlay yang tersedia.  
...
- Pastikan anda mempunyai versi aplikasi terkini yang dipasang pada kedua-dua peranti<br>
- Aktifkan **iCloud** pada kedua-dua peranti<br>
- Lancarkan aplikasi pada peranti iOS anda dan tunggu 1 minit untuk maklumat pembelian dimuat naik<br>
- Pada Mac anda, pasang aplikasi dari App Store menggunakan **Apple ID yang sama**<br>
- Lancarkan aplikasi dan tunggu beberapa saat untuk maklumat disegerakkan<br>
...
- **Sandaran dan Pulih** dari Tetapan Aplikasi [Cara Memindahkan Pustaka Muzik Anda Antara Peranti dalam Evermusic: Panduan Langkah demi Langkah](/docs/howto/how-to-transfer-your-music-library-between-devices-in-evermusic-step-by-step-guide/)<br>
- **Eksport senarai main ke M3U**, kemudian import pada peranti lain:<br>
  - [Cara Mengeksport Senarai Main](/docs/howto/export-tracks-collection-from-evermusic-flacbox-to-m3u-csv-txt/)<br>
...
- Kelayakan log masuk disimpan dengan selamat dalam **iOS Keychain**<br>
- Kami hanya mengumpul laporan ranap dan penggunaan tanpa nama<br>
- Anda boleh keluar dalam **Tetapan Aplikasi → Analitik**<br><br>

Maklumat lanjut:<br>
- [Dasar Privasi](/legal/privacy-policy/)<br>
- [Keselamatan Apple Keychain](https://support.apple.com/guide/security/keychain-data-protection-secb0694df1a/web)<br><br>
...
- **Tetapan → Pustaka Muzik → Segerak Muzik Dalam Talian → Segerak Latar Belakang**<br><br>
...
Walau bagaimanapun, jika anda berjaya menyambung ke **WD MyCloud EX2 Ultra**, **WD MyCloud Mirror**, atau model storan **WD MyCloud** lain, anda masih boleh menggunakannya dengan penyelesaian berikut:<br><br>

1. Buka **Sambungan → Sambung ke Storan Awan → My Cloud Home**<br>
2. Buat folder menggunakan pengurus fail terbina dalam<br>
3. Muat naik fail muzik ke dalam folder ini<br>
4. Ini akan disimpan dalam "kotak pasir" yang hanya boleh diakses oleh aplikasi<br>
...
- Aktifkan **SMB1** pada pelayan dan dalam tetapan aplikasi anda<br>
- Gunakan **pemilih fail sistem**:<br>
  - Pergi ke **Fail Tempatan > Fail pada Peranti Ini > Buka Fail...**<br>
...
– **Bagaimana cara mengurus storan iCloud?**  <br>
Anda mempunyai dua pilihan:  <br>
1. Gunakan [https://www.icloud.com](https://www.icloud.com) dalam pelayar anda untuk menyusun, memuat naik, atau memadam fail.<br>  
2. Dalam aplikasi, selepas menyambung ke iCloud melalui **Sambungan → Sambung ke Storan Awan → iCloud Drive**, gunakan pengurus fail terbina dalam untuk memuat naik, memuat turun, menamakan semula folder, atau memadam fail terus dalam storan iCloud anda — tanpa menyimpannya ke peranti anda.<br>

⚠️ Berhati-hati apabila memadam fail. Aplikasi memadam fail secara kekal (ia tidak akan pergi ke tong sampah dan tidak boleh dipulihkan).<br>
...
1. **Menggunakan sambungan kabel (disyorkan untuk pustaka besar)**  <br>
   Gunakan aplikasi **Apple Devices** pada Windows 11 untuk memindahkan fail terus ke iPhone anda melalui USB.  
   Ikuti panduan Apple di sini:  
   https://support.apple.com/en-ph/120402 <br>

2. **Secara wayarles melalui Wi-Fi Drive**  <br>
   Aktifkan ciri **WiFi Drive** dalam aplikasi dan muat naik muzik anda melalui pelayar pada komputer anda.  
   Arahan langkah demi langkah di sini:  
   [Cara Memindahkan Fail Muzik dari Komputer ke iPhone Tanpa iTunes Menggunakan WiFi-Drive](/docs/howto/how-to-transfer-music-from-computer-to-iphone-without-itunes/) <br>

3. **Secara wayarles menggunakan Pelayan DLNA**  <br>
   Hidupkan pelayan media DLNA pada komputer Windows anda dan strim atau pindahkan pustaka anda terus ke aplikasi.  
   Panduan:  
...
4. **Secara wayarles menggunakan Perkongsian Fail SMB**  <br>
   Aktifkan **perkongsian fail SMB** pada PC anda dan sambungkan ke dalamnya dalam aplikasi untuk melayari, memuat turun, atau memindahkan fail anda folder demi folder.  
   Arahan:  
   [Pindahkan Fail dari Komputer ke iPhone Menggunakan Protokol SMB](/docs/howto/transfer-your-files-from-the-computer-to-iphone-using-smb-protocol/) <br>
