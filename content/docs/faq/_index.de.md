...
description: 'Finden Sie Antworten auf häufige Fragen zu Evermusic, Flacbox, Evervideo und Evertag. Entdecken Sie Funktionen wie Cloud-Streaming, Dateiverwaltung, Wiedergabeoptionen, Metadaten-Bearbeitung und mehr.'
keywords: [
  "Evermusic FAQ", "Flacbox Support", "Evervideo Hilfe", "Evertag Fragen",
  "wie benutzt man Evermusic", "Fehlerbehebung Cloud-Musikplayer", "Anleitung Offline-Wiedergabe",
  "Support Audio-Tag-Editor", "Videostreaming-Probleme", "Dateiübertragung Tutorial"
]
tags: [
  "FAQ", "Hilfe", "Support", "evermusic", "flacbox", "evervideo", "evertag",
...
Suchen Sie Antworten oder Hilfe bei der Verwendung einer unserer Apps? Sie sind hier genau richtig.

Unsere FAQ-Seiten helfen Ihnen beim Verbinden von Cloud-Speicher, Verwalten von Musik- und Videodateien, Einrichten der Offline-Wiedergabe, Anpassen von Equalizer-Einstellungen, Beheben von Metadaten und vielem mehr.

Erkunden Sie die FAQ für Ihre App unten, um loszulegen, oder durchsuchen Sie häufige Fragen und Antworten, die wir von Nutzer-E-Mails erhalten haben.
...
**WebDAV-Einrichtung:**<br>
- **US-Server:** `https://webdav.pcloud.com`  
- **Europäische Server:** `https://ewebdav.pcloud.com`  
- **Benutzername:** Ihre pCloud-E-Mail-Adresse  
- **Passwort:** Ihr pCloud-Kontopasswort  
...
1. Gehen Sie zur **oberen rechten Ecke** Ihres Bildschirms und öffnen Sie das **Kontrollzentrum** (neben der Uhr).  
2. Klicken Sie auf das **Sound/Lautstärke**-Symbol.  
3. Klicken Sie auf dem nächsten Bildschirm auf **AirPlay**, um eine Liste aller verfügbaren AirPlay-Geräte anzuzeigen.  
...
- Stellen Sie sicher, dass die neueste App-Version auf beiden Geräten installiert ist<br>
- Aktivieren Sie **iCloud** auf beiden Geräten<br>
- Starten Sie die App auf Ihrem iOS-Gerät und warten Sie 1 Minute, bis die Kaufinformationen hochgeladen werden<br>
- Installieren Sie die App auf Ihrem Mac aus dem App Store mit der **gleichen Apple ID**<br>
- Starten Sie die App und warten Sie einige Sekunden, bis die Informationen synchronisiert werden<br>
...
- **Sicherung und Wiederherstellung** aus den App-Einstellungen [So übertragen Sie Ihre Musikbibliothek zwischen Geräten in Evermusic: Schritt-für-Schritt-Anleitung](/docs/howto/how-to-transfer-your-music-library-between-devices-in-evermusic-step-by-step-guide/)<br>
- **Wiedergabeliste nach M3U exportieren** und auf einem anderen Gerät importieren:<br>
  - [So exportieren Sie Wiedergabelisten](/docs/howto/export-tracks-collection-from-evermusic-flacbox-to-m3u-csv-txt/)<br>
...
- Anmeldedaten werden sicher im **iOS Keychain** gespeichert<br>
- Wir erfassen nur anonyme Absturz- und Nutzungsberichte<br>
- Sie können sich in den **App-Einstellungen → Analyse** abmelden<br><br>

Weitere Informationen:<br>
- [Datenschutzrichtlinie](/legal/privacy-policy/)<br>
- [Apple Keychain-Sicherheit](https://support.apple.com/guide/security/keychain-data-protection-secb0694df1a/web)<br><br>
...
- **Einstellungen → Musikbibliothek → Online-Musik-Sync → Hintergrund-Sync**<br><br>
...
Wenn Sie jedoch erfolgreich eine Verbindung zu einem **WD MyCloud EX2 Ultra**, **WD MyCloud Mirror** oder einem anderen **WD MyCloud**-Speichermodell hergestellt haben, können Sie es mit dem folgenden Workaround weiterhin verwenden:<br><br>

1. Öffnen Sie **Verbindungen → Mit Cloud-Speicher verbinden → My Cloud Home**<br>
2. Erstellen Sie mit dem integrierten Dateimanager einen Ordner<br>
3. Laden Sie Musikdateien in diesen Ordner hoch<br>
4. Diese werden in einem „Sandbox" gespeichert, auf den nur die App zugreifen kann<br>
...
**Evermusic**<br>
- iOS (blaues Symbol): `lsevermusic://`<br>
- macOS: `lsevermusicmac://`<br>
- iOS (rotes Symbol): `lsevermusicpro://`<br><br>
...
- Aktivieren Sie **SMB1** auf Ihrem Server und in den App-Einstellungen<br>
- Verwenden Sie die **Systemdateiauswahl**:<br>
  - Gehen Sie zu **Lokale Dateien > Dateien auf diesem Gerät > Dateien öffnen...**<br>
...
– **Wie verwalte ich den iCloud-Speicher?**  <br>
Sie haben zwei Möglichkeiten:  <br>
1. Nutzen Sie [https://www.icloud.com](https://www.icloud.com) in Ihrem Browser, um Dateien zu organisieren, hochzuladen oder zu löschen.<br>  
2. Verwenden Sie in der App nach der Verbindung mit iCloud über **Verbindungen → Mit Cloud-Speicher verbinden → iCloud Drive** den integrierten Dateimanager, um Dateien direkt in Ihrem iCloud-Speicher hochzuladen, herunterzuladen, Ordner umzubenennen oder Dateien zu löschen — ohne sie auf Ihrem Gerät zu speichern.<br>

⚠️ Seien Sie beim Löschen von Dateien vorsichtig. Die App löscht sie dauerhaft (sie werden nicht in den Papierkorb verschoben und können nicht wiederhergestellt werden).<br>
...
1. **Per Kabelverbindung (empfohlen für große Bibliotheken)**  <br>
   Verwenden Sie die **Apple Devices**-App unter Windows 11, um Dateien direkt über USB auf Ihr iPhone zu übertragen.  
   Folgen Sie der Apple-Anleitung hier:  
   https://support.apple.com/en-ph/120402 <br>

2. **Drahtlos über Wi-Fi Drive**  <br>
   Aktivieren Sie die **WiFi Drive**-Funktion in der App und laden Sie Ihre Musik über einen Browser auf Ihrem Computer hoch.  
   Schritt-für-Schritt-Anleitung hier:  
   [So übertragen Sie Musikdateien vom Computer auf das iPhone ohne iTunes mit WiFi-Drive](/docs/howto/how-to-transfer-music-from-computer-to-iphone-without-itunes/) <br>

3. **Drahtlos mit DLNA-Server**  <br>
   Aktivieren Sie den DLNA-Medienserver auf Ihrem Windows-Computer und streamen oder übertragen Sie Ihre Bibliothek direkt in die App.  
   Anleitung:  
   [So aktivieren Sie den DLNA-Medienserver unter Windows 10 und spielen Musik auf dem iPhone ab](/docs/howto/how-to-enable-dlna-media-server-on-windows-10-and-play-your-music-on-iphone/) <br>

4. **Drahtlos mit SMB-Dateifreigabe**  <br>
   Aktivieren Sie die **SMB-Dateifreigabe** auf Ihrem PC und verbinden Sie sich in der App damit, um Ihre Dateien Ordner für Ordner zu durchsuchen, herunterzuladen oder zu übertragen.  
   Anleitung:  
   [Dateien vom Computer auf das iPhone mit dem SMB-Protokoll übertragen](/docs/howto/transfer-your-files-from-the-computer-to-iphone-using-smb-protocol/) <br>
