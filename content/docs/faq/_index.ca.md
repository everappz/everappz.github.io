...
keywords: [
  "Preguntes freqüents Evermusic", "suport Flacbox", "ajuda Evervideo", "preguntes Evertag",
  "com usar Evermusic", "solució de problemes reproductor de música al núvol", "guia de reproducció sense connexió",
  "suport editor d'etiquetes àudio", "problemes de streaming de vídeo", "tutorial de transferència de fitxers"
]
tags: [
  "FAQ", "ajuda", "suport", "evermusic", "flacbox", "evervideo", "evertag",
...
Busques respostes o ajuda per utilitzar una de les nostres aplicacions? Ets al lloc correcte.

Les nostres pàgines de preguntes freqüents t'ajudaran a connectar l'emmagatzematge al núvol, gestionar fitxers de música i vídeo, configurar la reproducció sense connexió, ajustar la configuració de l'equalitzador, corregir metadades i molt més.

Explora les preguntes freqüents de la teva aplicació a continuació per començar, o navega per les preguntes i respostes habituals que hem rebut dels correus electrònics dels usuaris.
...
**Configuració WebDAV:**<br>
- **Servidors EUA:** `https://webdav.pcloud.com`  
- **Servidors europeus:** `https://ewebdav.pcloud.com`  
- **Nom d'usuari:** La teva adreça de correu electrònic de pCloud  
- **Contrasenya:** La contrasenya del teu compte pCloud  
...
1. Vés a la **cantonada superior dreta** de la pantalla i obre el **Centre de control** (a prop del rellotge).  
2. Fes clic a la icona de **So/Volum**.  
3. A la pantalla següent, fes clic a **AirPlay** per veure la llista de dispositius AirPlay disponibles.  
...
- Assegura't de tenir la darrera versió de l'aplicació instal·lada als dos dispositius<br>
- Activa **iCloud** als dos dispositius<br>
- Obre l'aplicació al dispositiu iOS i espera 1 minut perquè la informació de compra es carregui<br>
- Al Mac, instal·la l'aplicació des de l'App Store amb el **mateix Apple ID**<br>
- Obre l'aplicació i espera uns segons perquè la informació es sincronitzi<br>
...
- **Còpia de seguretat i restauració** des de la configuració de l'aplicació [Com transferir la biblioteca de música entre dispositius a Evermusic: guia pas a pas](/docs/howto/how-to-transfer-your-music-library-between-devices-in-evermusic-step-by-step-guide/)<br>
- **Exporta la llista de reproducció a M3U** i importa-la a un altre dispositiu:<br>
  - [Com exportar llistes de reproducció](/docs/howto/export-tracks-collection-from-evermusic-flacbox-to-m3u-csv-txt/)<br>
...
- Les credencials d'inici de sessió s'emmagatzemen de forma segura al **iOS Keychain**<br>
- Només recopilem informes anònims d'errors i ús<br>
- Pots desactivar-ho a **Configuració de l'aplicació → Analítica**<br><br>

Més informació:<br>
- [Política de privadesa](/legal/privacy-policy/)<br>
- [Seguretat del Apple Keychain](https://support.apple.com/guide/security/keychain-data-protection-secb0694df1a/web)<br><br>
...
- **Configuració → Biblioteca de música → Sincronització de música en línia → Sincronització en segon pla**<br><br>
...
No obstant això, si t'has connectat correctament a un **WD MyCloud EX2 Ultra**, **WD MyCloud Mirror** o un altre model d'emmagatzematge **WD MyCloud**, encara pots utilitzar-lo amb la solució alternativa següent:<br><br>

1. Obre **Connexions → Connecta amb emmagatzematge al núvol → My Cloud Home**<br>
2. Crea una carpeta utilitzant el gestor de fitxers integrat<br>
3. Carrega fitxers de música a aquesta carpeta<br>
4. S'emmagatzemaran en un "sandbox" accessible només per l'aplicació<br>
...
**Evermusic**<br>
- iOS (icona blava): `lsevermusic://`<br>
- macOS: `lsevermusicmac://`<br>
- iOS (icona vermella): `lsevermusicpro://`<br><br>
...
- Activa **SMB1** al servidor i a la configuració de l'aplicació<br>
- Utilitza el **selector de fitxers del sistema**:<br>
  - Vés a **Fitxers locals > Fitxers en aquest dispositiu > Obre fitxers...**<br>
...
– **Com gestiono l'emmagatzematge d'iCloud?**  <br>
Tens dues opcions:  <br>
1. Utilitza [https://www.icloud.com](https://www.icloud.com) al teu navegador per organitzar, carregar o eliminar fitxers.<br>  
2. A l'aplicació, un cop connectat a iCloud mitjançant **Connexions → Connecta amb emmagatzematge al núvol → iCloud Drive**, utilitza el gestor de fitxers integrat per carregar, descarregar, reanomenar carpetes o eliminar fitxers directament al teu emmagatzematge iCloud — sense desar-los al dispositiu.<br>

⚠️ Vés amb compte quan eliminis fitxers. L'aplicació els elimina permanentment (no aniran a la paperera i no es podran recuperar).<br>
...
1. **Mitjançant connexió per cable (recomanat per a biblioteques grans)**  <br>
   Utilitza l'aplicació **Apple Devices** a Windows 11 per transferir fitxers directament a l'iPhone via USB.  
   Segueix la guia d'Apple aquí:  
   https://support.apple.com/en-ph/120402 <br>

2. **Sense fils via Wi-Fi Drive**  <br>
   Activa la funció **WiFi Drive** a l'aplicació i carrega la música des d'un navegador a l'ordinador.  
   Instruccions pas a pas aquí:  
   [Com transferir fitxers de música d'un ordinador a l'iPhone sense iTunes amb WiFi-Drive](/docs/howto/how-to-transfer-music-from-computer-to-iphone-without-itunes/) <br>

3. **Sense fils amb servidor DLNA**  <br>
   Activa el servidor multimèdia DLNA a l'ordinador Windows i transmet o transfereix la biblioteca directament a l'aplicació.  
   Guia:  
   [Com activar el servidor multimèdia DLNA a Windows 10 i reproduir música a l'iPhone](/docs/howto/how-to-enable-dlna-media-server-on-windows-10-and-play-your-music-on-iphone/) <br>

4. **Sense fils amb SMB File Sharing**  <br>
   Activa **l'ús compartit de fitxers SMB** al PC i connecta-t'hi a l'aplicació per explorar, descarregar o transferir fitxers carpeta per carpeta.  
   Instruccions:  
   [Transfereix fitxers de l'ordinador a l'iPhone amb el protocol SMB](/docs/howto/transfer-your-files-from-the-computer-to-iphone-using-smb-protocol/) <br>
