...
keywords: [
  "FAQ Evermusic", "dukungan Flacbox", "bantuan Evervideo", "pertanyaan Evertag",
  "cara menggunakan Evermusic", "pemecahan masalah pemutar musik cloud", "panduan pemutaran offline",
  "dukungan editor tag audio", "masalah streaming video", "tutorial transfer file"
]
tags: [
  "FAQ", "bantuan", "dukungan", "evermusic", "flacbox", "evervideo", "evertag",
...
Mencari jawaban atau bantuan untuk menggunakan salah satu aplikasi kami? Anda berada di tempat yang tepat.

Halaman FAQ kami akan membantu Anda menghubungkan penyimpanan cloud, mengelola file musik dan video, mengatur pemutaran offline, menyesuaikan pengaturan ekualizer, memperbaiki metadata, dan banyak lagi.

Jelajahi FAQ untuk aplikasi Anda di bawah ini untuk memulai, atau telusuri pertanyaan dan jawaban umum yang kami terima dari email pengguna.
...
{{< card 
  ...
  title="Evervideo" 
  subtitle="Putar video 360°, streaming dari iCloud, tonton dengan subtitle, terapkan ekualizer video, atur konten dengan playlist, dan unduh video untuk ditonton offline."
...
{{< card 
  ...
  title="Evermusic" 
  subtitle="Pemutar musik cloud dengan mode offline, ekualizer audio, crossfade, pemutaran gapless, manajemen playlist, perpustakaan musik lengkap, dan pengelola file bawaan."
...
{{< card 
  ...
  title="Flacbox" 
  subtitle="Pemutar audio resolusi tinggi untuk iPhone dan Mac. Dengarkan format lossless seperti FLAC, ALAC, APE, dan DSD. Sesuaikan output dengan pengaturan audio canggih."
...
{{< card 
  ...
  title="Evertag" 
  subtitle="Editor tag musik cerdas dengan pengeditan massal. Perbaiki metadata yang hilang, sampul album, dan lainnya. Edit tag ID3, FLAC, APE — lebih dari 120 field didukung." 
...
**Pengaturan WebDAV:**<br>
- **Server AS:** `https://webdav.pcloud.com`  
- **Server Eropa:** `https://ewebdav.pcloud.com`  
- **Nama pengguna:** Alamat email pCloud Anda  
- **Kata sandi:** Kata sandi akun pCloud Anda  
...
1. Pergi ke **sudut kanan atas** layar Anda dan buka **Control Center** (dekat jam).  
2. Klik ikon **Suara/Volume**.  
3. Di layar berikutnya, klik **AirPlay** untuk melihat daftar semua perangkat AirPlay yang tersedia.  
...
- Pastikan Anda memiliki versi aplikasi terbaru yang terpasang di kedua perangkat<br>
- Aktifkan **iCloud** di kedua perangkat<br>
- Luncurkan aplikasi di perangkat iOS Anda dan tunggu 1 menit agar informasi pembelian terunggah<br>
- Di Mac Anda, instal aplikasi dari App Store menggunakan **Apple ID yang sama**<br>
- Luncurkan aplikasi dan tunggu beberapa detik agar informasi tersinkronisasi<br>
...
- **Cadangkan dan Pulihkan** dari Pengaturan Aplikasi [Cara Mentransfer Perpustakaan Musik Antar Perangkat di Evermusic: Panduan Langkah demi Langkah](/docs/howto/how-to-transfer-your-music-library-between-devices-in-evermusic-step-by-step-guide/)<br>
- **Ekspor playlist ke M3U**, lalu impor di perangkat lain:<br>
  - [Cara Mengekspor Playlist](/docs/howto/export-tracks-collection-from-evermusic-flacbox-to-m3u-csv-txt/)<br>
...
- Kredensial login tersimpan dengan aman di **iOS Keychain**<br>
- Kami hanya mengumpulkan laporan crash dan penggunaan anonim<br>
- Anda dapat menonaktifkannya di **Pengaturan Aplikasi → Analitik**<br><br>

Info lebih lanjut:<br>
- [Kebijakan Privasi](/legal/privacy-policy/)<br>
- [Keamanan Apple Keychain](https://support.apple.com/guide/security/keychain-data-protection-secb0694df1a/web)<br><br>
...
- **Pengaturan → Perpustakaan Musik → Sinkronisasi Musik Online → Sinkronisasi Latar Belakang**<br><br>
...
Namun, jika Anda berhasil terhubung ke **WD MyCloud EX2 Ultra**, **WD MyCloud Mirror**, atau model penyimpanan **WD MyCloud** lainnya, Anda masih dapat menggunakannya dengan solusi berikut:<br><br>

1. Buka **Koneksi → Hubungkan ke Penyimpanan Cloud → My Cloud Home**<br>
2. Buat folder menggunakan pengelola file bawaan<br>
3. Unggah file musik ke folder ini<br>
4. File akan tersimpan di "sandbox" yang hanya dapat diakses oleh aplikasi<br>
...
**Evermusic**<br>
- iOS (ikon biru): `lsevermusic://`<br>
- macOS: `lsevermusicmac://`<br>
- iOS (ikon merah): `lsevermusicpro://`<br><br>
...
- Aktifkan **SMB1** di server dan di pengaturan aplikasi<br>
- Gunakan **pemilih file sistem**:<br>
  - Buka **File Lokal > File di Perangkat Ini > Buka File...**<br>
...
– **Bagaimana cara mengelola penyimpanan iCloud?**  <br>
Anda memiliki dua pilihan:  <br>
1. Gunakan [https://www.icloud.com](https://www.icloud.com) di browser Anda untuk mengatur, mengunggah, atau menghapus file.<br>  
2. Di aplikasi, setelah terhubung ke iCloud melalui **Koneksi → Hubungkan ke Penyimpanan Cloud → iCloud Drive**, gunakan pengelola file bawaan untuk mengunggah, mengunduh, mengganti nama folder, atau menghapus file langsung di penyimpanan iCloud Anda — tanpa menyimpannya ke perangkat.<br>

⚠️ Berhati-hatilah saat menghapus file. Aplikasi menghapusnya secara permanen (tidak akan masuk ke tempat sampah dan tidak dapat dipulihkan).<br>
...
1. **Menggunakan koneksi kabel (direkomendasikan untuk perpustakaan besar)**  <br>
   Gunakan aplikasi **Apple Devices** di Windows 11 untuk mentransfer file langsung ke iPhone melalui USB.  
   Ikuti panduan Apple di sini:  
   https://support.apple.com/en-ph/120402 <br>

2. **Secara nirkabel melalui Wi-Fi Drive**  <br>
   Aktifkan fitur **WiFi Drive** di dalam aplikasi dan unggah musik Anda melalui browser di komputer Anda.  
   Petunjuk langkah demi langkah di sini:  
   [Cara Mentransfer File Musik dari Komputer ke iPhone Tanpa iTunes Menggunakan WiFi-Drive](/docs/howto/how-to-transfer-music-from-computer-to-iphone-without-itunes/) <br>

3. **Secara nirkabel menggunakan Server DLNA**  <br>
   Aktifkan server media DLNA di komputer Windows Anda dan streaming atau transfer perpustakaan Anda langsung ke aplikasi.  
   Panduan:  
   [Cara Mengaktifkan Server Media DLNA di Windows 10 dan Memutar Musik di iPhone](/docs/howto/how-to-enable-dlna-media-server-on-windows-10-and-play-your-music-on-iphone/) <br>

4. **Secara nirkabel menggunakan SMB File Sharing**  <br>
   Aktifkan **berbagi file SMB** di PC Anda dan hubungkan ke aplikasi untuk menelusuri, mengunduh, atau mentransfer file folder demi folder.  
   Petunjuk:  
   [Transfer File dari Komputer ke iPhone Menggunakan Protokol SMB](/docs/howto/transfer-your-files-from-the-computer-to-iphone-using-smb-protocol/) <br>
