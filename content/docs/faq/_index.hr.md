...
description: 'Pronađite odgovore na uobičajena pitanja o Evermusic, Flacbox, Evervideo i Evertag. Istražite značajke kao što su cloud streaming, upravljanje datotekama, mogućnosti reprodukcije, uređivanje metapodataka i više.'
keywords: [
  "Evermusic FAQ", "podrška Flacbox", "pomoć Evervideo", "pitanja Evertag",
  "kako koristiti Evermusic", "rješavanje problema cloud glazbenog playera", "vodič za offline reprodukciju",
  "podrška uređivaču audio oznaka", "problemi s video streamingom", "vodič za prijenos datoteka"
]
tags: [
  "FAQ", "pomoć", "podrška", "evermusic", "flacbox", "evervideo", "evertag",
...
Tražite odgovore ili pomoć pri korištenju jedne od naših aplikacija? Na pravom ste mjestu.

Naše FAQ stranice pomoći će vam da povežete pohranu u oblaku, upravljate glazbenim i video datotekama, postavite offline reprodukciju, prilagodite postavke ekvilajzera, ispravite metapodatke i mnogo više.

Istražite FAQ za svoju aplikaciju u nastavku kako biste započeli, ili pregledajte uobičajena pitanja i odgovore koje smo primili od korisnika.
...
**WebDAV postavke:**<br>
- **Američki poslužitelji:** `https://webdav.pcloud.com`  
- **Europski poslužitelji:** `https://ewebdav.pcloud.com`  
- **Korisničko ime:** Vaša pCloud e-mail adresa  
- **Lozinka:** Lozinka vašeg pCloud računa  
...
1. Idite u **gornji desni kut** zaslona i otvorite **Kontrolni centar** (blizu sata).  
2. Kliknite na ikonu **Zvuk/Glasnoća**.  
3. Na sljedećem zaslonu kliknite **AirPlay** za prikaz popisa svih dostupnih AirPlay uređaja.  
...
- Provjerite je li na oba uređaja instalirana najnovija verzija aplikacije<br>
- Omogućite **iCloud** na oba uređaja<br>
- Pokrenite aplikaciju na iOS uređaju i pričekajte 1 minutu da se informacije o kupnji učitaju<br>
- Na Macu instalirajte aplikaciju iz App Storea koristeći **isti Apple ID**<br>
- Pokrenite aplikaciju i pričekajte nekoliko sekundi za sinkronizaciju informacija<br>
...
- **Sigurnosna kopija i obnavljanje** iz postavki aplikacije [Kako prenijeti glazbenu biblioteku između uređaja u Evermusictu: vodič korak po korak](/docs/howto/how-to-transfer-your-music-library-between-devices-in-evermusic-step-by-step-guide/)<br>
- **Izvezi popis za reprodukciju u M3U** pa uvezi na drugom uređaju:<br>
  - [Kako izvesti popise za reprodukciju](/docs/howto/export-tracks-collection-from-evermusic-flacbox-to-m3u-csv-txt/)<br>
...
- Vjerodajnice za prijavu sigurno su pohranjene u **iOS Keychain**<br>
- Prikupljamo samo anonimna izvješća o rušenjima i korištenju<br>
- Možete se isključiti u **Postavke aplikacije → Analitika**<br><br>

Više informacija:<br>
- [Pravila privatnosti](/legal/privacy-policy/)<br>
- [Sigurnost Apple Keychain](https://support.apple.com/guide/security/keychain-data-protection-secb0694df1a/web)<br><br>
...
- **Postavke → Glazbena biblioteka → Online sinkronizacija glazbe → Pozadinska sinkronizacija**<br><br>
...
Međutim, ako ste se uspješno povezali s **WD MyCloud EX2 Ultra**, **WD MyCloud Mirrorom** ili drugim modelom pohrane **WD MyCloud**, još ga uvijek možete koristiti sa sljedećim zaobilaznim rješenjem:<br><br>

1. Otvorite **Veze → Poveži s pohranom u oblaku → My Cloud Home**<br>
2. Kreirajte mapu koristeći ugrađeni upravitelj datoteka<br>
3. Učitajte glazbene datoteke u ovu mapu<br>
4. One će biti pohranjene u "sandbox" dostupan samo aplikaciji<br>
...
**Evermusic**<br>
- iOS (plava ikona): `lsevermusic://`<br>
- macOS: `lsevermusicmac://`<br>
- iOS (crvena ikona): `lsevermusicpro://`<br><br>
...
- Omogućite **SMB1** na vašem poslužitelju i u postavkama aplikacije<br>
- Koristite **sistemski odabir datoteka**:<br>
  - Idite na **Lokalne datoteke > Datoteke na ovom uređaju > Otvori datoteke...**<br>
...
– **Kako upravljati iCloud pohranom?**  <br>
Imate dvije mogućnosti:  <br>
1. Koristite [https://www.icloud.com](https://www.icloud.com) u pregledniku za organiziranje, učitavanje ili brisanje datoteka.<br>  
2. U aplikaciji, nakon spajanja na iCloud putem **Veze → Poveži s pohranom u oblaku → iCloud Drive**, koristite ugrađeni upravitelj datoteka za učitavanje, preuzimanje, preimenovanje mapa ili brisanje datoteka izravno u vašoj iCloud pohrani — bez njihovog spremanja na uređaj.<br>

⚠️ Budite oprezni pri brisanju datoteka. Aplikacija ih trajno briše (neće ići u smeće i ne mogu se oporaviti).<br>
...
1. **Koristeći kabelsku vezu (preporučeno za velike biblioteke)**  <br>
   Koristite aplikaciju **Apple Devices** na Windows 11 za izravni prijenos datoteka na iPhone putem USB-a.  
   Slijedite Appleov vodič ovdje:  
   https://support.apple.com/en-ph/120402 <br>

2. **Bežično putem Wi-Fi Drivea**  <br>
   Omogućite funkciju **WiFi Drive** unutar aplikacije i učitajte glazbu putem preglednika na računalu.  
   Upute korak po korak ovdje:  
   [Kako prenijeti glazbene datoteke s računala na iPhone bez iTunesa koristeći WiFi-Drive](/docs/howto/how-to-transfer-music-from-computer-to-iphone-without-itunes/) <br>

3. **Bežično koristeći DLNA poslužitelj**  <br>
   Uključite DLNA medijski poslužitelj na Windows računalu i streamajte ili prenesite biblioteku izravno u aplikaciju.  
   Vodič:  
   [Kako omogućiti DLNA medijski poslužitelj na Windows 10 i reproducirati glazbu na iPhoneu](/docs/howto/how-to-enable-dlna-media-server-on-windows-10-and-play-your-music-on-iphone/) <br>

4. **Bežično koristeći SMB dijeljenje datoteka**  <br>
   Omogućite **SMB dijeljenje datoteka** na PC-u i povežite se s njim u aplikaciji za pregledavanje, preuzimanje ili prijenos datoteka mapu po mapu.  
   Upute:  
   [Prijenos datoteka s računala na iPhone koristeći SMB protokol](/docs/howto/transfer-your-files-from-the-computer-to-iphone-using-smb-protocol/) <br>
