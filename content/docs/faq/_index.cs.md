...
draft: false
title: 'Časté dotazy'
description: 'Najděte odpovědi na běžné otázky o Evermusic, Flacbox, Evervideo a Evertag. Prozkoumejte funkce jako cloudové streamování, správa souborů, možnosti přehrávání, úprava metadat a další.'
keywords: [
  "Evermusic časté dotazy", "podpora Flacbox", "pomoc Evervideo", "otázky Evertag",
  "jak používat Evermusic", "řešení potíží cloudového přehrávače hudby", "průvodce offline přehráváním",
  "podpora editoru zvukových tagů", "problémy se streamováním videa", "výukový program pro přenos souborů"
]
tags: [
  "FAQ", "pomoc", "podpora", "evermusic", "flacbox", "evervideo", "evertag",
  "nastavení cloudu", "problémy s přehráváním", "správa souborů", "úprava metadat",
  "řešení problémů", "offline režim", "přehrávač hudby", "přehrávač videa"
]
aliases:
...
Hledáte odpovědi nebo pomoc při používání jedné z našich aplikací? Jste na správném místě.

Naše stránky s často kladenými otázkami vám pomohou připojit cloudové úložiště, spravovat hudební a video soubory, nastavit offline přehrávání, upravit nastavení ekvalizéru, opravit metadata a mnoho dalšího.

Prohlédněte si níže FAQ pro svou aplikaci a začněte, nebo procházejte běžné otázky a odpovědi, které jsme obdrželi od uživatelů.
...
{{< card 
  ...
  title="Evervideo" 
  subtitle="Přehrávejte 360° videa, streamujte z iCloudu, sledujte s titulky, aplikujte video ekvalizér, organizujte obsah pomocí seznamů přehrávání a stahujte videa pro offline sledování."
...
{{< card 
  ...
  title="Evermusic" 
  subtitle="Cloudový přehrávač hudby s offline režimem, audio ekvalizérem, crossfade, plynulým přehráváním, správou seznamů přehrávání, kompletní hudební knihovnou a vestavěným správcem souborů."
...
{{< card 
  ...
  title="Flacbox" 
  subtitle="Přehrávač zvuku ve vysokém rozlišení pro iPhone a Mac. Poslouchejte bezztrátové formáty jako FLAC, ALAC, APE a DSD. Dolaďte výstup pomocí pokročilých nastavení zvuku."
...
{{< card 
  ...
  title="Evertag" 
  subtitle="Chytrý editor hudebních tagů s dávkovou úpravou. Opravte chybějící metadata, obaly alb a další. Upravujte tagy ID3, FLAC, APE — podporováno více než 120 polí." 
...
- **Evropské servery:** `https://ewebdav.pcloud.com`  
- **Uživatelské jméno:** Vaše e-mailová adresa pCloud  
- **Heslo:** Heslo k vašemu účtu pCloud  
...
1. Přejděte do **pravého horního rohu** obrazovky a otevřete **Centrum řízení** (u hodin).  
2. Klikněte na ikonu **Zvuk/Hlasitost**.  
3. Na další obrazovce klikněte na **AirPlay** a zobrazte seznam dostupných zařízení AirPlay.  
...
- Ujistěte se, že máte na obou zařízeních nainstalovanou nejnovější verzi aplikace<br>
- Povolte **iCloud** na obou zařízeních<br>
- Spusťte aplikaci na iOS zařízení a počkejte 1 minutu, než se informace o nákupu nahrají<br>
- Na Macu nainstalujte aplikaci z App Store pomocí **stejného Apple ID**<br>
- Spusťte aplikaci a počkejte několik sekund na synchronizaci informací<br>
...
- **Záloha a obnovení** z nastavení aplikace [Jak přenést hudební knihovnu mezi zařízeními v Evermusic: průvodce krok za krokem](/docs/howto/how-to-transfer-your-music-library-between-devices-in-evermusic-step-by-step-guide/)<br>
- **Export seznamu přehrávání do M3U** a jeho import na jiném zařízení:<br>
  - [Jak exportovat seznamy přehrávání](/docs/howto/export-tracks-collection-from-evermusic-flacbox-to-m3u-csv-txt/)<br>
...
- Přihlašovací údaje jsou bezpečně uloženy v **iOS Keychain**<br>
- Shromažďujeme pouze anonymní hlášení o chybách a používání<br>
- Můžete se odhlásit v **Nastavení aplikace → Analytika**<br><br>

Více informací:<br>
- [Zásady ochrany osobních údajů](/legal/privacy-policy/)<br>
- [Zabezpečení Apple Keychain](https://support.apple.com/guide/security/keychain-data-protection-secb0694df1a/web)<br><br>
...
- **Nastavení → Hudební knihovna → Online synchronizace hudby → Synchronizace na pozadí**<br><br>
...
Pokud jste se však úspěšně připojili k **WD MyCloud EX2 Ultra**, **WD MyCloud Mirror** nebo jinému modelu úložiště **WD MyCloud**, můžete jej stále používat s následujícím řešením:<br><br>

1. Otevřete **Připojení → Připojit ke cloudovému úložišti → My Cloud Home**<br>
2. Vytvořte složku pomocí vestavěného správce souborů<br>
3. Nahrajte hudební soubory do této složky<br>
4. Budou uloženy v „sandboxu" přístupném pouze pro aplikaci<br>
...
- Povolte **SMB1** na svém serveru a v nastavení aplikace<br>
- Použijte **systémový výběr souborů**:<br>
  - Přejděte do **Místní soubory > Soubory v tomto zařízení > Otevřít soubory...**<br>
...
– **Jak spravuji úložiště iCloud?**  <br>
Máte dvě možnosti:  <br>
1. Použijte [https://www.icloud.com](https://www.icloud.com) v prohlížeči k organizaci, nahrávání nebo mazání souborů.<br>  
2. V aplikaci, po připojení k iCloudu přes **Připojení → Připojit ke cloudovému úložišti → iCloud Drive**, použijte vestavěný správce souborů k nahrávání, stahování, přejmenování složek nebo mazání souborů přímo v úložišti iCloud — bez jejich ukládání do zařízení.<br>

⚠️ Buďte opatrní při mazání souborů. Aplikace je trvale smaže (nepůjdou do koše a nelze je obnovit).<br>
...
1. **Pomocí kabelového připojení (doporučeno pro velké knihovny)**  <br>
   Použijte aplikaci **Apple Devices** na Windows 11 k přenosu souborů přímo do iPhonu přes USB.  
   Postupujte podle průvodce Apple zde:  
   https://support.apple.com/en-ph/120402 <br>

2. **Bezdrátově přes Wi-Fi Drive**  <br>
   Povolte funkci **WiFi Drive** v aplikaci a nahrajte hudbu přes prohlížeč v počítači.  
   Pokyny krok za krokem zde:  
   [Jak přenést hudební soubory z počítače do iPhonu bez iTunes pomocí WiFi-Drive](/docs/howto/how-to-transfer-music-from-computer-to-iphone-without-itunes/) <br>

3. **Bezdrátově pomocí serveru DLNA**  <br>
   Zapněte mediální server DLNA na počítači s Windows a streamujte nebo přeneste knihovnu přímo do aplikace.  
   Průvodce:  
   [Jak povolit mediální server DLNA ve Windows 10 a přehrávat hudbu na iPhonu](/docs/howto/how-to-enable-dlna-media-server-on-windows-10-and-play-your-music-on-iphone/) <br>

4. **Bezdrátově pomocí sdílení souborů SMB**  <br>
   Povolte **sdílení souborů SMB** na PC a připojte se k němu v aplikaci pro procházení, stahování nebo přenos souborů složku po složce.  
   Pokyny:  
   [Přenos souborů z počítače do iPhonu pomocí protokolu SMB](/docs/howto/transfer-your-files-from-the-computer-to-iphone-using-smb-protocol/) <br>
