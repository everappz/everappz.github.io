...
keywords: [
  "Evermusic SSS", "Flacbox destek", "Evervideo yardım", "Evertag soruları",
  "Evermusic nasıl kullanılır", "bulut müzik çalar sorun giderme", "çevrimdışı oynatma kılavuzu",
  "ses etiketi düzenleyici desteği", "video akışı sorunları", "dosya aktarım öğreticisi"
]
tags: [
  "SSS", "yardım", "destek", "evermusic", "flacbox", "evervideo", "evertag",
...
Uygulamalarımızdan birini kullanırken cevap veya yardım mı arıyorsunuz? Doğru yerdesiniz.

SSS sayfalarımız bulut depolamayı bağlamanıza, müzik ve video dosyalarını yönetmenize, çevrimdışı oynatmayı ayarlamanıza, ekolayzer ayarlarını düzenlemenize, meta verileri düzeltmenize ve çok daha fazlasına yardımcı olacaktır.

Başlamak için aşağıda uygulamanızın SSS'ini keşfedin veya kullanıcı e-postalarından aldığımız yaygın soru ve cevaplara göz atın.
...
{{< card 
  ...
  title="Evervideo" 
  subtitle="360° videolar oynatın, iCloud'dan akış yapın, altyazıyla izleyin, video ekolayzer uygulayın, çalma listeleriyle içerikleri düzenleyin ve çevrimdışı izleme için video indirin."
...
{{< card 
  ...
  title="Evermusic" 
  subtitle="Çevrimdışı mod, ses ekolayzer, crossfade, kesintisiz oynatma, çalma listesi yönetimi, tam müzik kütüphanesi ve dahili dosya yöneticisi ile bulut müzik çalar."
...
{{< card 
  ...
  title="Flacbox" 
  subtitle="iPhone ve Mac için yüksek çözünürlüklü ses çalar. FLAC, ALAC, APE ve DSD gibi kayıpsız formatları dinleyin. Gelişmiş ses ayarlarıyla çıktıyı ince ayarlayın."
...
{{< card 
  ...
  title="Evertag" 
  subtitle="Toplu düzenleme özellikli akıllı müzik etiketi düzenleyicisi. Eksik meta verileri, albüm kapaklarını ve daha fazlasını düzeltin. ID3, FLAC, APE etiketlerini düzenleyin — 120'den fazla alan desteklenir." 
...
**WebDAV Kurulumu:**<br>
- **ABD Sunucuları:** `https://webdav.pcloud.com`  
- **Avrupa Sunucuları:** `https://ewebdav.pcloud.com`  
- **Kullanıcı Adı:** pCloud e-posta adresiniz  
- **Şifre:** pCloud hesap şifreniz  
...
1. Ekranınızın **sağ üst köşesine** gidin ve **Kontrol Merkezi**'ni açın (saatin yanında).  
2. **Ses/Ses Düzeyi** simgesine tıklayın.  
3. Sonraki ekranda, mevcut tüm AirPlay cihazlarının listesini görmek için **AirPlay**'e tıklayın.  
...
- Her iki cihaza da uygulamanın en son sürümünün yüklü olduğundan emin olun<br>
- Her iki cihazda da **iCloud**'u etkinleştirin<br>
- iOS cihazınızda uygulamayı başlatın ve satın alma bilgilerinin yüklenmesi için 1 dakika bekleyin<br>
- Mac'inizde **aynı Apple ID** ile App Store'dan uygulamayı yükleyin<br>
- Uygulamayı başlatın ve bilgilerin senkronize edilmesi için birkaç saniye bekleyin<br>
...
- Uygulama Ayarlarından **Yedekle ve Geri Yükle** [Evermusic'te Müzik Kütüphanenizi Cihazlar Arasında Nasıl Aktarırsınız: Adım Adım Kılavuz](/docs/howto/how-to-transfer-your-music-library-between-devices-in-evermusic-step-by-step-guide/)<br>
- **Çalma listesini M3U'ya aktarın**, ardından başka bir cihaza içe aktarın:<br>
  - [Çalma Listeleri Nasıl Dışa Aktarılır](/docs/howto/export-tracks-collection-from-evermusic-flacbox-to-m3u-csv-txt/)<br>
...
- Giriş kimlik bilgileri güvenli bir şekilde **iOS Keychain**'de saklanır<br>
- Yalnızca anonim çökme ve kullanım raporları topluyoruz<br>
- **Uygulama Ayarları → Analitik**'ten vazgeçebilirsiniz<br><br>

Daha fazla bilgi:<br>
- [Gizlilik Politikası](/legal/privacy-policy/)<br>
- [Apple Keychain Güvenliği](https://support.apple.com/guide/security/keychain-data-protection-secb0694df1a/web)<br><br>
...
- **Ayarlar → Müzik Kütüphanesi → Çevrimiçi Müzik Senkronizasyonu → Arka Plan Senkronizasyonu**<br><br>
...
Ancak bir **WD MyCloud EX2 Ultra**, **WD MyCloud Mirror** veya başka bir **WD MyCloud** depolama modeline başarıyla bağlandıysanız, aşağıdaki geçici çözümle kullanmaya devam edebilirsiniz:<br><br>

1. **Bağlantılar → Bulut Depolamaya Bağlan → My Cloud Home**'u açın<br>
2. Yerleşik dosya yöneticisini kullanarak bir klasör oluşturun<br>
3. Müzik dosyalarını bu klasöre yükleyin<br>
4. Bunlar yalnızca uygulama tarafından erişilebilen bir "kum havuzunda" saklanacaktır<br>
...
**Evermusic**<br>
- iOS (mavi simge): `lsevermusic://`<br>
- macOS: `lsevermusicmac://`<br>
- iOS (kırmızı simge): `lsevermusicpro://`<br><br>
...
- Sunucunuzda ve uygulama ayarlarında **SMB1**'i etkinleştirin<br>
- **Sistem dosya seçiciyi** kullanın:<br>
  - **Yerel Dosyalar > Bu Cihazındaki Dosyalar > Dosya Aç...**'a gidin<br>
...
– **iCloud depolamayı nasıl yönetirim?**  <br>
İki seçeneğiniz var:  <br>
1. Dosyaları düzenlemek, yüklemek veya silmek için tarayıcınızda [https://www.icloud.com](https://www.icloud.com) kullanın.<br>  
2. Uygulamada, **Bağlantılar → Bulut Depolamaya Bağlan → iCloud Drive** üzerinden iCloud'a bağlandıktan sonra, cihazınıza kaydetmeden iCloud depolama alanınızdaki dosyaları doğrudan yüklemek, indirmek, klasörleri yeniden adlandırmak veya silmek için yerleşik dosya yöneticisini kullanın.<br>

⚠️ Dosyaları silerken dikkatli olun. Uygulama bunları kalıcı olarak siler (çöp kutusuna gitmez ve kurtarılamaz).<br>
...
1. **Kablo bağlantısı kullanma (büyük kütüphaneler için önerilir)**  <br>
   Dosyaları doğrudan USB üzerinden iPhone'a aktarmak için Windows 11'deki **Apple Devices** uygulamasını kullanın.  
   Apple'ın kılavuzunu buradan takip edin:  
   https://support.apple.com/en-ph/120402 <br>

2. **Wi-Fi Drive üzerinden kablosuz**  <br>
   Uygulama içindeki **WiFi Drive** özelliğini etkinleştirin ve müziğinizi bilgisayarınızdaki bir tarayıcı aracılığıyla yükleyin.  
   Adım adım talimatlar burada:  
   [WiFi-Drive Kullanarak iTunes Olmadan Bilgisayardan iPhone'a Müzik Dosyası Aktarma](/docs/howto/how-to-transfer-music-from-computer-to-iphone-without-itunes/) <br>

3. **DLNA Sunucusu kullanarak kablosuz**  <br>
   Windows bilgisayarınızda DLNA medya sunucusunu açın ve kütüphanenizi doğrudan uygulamaya akış yapın veya aktarın.  
   Kılavuz:  
   [Windows 10'da DLNA Medya Sunucusunu Etkinleştirme ve iPhone'da Müzik Oynatma](/docs/howto/how-to-enable-dlna-media-server-on-windows-10-and-play-your-music-on-iphone/) <br>

4. **SMB Dosya Paylaşımı kullanarak kablosuz**  <br>
   PC'nizde **SMB dosya paylaşımını** etkinleştirin ve dosyalarınızı klasör klasör taramak, indirmek veya aktarmak için uygulamada bu bağlantıyı kullanın.  
   Talimatlar:  
   [SMB Protokolü Kullanarak Bilgisayardan iPhone'a Dosya Aktarma](/docs/howto/transfer-your-files-from-the-computer-to-iphone-using-smb-protocol/) <br>
