...
keywords: [
  "Evermusic FAQ", "hỗ trợ Flacbox", "trợ giúp Evervideo", "câu hỏi Evertag",
  "cách sử dụng Evermusic", "khắc phục sự cố trình phát nhạc đám mây", "hướng dẫn phát lại ngoại tuyến",
  "hỗ trợ trình chỉnh sửa thẻ âm thanh", "sự cố phát trực tuyến video", "hướng dẫn truyền tệp"
]
tags: [
  "FAQ", "trợ giúp", "hỗ trợ", "evermusic", "flacbox", "evervideo", "evertag",
...
Bạn đang tìm câu trả lời hoặc trợ giúp khi sử dụng một trong các ứng dụng của chúng tôi? Bạn đã đến đúng nơi rồi.

Các trang FAQ của chúng tôi sẽ giúp bạn kết nối bộ nhớ đám mây, quản lý tệp âm nhạc và video, thiết lập phát lại ngoại tuyến, điều chỉnh cài đặt bộ chỉnh âm, sửa siêu dữ liệu và nhiều hơn nữa.

Khám phá FAQ cho ứng dụng của bạn bên dưới để bắt đầu, hoặc duyệt qua các câu hỏi và câu trả lời phổ biến mà chúng tôi nhận được từ email của người dùng.
...
**Cài đặt WebDAV:**<br>
- **Máy chủ Mỹ:** `https://webdav.pcloud.com`  
- **Máy chủ Châu Âu:** `https://ewebdav.pcloud.com`  
- **Tên đăng nhập:** Địa chỉ email pCloud của bạn  
- **Mật khẩu:** Mật khẩu tài khoản pCloud của bạn  
...
1. Đi đến **góc trên bên phải** màn hình và mở **Trung tâm điều khiển** (gần đồng hồ).  
2. Nhấp vào biểu tượng **Âm thanh/Âm lượng**.  
3. Trong màn hình tiếp theo, nhấp vào **AirPlay** để xem danh sách tất cả các thiết bị AirPlay có sẵn.  
...
- Đảm bảo bạn đã cài đặt phiên bản ứng dụng mới nhất trên cả hai thiết bị<br>
- Bật **iCloud** trên cả hai thiết bị<br>
- Khởi chạy ứng dụng trên thiết bị iOS và chờ 1 phút để thông tin mua hàng được tải lên<br>
- Trên Mac, cài đặt ứng dụng từ App Store bằng **cùng một Apple ID**<br>
- Khởi chạy ứng dụng và chờ vài giây để thông tin đồng bộ<br>
...
- **Sao lưu và Khôi phục** từ Cài đặt ứng dụng [Cách chuyển thư viện nhạc giữa các thiết bị trong Evermusic: Hướng dẫn từng bước](/docs/howto/how-to-transfer-your-music-library-between-devices-in-evermusic-step-by-step-guide/)<br>
- **Xuất danh sách phát sang M3U**, sau đó nhập trên thiết bị khác:<br>
  - [Cách xuất danh sách phát](/docs/howto/export-tracks-collection-from-evermusic-flacbox-to-m3u-csv-txt/)<br>
...
- Thông tin đăng nhập được lưu trữ an toàn trong **iOS Keychain**<br>
- Chúng tôi chỉ thu thập báo cáo sự cố và sử dụng ẩn danh<br>
- Bạn có thể từ chối trong **Cài đặt ứng dụng → Phân tích**<br><br>

Thông tin thêm:<br>
- [Chính sách bảo mật](/legal/privacy-policy/)<br>
- [Bảo mật Apple Keychain](https://support.apple.com/guide/security/keychain-data-protection-secb0694df1a/web)<br><br>
...
- **Cài đặt → Thư viện nhạc → Đồng bộ nhạc trực tuyến → Đồng bộ nền**<br><br>
...
Tuy nhiên, nếu bạn đã kết nối thành công với **WD MyCloud EX2 Ultra**, **WD MyCloud Mirror** hoặc một model **WD MyCloud** khác, bạn vẫn có thể sử dụng nó với cách giải quyết sau:<br><br>

1. Mở **Kết nối → Kết nối với Bộ nhớ đám mây → My Cloud Home**<br>
2. Tạo một thư mục bằng trình quản lý tệp tích hợp<br>
3. Tải tệp nhạc vào thư mục này<br>
4. Các tệp sẽ được lưu trữ trong "sandbox" chỉ ứng dụng mới truy cập được<br>
...
**Evermusic**<br>
- iOS (biểu tượng xanh): `lsevermusic://`<br>
- macOS: `lsevermusicmac://`<br>
- iOS (biểu tượng đỏ): `lsevermusicpro://`<br><br>
...
- Bật **SMB1** trên máy chủ và trong cài đặt ứng dụng<br>
- Sử dụng **bộ chọn tệp hệ thống**:<br>
  - Đi đến **Tệp cục bộ > Tệp trên thiết bị này > Mở tệp...**<br>
...
– **Cách quản lý bộ nhớ iCloud?**  <br>
Bạn có hai lựa chọn:  <br>
1. Sử dụng [https://www.icloud.com](https://www.icloud.com) trong trình duyệt để sắp xếp, tải lên hoặc xóa tệp.<br>  
2. Trong ứng dụng, sau khi kết nối với iCloud qua **Kết nối → Kết nối với Bộ nhớ đám mây → iCloud Drive**, sử dụng trình quản lý tệp tích hợp để tải lên, tải xuống, đổi tên thư mục hoặc xóa tệp trực tiếp trong bộ nhớ iCloud — mà không lưu vào thiết bị của bạn.<br>

⚠️ Hãy cẩn thận khi xóa tệp. Ứng dụng xóa vĩnh viễn chúng (chúng sẽ không vào thùng rác và không thể khôi phục).<br>
...
1. **Sử dụng kết nối cáp (khuyến nghị cho thư viện lớn)**  <br>
   Sử dụng ứng dụng **Apple Devices** trên Windows 11 để chuyển tệp trực tiếp sang iPhone qua USB.  
   Làm theo hướng dẫn của Apple tại đây:  
   https://support.apple.com/en-ph/120402 <br>

2. **Không dây qua Wi-Fi Drive**  <br>
   Bật tính năng **WiFi Drive** trong ứng dụng và tải nhạc lên qua trình duyệt trên máy tính của bạn.  
   Hướng dẫn từng bước tại đây:  
   [Cách chuyển tệp nhạc từ máy tính sang iPhone không cần iTunes bằng WiFi-Drive](/docs/howto/how-to-transfer-music-from-computer-to-iphone-without-itunes/) <br>

3. **Không dây bằng Máy chủ DLNA**  <br>
   Bật máy chủ phương tiện DLNA trên máy tính Windows và phát trực tuyến hoặc chuyển thư viện trực tiếp sang ứng dụng.  
   Hướng dẫn:  
...
4. **Không dây bằng Chia sẻ tệp SMB**  <br>
   Bật **chia sẻ tệp SMB** trên PC và kết nối với ứng dụng để duyệt, tải xuống hoặc chuyển tệp theo từng thư mục.  
   Hướng dẫn:  
   [Chuyển tệp từ máy tính sang iPhone bằng giao thức SMB](/docs/howto/transfer-your-files-from-the-computer-to-iphone-using-smb-protocol/) <br>
