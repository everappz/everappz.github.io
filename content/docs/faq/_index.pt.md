...
description: 'Encontre respostas para perguntas comuns sobre Evermusic, Flacbox, Evervideo e Evertag. Explore recursos como streaming em nuvem, gerenciamento de arquivos, opções de reprodução, edição de metadados e muito mais.'
keywords: [
  "Evermusic FAQ", "suporte Flacbox", "ajuda Evervideo", "perguntas Evertag",
  "como usar Evermusic", "solução de problemas do reprodutor de música em nuvem", "guia de reprodução offline",
  "suporte editor de tags de áudio", "problemas de streaming de vídeo", "tutorial de transferência de arquivos"
]
tags: [
  "FAQ", "ajuda", "suporte", "evermusic", "flacbox", "evervideo", "evertag",
...
Procurando respostas ou ajuda para usar um de nossos aplicativos? Você está no lugar certo.

Nossas páginas de FAQ vão ajudá-lo a conectar armazenamento em nuvem, gerenciar arquivos de música e vídeo, configurar reprodução offline, ajustar configurações de equalizador, corrigir metadados e muito mais.

Explore o FAQ do seu aplicativo abaixo para começar, ou navegue pelas perguntas e respostas comuns que recebemos por e-mail dos usuários.
...
{{< card 
  ...
  title="Evervideo" 
  subtitle="Reproduza vídeos 360°, faça streaming do iCloud, assista com legendas, aplique um equalizador de vídeo, organize o conteúdo com listas de reprodução e baixe vídeos para visualização offline."
...
{{< card 
  ...
  title="Evermusic" 
  subtitle="Reprodutor de música em nuvem com modo offline, equalizador de áudio, crossfade, reprodução sem interrupção, gerenciamento de listas de reprodução, biblioteca musical completa e gerenciador de arquivos integrado."
...
{{< card 
  ...
  title="Flacbox" 
  subtitle="Reprodutor de áudio de alta resolução para iPhone e Mac. Ouça formatos sem perdas como FLAC, ALAC, APE e DSD. Ajuste a saída com configurações de áudio avançadas."
...
{{< card 
  ...
  title="Evertag" 
  subtitle="Editor inteligente de tags de música com edição em lote. Corrija metadados ausentes, capas de álbuns e mais. Edite tags ID3, FLAC, APE — mais de 120 campos suportados." 
...
**Configuração WebDAV:**<br>
- **Servidores EUA:** `https://webdav.pcloud.com`  
- **Servidores Europeus:** `https://ewebdav.pcloud.com`  
- **Nome de usuário:** Seu endereço de e-mail do pCloud  
- **Senha:** Sua senha de conta do pCloud  
...
1. Vá para o **canto superior direito** da tela e abra a **Central de Controle** (perto do relógio).  
2. Clique no ícone **Som/Volume**.  
3. Na próxima tela, clique em **AirPlay** para ver uma lista de todos os dispositivos AirPlay disponíveis.  
...
- Certifique-se de ter a versão mais recente do aplicativo instalada em ambos os dispositivos<br>
- Ative o **iCloud** em ambos os dispositivos<br>
- Inicie o aplicativo no seu dispositivo iOS e aguarde 1 minuto para que as informações de compra sejam enviadas<br>
- No seu Mac, instale o aplicativo da App Store usando o mesmo **Apple ID**<br>
- Inicie o aplicativo e aguarde alguns segundos para que as informações sejam sincronizadas<br>
...
- **Backup e restauração** das configurações do aplicativo [Como transferir sua biblioteca de música entre dispositivos no Evermusic: guia passo a passo](/docs/howto/how-to-transfer-your-music-library-between-devices-in-evermusic-step-by-step-guide/)<br>
- **Exportar lista de reprodução para M3U**, depois importar em outro dispositivo:<br>
  - [Como exportar listas de reprodução](/docs/howto/export-tracks-collection-from-evermusic-flacbox-to-m3u-csv-txt/)<br>
...
- As credenciais de login são armazenadas com segurança no **iOS Keychain**<br>
- Coletamos apenas relatórios anônimos de falhas e uso<br>
- Você pode cancelar em **Configurações do aplicativo → Análise**<br><br>

Mais informações:<br>
- [Política de privacidade](/legal/privacy-policy/)<br>
- [Segurança Apple Keychain](https://support.apple.com/guide/security/keychain-data-protection-secb0694df1a/web)<br><br>
...
- **Configurações → Biblioteca de música → Sincronização de música online → Sincronização em segundo plano**<br><br>
...
No entanto, se você se conectou com sucesso a um **WD MyCloud EX2 Ultra**, **WD MyCloud Mirror** ou outro modelo de armazenamento **WD MyCloud**, ainda pode usá-lo com a seguinte solução alternativa:<br><br>

1. Abra **Conexões → Conectar ao armazenamento em nuvem → My Cloud Home**<br>
2. Crie uma pasta usando o gerenciador de arquivos integrado<br>
3. Faça upload de arquivos de música nesta pasta<br>
4. Eles serão armazenados em uma "sandbox" acessível apenas pelo aplicativo<br>
...
**Evermusic**<br>
- iOS (ícone azul): `lsevermusic://`<br>
- macOS: `lsevermusicmac://`<br>
- iOS (ícone vermelho): `lsevermusicpro://`<br><br>
...
- Ative o **SMB1** no servidor e nas configurações do aplicativo<br>
- Use o **seletor de arquivos do sistema**:<br>
  - Vá para **Arquivos locais > Arquivos neste dispositivo > Abrir arquivos...**<br>
...
– **Como gerencio o armazenamento do iCloud?**  <br>
Você tem duas opções:  <br>
1. Use [https://www.icloud.com](https://www.icloud.com) no seu navegador para organizar, fazer upload ou excluir arquivos.<br>  
2. No aplicativo, após se conectar ao iCloud via **Conexões → Conectar ao armazenamento em nuvem → iCloud Drive**, use o gerenciador de arquivos integrado para fazer upload, download, renomear pastas ou excluir arquivos diretamente no seu armazenamento iCloud — sem salvá-los no dispositivo.<br>

⚠️ Tenha cuidado ao excluir arquivos. O aplicativo os exclui permanentemente (eles não vão para a lixeira e não podem ser recuperados).<br>
...
1. **Usando conexão por cabo (recomendado para bibliotecas grandes)**  <br>
   Use o aplicativo **Apple Devices** no Windows 11 para transferir arquivos diretamente para o iPhone via USB.  
   Siga o guia da Apple aqui:  
   https://support.apple.com/en-ph/120402 <br>

2. **Sem fio via Wi-Fi Drive**  <br>
   Ative o recurso **WiFi Drive** no aplicativo e faça upload da sua música por um navegador no computador.  
   Instruções passo a passo aqui:  
   [Como transferir arquivos de música de um computador para iPhone sem iTunes usando WiFi-Drive](/docs/howto/how-to-transfer-music-from-computer-to-iphone-without-itunes/) <br>

3. **Sem fio usando servidor DLNA**  <br>
   Ligue o servidor de mídia DLNA no seu computador Windows e transmita ou transfira sua biblioteca diretamente para o aplicativo.  
   Guia:  
   [Como ativar o servidor de mídia DLNA no Windows 10 e reproduzir música no iPhone](/docs/howto/how-to-enable-dlna-media-server-on-windows-10-and-play-your-music-on-iphone/) <br>

4. **Sem fio usando compartilhamento de arquivos SMB**  <br>
   Ative o **compartilhamento de arquivos SMB** no PC e conecte-se a ele no aplicativo para navegar, baixar ou transferir arquivos pasta por pasta.  
   Instruções:  
   [Transferir arquivos do computador para iPhone usando protocolo SMB](/docs/howto/transfer-your-files-from-the-computer-to-iphone-using-smb-protocol/) <br>
