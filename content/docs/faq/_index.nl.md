...
keywords: [
  "Evermusic FAQ", "Flacbox ondersteuning", "Evervideo hulp", "Evertag vragen",
  "hoe Evermusic te gebruiken", "cloudmuziekspeler probleemoplossing", "gids offline afspelen",
  "ondersteuning audiotag-editor", "videostreamingproblemen", "bestandsoverdracht tutorial"
]
tags: [
  "FAQ", "hulp", "ondersteuning", "evermusic", "flacbox", "evervideo", "evertag",
...
Op zoek naar antwoorden of hulp bij het gebruik van een van onze apps? U bent op de juiste plek.

Onze FAQ-pagina's helpen u cloudopslag te verbinden, muziek- en videobestanden te beheren, offline afspelen in te stellen, equalizerinstellingen aan te passen, metadata te corrigeren en meer.

Verken de FAQ voor uw app hieronder om aan de slag te gaan, of blader door veelgestelde vragen en antwoorden die we via gebruikersmails hebben ontvangen.
...
**WebDAV-instelling:**<br>
- **Amerikaanse servers:** `https://webdav.pcloud.com`  
- **Europese servers:** `https://ewebdav.pcloud.com`  
- **Gebruikersnaam:** Uw pCloud-e-mailadres  
- **Wachtwoord:** Uw pCloud-accountwachtwoord  
...
1. Ga naar de **rechterbovenhoek** van uw scherm en open het **Controlecentrum** (naast de klok).  
2. Klik op het pictogram **Geluid/Volume**.  
3. Klik in het volgende scherm op **AirPlay** om een lijst van alle beschikbare AirPlay-apparaten te zien.  
...
- Zorg ervoor dat u de nieuwste app-versie op beide apparaten hebt geïnstalleerd<br>
- Schakel **iCloud** in op beide apparaten<br>
- Start de app op uw iOS-apparaat en wacht 1 minuut totdat de aankoopinformatie is geüpload<br>
- Installeer de app op uw Mac vanuit de App Store met hetzelfde **Apple ID**<br>
- Start de app en wacht een paar seconden totdat de informatie is gesynchroniseerd<br>
...
- **Back-up en herstel** via app-instellingen [Hoe u uw muziekbibliotheek overdraagt tussen apparaten in Evermusic: stapsgewijze handleiding](/docs/howto/how-to-transfer-your-music-library-between-devices-in-evermusic-step-by-step-guide/)<br>
- **Exporteer afspeellijst naar M3U**, importeer vervolgens op een ander apparaat:<br>
  - [Afspeellijsten exporteren](/docs/howto/export-tracks-collection-from-evermusic-flacbox-to-m3u-csv-txt/)<br>
...
- Inloggegevens worden veilig opgeslagen in **iOS Keychain**<br>
- We verzamelen alleen anonieme crash- en gebruiksrapporten<br>
- U kunt zich afmelden via **App-instellingen → Analyses**<br><br>

Meer info:<br>
- [Privacybeleid](/legal/privacy-policy/)<br>
- [Apple Keychain-beveiliging](https://support.apple.com/guide/security/keychain-data-protection-secb0694df1a/web)<br><br>
...
- **Instellingen → Muziekbibliotheek → Online muziek synchroniseren → Achtergrond synchroniseren**<br><br>
...
Als u echter succesvol verbinding hebt gemaakt met een **WD MyCloud EX2 Ultra**, **WD MyCloud Mirror** of een ander **WD MyCloud**-opslagmodel, kunt u het nog steeds gebruiken met de volgende tijdelijke oplossing:<br><br>

1. Open **Verbindingen → Verbinden met cloudopslag → My Cloud Home**<br>
2. Maak een map aan met de ingebouwde bestandsbeheerder<br>
3. Upload muziekbestanden naar deze map<br>
4. Deze worden opgeslagen in een "sandbox" die alleen toegankelijk is voor de app<br>
...
**Evermusic**<br>
- iOS (blauw pictogram): `lsevermusic://`<br>
- macOS: `lsevermusicmac://`<br>
- iOS (rood pictogram): `lsevermusicpro://`<br><br>
...
- Schakel **SMB1** in op uw server en in app-instellingen<br>
- Gebruik de **systeembestandskiezer**:<br>
  - Ga naar **Lokale bestanden > Bestanden op dit apparaat > Bestanden openen...**<br>
...
– **Hoe beheer ik iCloud-opslag?**  <br>
U heeft twee opties:  <br>
1. Gebruik [https://www.icloud.com](https://www.icloud.com) in uw browser om bestanden te organiseren, uploaden of verwijderen.<br>  
2. In de app, na verbinding met iCloud via **Verbindingen → Verbinden met cloudopslag → iCloud Drive**, gebruik de ingebouwde bestandsbeheerder om bestanden te uploaden, downloaden, mappen te hernoemen of bestanden rechtstreeks in uw iCloud-opslag te verwijderen — zonder ze op uw apparaat op te slaan.<br>

⚠️ Wees voorzichtig bij het verwijderen van bestanden. De app verwijdert ze permanent (ze gaan niet naar de prullenbak en kunnen niet worden hersteld).<br>
...
1. **Een kabelverbinding gebruiken (aanbevolen voor grote bibliotheken)**  <br>
   Gebruik de app **Apple Devices** op Windows 11 om bestanden rechtstreeks via USB naar uw iPhone over te dragen.  
   Volg de gids van Apple hier:  
   https://support.apple.com/en-ph/120402 <br>

2. **Draadloos via Wi-Fi Drive**  <br>
   Schakel de **WiFi Drive**-functie in de app in en upload uw muziek via een browser op uw computer.  
   Stapsgewijze instructies hier:  
   [Muziekbestanden overbrengen van een computer naar iPhone zonder iTunes via WiFi-Drive](/docs/howto/how-to-transfer-music-from-computer-to-iphone-without-itunes/) <br>

3. **Draadloos via DLNA-server**  <br>
   Zet de DLNA-mediaserver op uw Windows-computer aan en stream of breng uw bibliotheek rechtstreeks over naar de app.  
   Gids:  
   [DLNA-mediaserver inschakelen op Windows 10 en muziek afspelen op iPhone](/docs/howto/how-to-enable-dlna-media-server-on-windows-10-and-play-your-music-on-iphone/) <br>

4. **Draadloos via SMB-bestandsdeling**  <br>
   Schakel **SMB-bestandsdeling** op uw pc in en maak verbinding in de app om uw bestanden per map te bladeren, downloaden of overbrengen.  
   Instructies:  
   [Bestanden overbrengen van computer naar iPhone via SMB-protocol](/docs/howto/transfer-your-files-from-the-computer-to-iphone-using-smb-protocol/) <br>
