...
description: 'Trova risposte alle domande più comuni su Evermusic, Flacbox, Evervideo ed Evertag. Esplora funzionalità come streaming cloud, gestione file, opzioni di riproduzione, modifica dei metadati e altro ancora.'
keywords: [
  "FAQ Evermusic", "supporto Flacbox", "aiuto Evervideo", "domande Evertag",
  "come usare Evermusic", "risoluzione problemi lettore musicale cloud", "guida riproduzione offline",
  "supporto editor tag audio", "problemi streaming video", "tutorial trasferimento file"
]
tags: [
  "FAQ", "aiuto", "supporto", "evermusic", "flacbox", "evervideo", "evertag",
...
Cerchi risposte o aiuto per usare una delle nostre app? Sei nel posto giusto.

Le nostre pagine FAQ ti aiuteranno a connettere l'archiviazione cloud, gestire i file musicali e video, configurare la riproduzione offline, regolare le impostazioni dell'equalizzatore, correggere i metadati e molto altro.

Esplora le FAQ della tua app qui sotto per iniziare, o sfoglia le domande e risposte frequenti che abbiamo ricevuto dalle email degli utenti.
...
{{< card 
  ...
  title="Evervideo" 
  subtitle="Riproduci video a 360°, esegui lo streaming da iCloud, guarda con i sottotitoli, applica un equalizzatore video, organizza i contenuti con playlist e scarica video per la visione offline."
...
{{< card 
  ...
  title="Evermusic" 
  subtitle="Lettore musicale cloud con modalità offline, equalizzatore audio, crossfade, riproduzione gapless, gestione playlist, libreria musicale completa e gestore file integrato."
...
{{< card 
  ...
  title="Flacbox" 
  subtitle="Lettore audio ad alta risoluzione per iPhone e Mac. Ascolta formati lossless come FLAC, ALAC, APE e DSD. Ottimizza l'output con impostazioni audio avanzate."
...
{{< card 
  ...
  title="Evertag" 
  subtitle="Editor di tag musicali intelligente con modifica in batch. Correggi metadati mancanti, copertine degli album e altro. Modifica tag ID3, FLAC, APE — oltre 120 campi supportati." 
...
**Configurazione WebDAV:**<br>
- **Server USA:** `https://webdav.pcloud.com`  
- **Server Europei:** `https://ewebdav.pcloud.com`  
- **Nome utente:** Il tuo indirizzo email pCloud  
- **Password:** La tua password dell'account pCloud  
...
1. Vai nell'**angolo in alto a destra** dello schermo e apri il **Centro di controllo** (vicino all'orologio).  
2. Clicca sull'icona **Audio/Volume**.  
3. Nella schermata successiva, clicca su **AirPlay** per visualizzare l'elenco di tutti i dispositivi AirPlay disponibili.  
...
- Assicurati di avere l'ultima versione dell'app installata su entrambi i dispositivi<br>
- Abilita **iCloud** su entrambi i dispositivi<br>
- Avvia l'app sul tuo dispositivo iOS e attendi 1 minuto per il caricamento delle informazioni sull'acquisto<br>
- Sul tuo Mac, installa l'app dall'App Store usando lo **stesso Apple ID**<br>
- Avvia l'app e attendi alcuni secondi per la sincronizzazione delle informazioni<br>
...
- **Backup e ripristino** dalle Impostazioni app [Come trasferire la libreria musicale tra dispositivi in Evermusic: Guida passo dopo passo](/docs/howto/how-to-transfer-your-music-library-between-devices-in-evermusic-step-by-step-guide/)<br>
- **Esporta playlist in M3U**, poi importa su un altro dispositivo:<br>
  - [Come esportare playlist](/docs/howto/export-tracks-collection-from-evermusic-flacbox-to-m3u-csv-txt/)<br>
...
- Le credenziali di accesso sono archiviate in modo sicuro nel **iOS Keychain**<br>
- Raccogliamo solo rapporti di crash e utilizzo anonimi<br>
- Puoi disattivarli in **Impostazioni app → Analisi**<br><br>

Ulteriori informazioni:<br>
- [Informativa sulla privacy](/legal/privacy-policy/)<br>
- [Sicurezza Apple Keychain](https://support.apple.com/guide/security/keychain-data-protection-secb0694df1a/web)<br><br>
...
- **Impostazioni → Libreria musicale → Sincronizzazione musica online → Sincronizzazione in background**<br><br>
...
Tuttavia, se ti sei connesso con successo a un **WD MyCloud EX2 Ultra**, **WD MyCloud Mirror**, o un altro modello di storage **WD MyCloud**, puoi comunque usarlo con la seguente soluzione alternativa:<br><br>

1. Apri **Connessioni → Connetti a Cloud Storage → My Cloud Home**<br>
2. Crea una cartella usando il gestore file integrato<br>
3. Carica file musicali in questa cartella<br>
4. Verranno archiviati in una "sandbox" accessibile solo dall'app<br>
...
**Evermusic**<br>
- iOS (icona blu): `lsevermusic://`<br>
- macOS: `lsevermusicmac://`<br>
- iOS (icona rossa): `lsevermusicpro://`<br><br>
...
- Abilita **SMB1** sul server e nelle impostazioni dell'app<br>
- Usa il **selettore file di sistema**:<br>
  - Vai in **File locali > File su questo dispositivo > Apri file...**<br>
...
– **Come gestisco lo storage iCloud?**  <br>
Hai due opzioni:  <br>
1. Usa [https://www.icloud.com](https://www.icloud.com) nel tuo browser per organizzare, caricare o eliminare file.<br>  
2. Nell'app, dopo esserti connesso a iCloud tramite **Connessioni → Connetti a Cloud Storage → iCloud Drive**, usa il gestore file integrato per caricare, scaricare, rinominare cartelle o eliminare file direttamente nel tuo storage iCloud — senza salvarli sul tuo dispositivo.<br>

⚠️ Fai attenzione quando elimini i file. L'app li elimina definitivamente (non andranno nel cestino e non potranno essere recuperati).<br>
...
1. **Usando una connessione via cavo (consigliato per librerie di grandi dimensioni)**  <br>
   Usa l'app **Apple Devices** su Windows 11 per trasferire file direttamente all'iPhone tramite USB.  
   Segui la guida Apple qui:  
   https://support.apple.com/en-ph/120402 <br>

2. **Senza fili tramite Wi-Fi Drive**  <br>
   Abilita la funzione **WiFi Drive** nell'app e carica la tua musica tramite un browser sul tuo computer.  
   Istruzioni passo dopo passo qui:  
   [Come trasferire file musicali dal computer all'iPhone senza iTunes usando WiFi-Drive](/docs/howto/how-to-transfer-music-from-computer-to-iphone-without-itunes/) <br>

3. **Senza fili usando il server DLNA**  <br>
   Attiva il server multimediale DLNA sul tuo computer Windows e fai streaming o trasferisci la tua libreria direttamente nell'app.  
   Guida:  
...
4. **Senza fili usando la condivisione file SMB**  <br>
   Abilita la **condivisione file SMB** sul tuo PC e connettiti nell'app per sfogliare, scaricare o trasferire i tuoi file cartella per cartella.  
   Istruzioni:  
   [Trasferisci file dal computer all'iPhone usando il protocollo SMB](/docs/howto/transfer-your-files-from-the-computer-to-iphone-using-smb-protocol/) <br>
