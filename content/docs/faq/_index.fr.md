...
keywords: [
  "FAQ Evermusic", "support Flacbox", "aide Evervideo", "questions Evertag",
  "comment utiliser Evermusic", "dépannage lecteur de musique cloud", "guide lecture hors ligne",
  "support éditeur de tags audio", "problèmes de streaming vidéo", "tutoriel de transfert de fichiers"
]
tags: [
  "FAQ", "aide", "support", "evermusic", "flacbox", "evervideo", "evertag",
...
Vous cherchez des réponses ou de l'aide pour utiliser l'une de nos applications ? Vous êtes au bon endroit.

Nos pages FAQ vous aideront à connecter le stockage cloud, gérer vos fichiers musicaux et vidéo, configurer la lecture hors ligne, ajuster les paramètres de l'égaliseur, corriger les métadonnées et bien plus encore.

Explorez la FAQ de votre application ci-dessous pour commencer, ou parcourez les questions et réponses courantes que nous avons reçues par e-mail des utilisateurs.
...
**Configuration WebDAV :**<br>
- **Serveurs américains :** `https://webdav.pcloud.com`  
- **Serveurs européens :** `https://ewebdav.pcloud.com`  
- **Nom d'utilisateur :** Votre adresse e-mail pCloud  
- **Mot de passe :** Votre mot de passe de compte pCloud  
...
1. Allez dans le **coin supérieur droit** de votre écran et ouvrez le **Centre de contrôle** (près de l'horloge).  
2. Cliquez sur l'icône **Son/Volume**.  
3. Sur l'écran suivant, cliquez sur **AirPlay** pour afficher la liste de tous les appareils AirPlay disponibles.  
...
- Assurez-vous d'avoir la dernière version de l'application installée sur les deux appareils<br>
- Activez **iCloud** sur les deux appareils<br>
- Lancez l'application sur votre appareil iOS et attendez 1 minute pour que les informations d'achat soient téléchargées<br>
- Sur votre Mac, installez l'application depuis l'App Store en utilisant le **même identifiant Apple**<br>
- Lancez l'application et attendez quelques secondes pour la synchronisation des informations<br>
...
- **Sauvegarde et restauration** depuis les paramètres de l'application [Comment transférer votre bibliothèque musicale entre appareils dans Evermusic : guide étape par étape](/docs/howto/how-to-transfer-your-music-library-between-devices-in-evermusic-step-by-step-guide/)<br>
- **Exporter la liste de lecture en M3U** puis l'importer sur un autre appareil :<br>
  - [Comment exporter des listes de lecture](/docs/howto/export-tracks-collection-from-evermusic-flacbox-to-m3u-csv-txt/)<br>
...
- Les identifiants de connexion sont stockés en toute sécurité dans le **iOS Keychain**<br>
- Nous collectons uniquement des rapports d'erreurs et d'utilisation anonymes<br>
- Vous pouvez vous désinscrire dans **Paramètres de l'application → Analyses**<br><br>

Plus d'informations :<br>
- [Politique de confidentialité](/legal/privacy-policy/)<br>
- [Sécurité Apple Keychain](https://support.apple.com/guide/security/keychain-data-protection-secb0694df1a/web)<br><br>
...
- **Paramètres → Bibliothèque musicale → Synchronisation de musique en ligne → Synchronisation en arrière-plan**<br><br>
...
Cependant, si vous vous êtes connecté avec succès à un **WD MyCloud EX2 Ultra**, **WD MyCloud Mirror** ou un autre modèle de stockage **WD MyCloud**, vous pouvez toujours l'utiliser avec la solution de contournement suivante :<br><br>

1. Ouvrez **Connexions → Se connecter au stockage cloud → My Cloud Home**<br>
2. Créez un dossier en utilisant le gestionnaire de fichiers intégré<br>
3. Téléchargez des fichiers musicaux dans ce dossier<br>
4. Ils seront stockés dans un « bac à sable » accessible uniquement par l'application<br>
...
**Evermusic**<br>
- iOS (icône bleue) : `lsevermusic://`<br>
- macOS : `lsevermusicmac://`<br>
- iOS (icône rouge) : `lsevermusicpro://`<br><br>
...
- Activez **SMB1** sur votre serveur et dans les paramètres de l'application<br>
- Utilisez le **sélecteur de fichiers système** :<br>
  - Allez dans **Fichiers locaux > Fichiers sur cet appareil > Ouvrir des fichiers...**<br>
...
– **Comment gérer le stockage iCloud ?**  <br>
Vous avez deux options :  <br>
1. Utilisez [https://www.icloud.com](https://www.icloud.com) dans votre navigateur pour organiser, télécharger ou supprimer des fichiers.<br>  
2. Dans l'application, après connexion à iCloud via **Connexions → Se connecter au stockage cloud → iCloud Drive**, utilisez le gestionnaire de fichiers intégré pour télécharger, télécharger, renommer des dossiers ou supprimer des fichiers directement dans votre stockage iCloud — sans les enregistrer sur votre appareil.<br>

⚠️ Soyez prudent lors de la suppression de fichiers. L'application les supprime définitivement (ils n'iront pas dans la corbeille et ne pourront pas être récupérés).<br>
...
1. **Via une connexion par câble (recommandé pour les grandes bibliothèques)**  <br>
   Utilisez l'application **Apple Devices** sur Windows 11 pour transférer des fichiers directement vers votre iPhone via USB.  
   Suivez le guide Apple ici :  
   https://support.apple.com/en-ph/120402 <br>

2. **Sans fil via Wi-Fi Drive**  <br>
   Activez la fonctionnalité **WiFi Drive** dans l'application et téléchargez votre musique via un navigateur sur votre ordinateur.  
   Instructions étape par étape ici :  
   [Comment transférer des fichiers musicaux d'un ordinateur vers iPhone sans iTunes avec WiFi-Drive](/docs/howto/how-to-transfer-music-from-computer-to-iphone-without-itunes/) <br>

3. **Sans fil avec un serveur DLNA**  <br>
   Activez le serveur multimédia DLNA sur votre ordinateur Windows et diffusez ou transférez votre bibliothèque directement dans l'application.  
   Guide :  
   [Comment activer le serveur multimédia DLNA sur Windows 10 et écouter de la musique sur iPhone](/docs/howto/how-to-enable-dlna-media-server-on-windows-10-and-play-your-music-on-iphone/) <br>

4. **Sans fil avec le partage de fichiers SMB**  <br>
   Activez le **partage de fichiers SMB** sur votre PC et connectez-vous à celui-ci dans l'application pour parcourir, télécharger ou transférer vos fichiers dossier par dossier.  
   Instructions :  
   [Transférer des fichiers d'un ordinateur vers iPhone avec le protocole SMB](/docs/howto/transfer-your-files-from-the-computer-to-iphone-using-smb-protocol/) <br>
