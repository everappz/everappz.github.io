...
{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/icloud_main.webp" alt="iCloud Drive main screen" width="800" >}}
...
{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/icloud_logged_in.webp" alt="Logged into iCloud Drive interface" width="800" >}}

Look for the **iCloud Drive** icon and click on it to open your iCloud Drive contents.

{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/icloud_drive_bubble.webp" alt="iCloud Drive shortcut bubble" width="800" >}}

You’ll see a list of all files and folders currently stored in your iCloud Drive.

{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/icloud_drive_folders_list.webp" alt="List of folders in iCloud Drive" width="800" >}}
...
{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/icloud_drive_enter_folder_name.webp" alt="Entering a folder name in iCloud Drive" width="800" >}}

Click on the new folder to open it. You’ll see that it’s currently empty.

{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/icloud_drive_opened_empty_folder.webp" alt="Opened empty folder in iCloud Drive" width="800" >}}
...
{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/icloud_selected_local_files.webp" alt="Selected local files ready to upload to iCloud" width="800" >}}

Wait for the upload to complete. The progress will be shown directly in the browser interface.

{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/icloud_files_uploading_2.webp" alt="Multiple files uploading to iCloud Drive" width="800" >}}

Once the files are uploaded, you can use the same web interface to rename, move, or delete files within your iCloud Drive.

{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/icloud_folder_rename.webp" alt="Renaming a folder in iCloud Drive" width="800" >}}
...
{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_6120fb02234c4997a90734215cc4034a~mv2.webp" alt="connect a cloud service" width="400" >}}

1. Choose "iCloud Drive" from the options.

{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_a83af8de2e1a4c6dadf172a385f5353c~mv2.webp" alt="select icloud drive from options menu" width="400" >}}
...
{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_7f5d9769507943fb9956c22c76bed3d2~mv2.webp" alt="select icloud drive folder" width="400" >}}

5. Select a folder in your iCloud Drive containing audio files. Tap "Open" to confirm your selection.

{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_e10a080568aa407d8e8fedde37234f7b~mv2.webp" alt="select files in icloud drive folder" width="400"  >}}

6. Once you've selected the folder, it will appear in the "Cloud Services" section.

{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_805d747135ae492e890257e80f7dedd6~mv2.webp" alt="connected icloud drive folder in the connections screen" width="400"  >}}
...
{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_27090f1c30ff4c688d799dd4916e9ff8~mv2.webp" alt="list of files in connected icloud drive folder" width="400"  >}}
...
{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_fb300231b3dd4e938bdc96b27c399374~mv2.webp" alt="audio player screen" width="400"  >}}
...
{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_6b0602b3bed2440986c0945585a5fbff~mv2.webp" alt="all connections menu item on mac screen" width="600"  >}}

3. Choose "iCloud Drive" from the list of options.

{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_c003880182ec456bbb0403b0fb996a9e~mv2.webp" alt="choose icloud drive from options menu" width="600"  >}}

4. A system "File Choose Dialog" will appear.

{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_0f7187489a194f8bb97f5554864a62cb~mv2.webp" alt="system file picker dialog" width="600"  >}}

5. Tap on the folder chooser located at the top of the dialog and switch to "iCloud Drive".

{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_2a750f91b74b47cc992e54c09315d424~mv2.webp" alt="choose icloud drive from menu" width="600"  >}}

6. Select your folder within iCloud Drive and tap "Open" to confirm your selection.

{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_4beca011a0dc4e47b9e7f51dc26baf5a~mv2.webp" alt="choose files in icloud drive folder" width="600"  >}}

7. The selected folder will now appear in the "All Connections" screen under the "Cloud Services" section.

{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_9e9a6e47129f4acd8c545bc5935dfe1c~mv2.webp" alt="all connections screen with connected icloud drive folder" width="600"  >}}

8. Tap on the added folder to open it. Tap audio file to start playback.

{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_fd3f7b232d6042808cc01293e49fb104~mv2.webp" alt="icloud drive folder content" width="600"  >}}

9. Tap "Audio player" on the left side bar to open full screen audio player.

{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_0e45427ecccd4ba79b290f78bbdc3fd6~mv2.webp" alt="full screen audio player on mac" width="600"  >}}
...
3. Select the "+ Add music" menu item to open the file chooser.
   ...
   {{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_db6d9e219ee1493983d59ad60c91fb92~mv2.webp" alt="add music to library" caption="Add music to library" width="600" >}}

4. On the next screen tap "Connections" and select connected iCloud Drive folder.

   {{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_a2e104591b1c4ef7b8e54c4ac6df2cdb~mv2.webp" alt="choose music location" caption="Choose music location" width="600" >}}
...
5. On the next screen select files you want to add to your music library. You can also select a folder and in this case, the application will scan selected folders and all found files will be added to the music library.
   ...
   {{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_84aa1e97dc7e4361bdb2319a4544be39~mv2.webp" alt="folders chooser" caption="Folders chooser" width="600" >}}
...
4. Tap the "Connections" menu item and select the connected iCloud Drive folder.
   ...
   {{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_10c3cee5586c4f8e9bdc17de5779e7c4~mv2.webp" alt="add songs to a playlist" caption="Add songs to a playlist" width="600" >}}

5. On the next screen select files you want to add to a playlist and tap "Done" button to confirm selection.

   {{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_361124a4c5d04b3e9077ad498900b645~mv2.webp" alt="select songs for a playlist" caption="Select songs for a playlist" width="600" >}}

6. Tap the three dots button in the top right corner to see all available actions for the created playlist.

   {{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_1506ad638e4347da8f93a0d411165f7a~mv2.webp" alt="playlist with added icloud drive songs" caption="Playlist with added iCloud Drive songs" width="600" >}}
...
{{< figure src="/docs/howto/how-to-listen-to-music-from-icloud-drive-on-your-iphone-or-mac/21260c_f82e4ae8f9a84825ba3a80df528a50fc~mv2.webp" alt="audio player cache enable in settings" caption="Enable audio player cache in settings" width="600" >}}
