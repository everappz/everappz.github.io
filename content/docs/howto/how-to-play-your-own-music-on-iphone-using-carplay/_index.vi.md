---
title: "Cách phát nhạc của riêng bạn trên iPhone bằng CarPlay"
date: 2025-07-16
description: "Tìm hiểu cách phát nhạc cục bộ hoặc ngoại tuyến của riêng bạn trên iPhone bằng Apple CarPlay. Hướng dẫn từng bước với mẹo sử dụng các ứng dụng như Evermusic và Flacbox."
...
Đầu tiên, bạn cần thêm tệp vào ứng dụng. Có nhiều cách để thực hiện:

### Kết nối với bộ nhớ đám mây

- Mở tab **Kết nối**
- Chọn "Kết nối với bộ nhớ đám mây" từ menu
- Chọn dịch vụ bộ nhớ đám mây từ danh sách
- Nhập thông tin đăng nhập của bạn và nhấn **Hoàn tất**

Nếu bạn gặp bất kỳ vấn đề nào, hãy kiểm tra kết nối internet và tên đăng nhập/mật khẩu.
Trong phiên bản Premium của ứng dụng, bạn có thể thêm không giới hạn số lượng dịch vụ.

### Các dịch vụ bộ nhớ đám mây được hỗ trợ

Hiện tại, ứng dụng hỗ trợ các dịch vụ bộ nhớ đám mây phổ biến nhất: iCloud Drive, Dropbox, OneDrive, Google Drive, MEGA, Synology Drive, SMB, WebDAV, DLNA, Yandex.Disk, Box, 阿里云盘, 百度网盘, pCloud, WD My Cloud Home, InfiniCLOUD, MediaFire, OpenDrive, HiDrive, Cloud Mail.ru, Put.io, MyDrive. Danh sách này có thể khác nhau giữa phiên bản miễn phí và premium của ứng dụng, và cũng giữa các ứng dụng khác nhau.

### Tải tệp từ bộ nhớ đám mây

Bạn có thể thêm tệp âm thanh vào ứng dụng bằng cách tải chúng từ các dịch vụ bộ nhớ đám mây đã kết nối như mô tả [tại đây](/docs/howto/how-to-upload-my-files-to-the-cloud-storage-and-connect-them-to-evermusic-flacbox-evertag).

### Chế độ ngoại tuyến

Bạn có thể tự động đồng bộ tệp để phát ngoại tuyến như mô tả [tại đây](/docs/howto/play-offline-music-in-evermusic-flacbox-download-sync-from-cloud-to-local-files/).

### Nhập tệp từ thiết bị của bạn

Dễ dàng nhập tệp từ thiết bị của bạn như mô tả [tại đây](/docs/howto/how-to-play-local-music-stored-on-your-iphone-or-mac) hoặc từ ổ USB đã kết nối như mô tả [tại đây](/docs/howto/how-to-connect-a-usb-flashcard-to-the-iphone-and-listen-to-music-or-manage-files-located-on-it).

### Chia sẻ tệp iTunes

Chuyển tệp bằng kết nối cáp như mô tả [tại đây](/docs/howto/how-to-transfer-files-from-my-mac-to-iphone-or-ipad-using-finder).

### Wi-Fi Drive

Chuyển tệp không dây như mô tả [tại đây](/docs/howto/how-to-transfer-files-wirelessly-from-a-computer-to-an-iphone-using-wifi-drive).

## Bật CarPlay trên iPhone

### Yêu cầu
- iPhone chạy iOS 13.0 trở lên
- Xe hơi hỗ trợ **Apple CarPlay** (USB hoặc không dây)
- **Siri** phải được bật trên iPhone của bạn

### Thiết lập CarPlay qua USB

1. Khởi động xe và đảm bảo **Siri** đã được bật trên iPhone.
2. Kết nối iPhone với xe bằng cáp **Lightning sang USB**.
3. Khi được nhắc trên iPhone, nhấn **Cho phép** để bật CarPlay.
4. CarPlay sẽ tự động khởi chạy trên màn hình giải trí của xe.

### Thiết lập CarPlay không dây

1. Khởi động xe và đảm bảo **Bluetooth** và **Wi-Fi** đã được bật.
2. Trên iPhone, đi tới:
   - **Cài đặt > Chung chung > CarPlay**
3. Chọn xe của bạn từ danh sách các phương tiện có sẵn.
4. Làm theo hướng dẫn hiển thị trên màn hình xe để hoàn tất ghép nối.

### Tùy chọn: Tùy chỉnh bố cục CarPlay

- Đi tới **Cài đặt > Chung chung > CarPlay**
- Chọn xe của bạn từ danh sách
- Nhấn **Tùy chỉnh** để sắp xếp lại hoặc ẩn ứng dụng

### Mẹo khắc phục sự cố

- Đảm bảo xe đang ở **chế độ ghép nối** (tham khảo hướng dẫn sử dụng xe)
- Khởi động lại iPhone và hệ thống xe nếu kết nối thất bại
- Đảm bảo phần mềm xe được cập nhật

## Giao diện ứng dụng trong chế độ CarPlay
...
Tab **Thư viện** trong Evermusic là trung tâm nơi tất cả nhạc của bạn được sắp xếp. Khi bạn đã thêm bài hát vào thư viện — dù từ bộ nhớ đám mây, tệp cục bộ hay iTunes — ứng dụng tự động đọc siêu dữ liệu và nhóm chúng gọn gàng vào các danh mục như **Album**, **Nghệ sĩ**, **Thể loại** và nhiều hơn nữa.
...
- **Tiếp tục phát** – Tiếp tục danh sách phát hoặc hàng đợi bài hát cuối cùng
- **Yêu thích** – Các bài hát bạn đã đánh dấu sao
- **Gần đây** – Các bài hát bạn phát gần đây
- **Bài hát chưa phát** – Các bài hát bạn đã thêm nhưng chưa phát
- **Đánh dấu trang** – Vị trí đã lưu trong các tệp âm thanh dài
- **Danh sách phát** – Các bộ sưu tập tùy chỉnh và tự động tạo
- **Bài hát** – Tất cả bài hát được nhóm theo tiêu đề
- **Album** – Nhóm theo tên album
- **Nghệ sĩ album** – Nhóm theo siêu dữ liệu nghệ sĩ album
- **Nghệ sĩ** – Nhóm theo thẻ nghệ sĩ
- **Thể loại** – Dựa trên thông tin thể loại được nhúng
- **Nhạc sĩ sáng tác** – Sắp xếp theo siêu dữ liệu nhạc sĩ
- **Tệp trong ứng dụng này** – Tệp ngoại tuyến được lưu trong ứng dụng
- **Tệp trên iPhone này** – Các bài hát được nhập thủ công từ ứng dụng Tệp
- **Nhạc iTunes** – Nhạc từ thư viện iPod (không bao gồm Apple Music)
...
Màn hình **Kết nối** bao gồm các phần sau:

- **Tệp yêu thích** – Truy cập nhanh các thư mục hoặc tệp bạn đã đánh dấu yêu thích để điều hướng nhanh, đặc biệt hữu ích trong CarPlay.
- **Tệp mở gần đây** – Xem các tệp gần đây nhất bạn đã truy cập từ dịch vụ đã kết nối.
- **Bộ nhớ đám mây** – Quản lý tất cả dịch vụ đám mây và ổ đĩa mạng cục bộ đã kết nối.

Bạn có thể kết nối dịch vụ đám mây mới bằng tùy chọn **"Kết nối với bộ nhớ đám mây"** trên màn hình Kết nối chính. Khi đã kết nối, bạn có thể điều hướng vào thư mục, duyệt thư viện nhạc và thậm chí phát trực tuyến hoặc tải xuống bài hát. Nếu thư mục nằm sâu, bạn có thể **đánh dấu là yêu thích** để dễ truy cập sau — đặc biệt hữu ích cho người dùng CarPlay muốn điều hướng nhanh.

Bạn cũng có thể sử dụng **Wi-Fi Drive** hoặc **Chia sẻ tệp iTunes** để nhập nhạc từ máy tính không dây hoặc qua USB. Hỗ trợ kết nối với thiết bị NAS, ổ đĩa ngoài và mạng cục bộ giúp bạn kiểm soát hoàn toàn cách lưu trữ và truy cập nhạc.

Để tìm hiểu thêm về tất cả các cách kết nối và quản lý thư viện đám mây và mạng, hãy đọc [Hướng dẫn Kết nối](/docs/guide/evermusic/evermusic-guide-connections/) đầy đủ.
...
- **Tệp yêu thích** – Lối tắt đến các thư mục hoặc tệp bạn đã đánh dấu yêu thích. Đặc biệt hữu ích cho CarPlay hoặc truy cập nhanh.
- **Tệp mở gần đây** – Các bài hát và thư mục bạn đã mở gần đây từ bộ nhớ cục bộ.
- **Tài liệu** – Hiển thị tất cả tệp và thư mục trong thư mục Tài liệu nội bộ của ứng dụng. Bao gồm các mục được thêm qua tải xuống từ đám mây, Wi-Fi Drive, Chia sẻ tệp iTunes hoặc chuyển USB.
- **Thư mục ngoại tuyến** – Hiển thị tất cả thư mục bạn đã đánh dấu để sử dụng ngoại tuyến (ví dụ: thư mục đám mây, album, danh sách phát hoặc bộ sưu tập nghệ sĩ đã tải để phát ngoại tuyến).
- **iCloud** – Hiển thị nội dung được đồng bộ qua iCloud Drive, đảm bảo truy cập trên tất cả thiết bị.
- **Thư mục thiết bị** – Thư mục nằm bên ngoài ứng dụng trên iPhone/iPad. Được thêm thủ công qua trình chọn tệp hệ thống hoặc kết nối thư mục.
...
- **Phát tất cả** – Thêm tất cả tệp âm thanh trong thư mục hiện tại (và thư mục con) vào hàng đợi trình phát.
- **Trộn tất cả** – Thêm các tệp tương tự theo thứ tự ngẫu nhiên.
- **Tiếp tục phát** – Tiếp tục phát từ vị trí đã lưu cuối cùng nếu được bật trong cài đặt ứng dụng.
...
Điều này xảy ra do giới hạn của hệ thống CarPlay, hạn chế số cấp thư mục có thể hiển thị.

**Cách khắc phục**

Để tránh vấn đề này và truy cập nhạc nhanh hơn:

- **Thêm thư mục lồng nhau sâu vào Yêu thích**
  Điều này giúp chúng dễ dàng truy cập trực tiếp từ menu **Yêu thích** trong CarPlay.

- **Đơn giản hóa cấu trúc thư mục**
  Nếu có thể, hãy thử làm phẳng cấu trúc thư mục để điều hướng CarPlay mượt mà hơn.

Giải pháp này đảm bảo trải nghiệm liền mạch khi duyệt nhạc trong xe.
...
Để xem và điều khiển phát, chỉ cần nhấn vào biểu tượng **Đang phát** ở góc trên bên phải của màn hình CarPlay.

Màn hình **Đang phát** bao gồm:

- Điều khiển phát đầy đủ (phát, tạm dừng, tiếp theo, trước đó)
- Tiêu đề bài hát, nghệ sĩ và ảnh bìa album
- Các chế độ phát như **Lặp lại**, **Trộn** và điều chỉnh **Tốc độ phát**

Màn hình này cho phép bạn kiểm soát trải nghiệm nghe khi lái xe — an toàn và hiệu quả.
...
- **Làm mới màn hình** – Tải lại giao diện CarPlay thủ công và cập nhật tất cả các thành phần nội dung.
- **Chung chung** – Cấu hình cài đặt phát âm thanh thiết yếu:
  - Chế độ lặp lại
  - Chế độ trộn
  - Chế độ đầu ra âm thanh
  - Lưu vị trí phát
  - Lưu trạng thái trình phát âm thanh
...
- **Hiển thị hình ảnh** – Bật/tắt ảnh bìa album và biểu tượng. Tắt hình ảnh có thể cải thiện hiệu suất CarPlay.
- **Tạm dừng phát khi kết nối** – Tự động tạm dừng âm thanh khi CarPlay kết nối để tránh phát âm lượng lớn đột ngột.
- **Tải tệp** – Chỉ định loại mạng (chỉ Wi-Fi hoặc Wi-Fi + Di động) được sử dụng khi tải tệp đám mây.
...
Các cài đặt này cũng có sẵn trên giao diện di động trong **Cài đặt → CarPlay**, nơi bạn có thể tinh chỉnh phát và hành vi giao diện trước khi kết nối iPhone với xe.

Để tìm hiểu thêm, hãy đọc [Hướng dẫn Cài đặt](/docs/guide/evermusic/evermusic-guide-settings/) đầy đủ.

> **Xin lưu ý:** Một số cài đặt và tính năng được đề cập trong hướng dẫn này có thể chỉ dành riêng cho **Evermusic** hoặc **Flacbox**. Tính khả dụng của tính năng cũng có thể khác nhau giữa phiên bản miễn phí và premium của mỗi ứng dụng.
...
- Thêm nhạc từ đám mây, USB hoặc iTunes vào iPhone
- Kết nối và thiết lập CarPlay với xe
- Điều hướng và quản lý nhạc từ Thư viện, Kết nối hoặc Tệp cục bộ
- Tùy chỉnh phát CarPlay với cài đặt âm thanh nâng cao

Bây giờ đến lượt bạn cầm lái và thưởng thức nhạc yêu thích — theo cách của bạn — mỗi khi lái xe.

Khám phá thêm tính năng, cài đặt và hướng dẫn trong [Hướng dẫn sử dụng Evermusic](/docs/guide/evermusic/) đầy đủ của chúng tôi.
